...
# Puku Editor - Working Production DMG Build
# Uses the same approach as launch.sh (development compiled code)
...
echo "📦 Bundling VS Code (development mode - same as ./launch.sh)..."

# Copy development-compiled output (same as what launch.sh uses)
echo "  - Copying compiled code from out/..."
...
# Skip built-in extensions (they require marketplace downloads which fail)
# Those extensions will be downloaded on first launch if needed
echo "📦 Skipping built-in extensions (will download on first launch)..."
...
echo ""
echo "Built with:"
echo "  • Development-compiled code from out/ (same as ./launch.sh)"
echo "  • Puku Editor extension with dependencies"
echo "  • No marketplace extensions (will download on first launch)"
echo ""
echo "To install:"
