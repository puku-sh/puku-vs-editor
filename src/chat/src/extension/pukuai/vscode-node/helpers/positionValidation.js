...
exports.PositionValidator = void 0;
/**
...
class PositionValidator {
    constructor() {
        this._completionPositionByFile = new Map();
    }
    /**
     ...
     */
    validate(fileUri, currentPosition, reqId) {
        ...
        if (!lastPosition.isEqual(currentPosition)) {
            console.log(`[PukuInlineCompletion][${reqId}] POSITION VALIDATION: Cursor moved from ` +
