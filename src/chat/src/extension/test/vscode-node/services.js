...
function createExtensionTestingServices() {
    ...
    testingServiceCollection.define(promptsService_1.IPromptsService, new descriptors_1.SyncDescriptor(promptsServiceImpl_1.PromptsServiceImpl));
    ...
    testingServiceCollection.define(githubAvailableEmbeddingTypes_1.IGithubAvailableEmbeddingTypesService, new descriptors_1.SyncDescriptor(githubAvailableEmbeddingTypes_1.GithubAvailableEmbeddingTypesService));
