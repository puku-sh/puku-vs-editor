...
exports.isEmptyBlockStart = isEmptyBlockStart;
exports.isBlockBodyFinished = isBlockBodyFinished;
exports.getNodeStart = getNodeStart;
const parse_1 = require("./parse");
class BaseBlockParser {
    constructor(languageId, nodeMatch, 
    /**
    ...
    async getNodeMatchAtPosition(text, offset, cb) {
        const tree = await (0, parse_1.parseTreeSitter)(this.languageId, text);
        try {
...
class TreeSitterBasedBlockParser extends BaseBlockParser {
    constructor(languageId, nodeMatch, nodeTypesWithBlockOrStmtChild, startKeywords, blockNodeType, 
    /**
     ...
     */
    emptyStatementType, curlyBraceLanguage) {
        super(languageId, nodeMatch, nodeTypesWithBlockOrStmtChild);
    ...
    isBlockEmpty(block, offset) {
        ...
        if (this.languageId === 'python' &&
            ...
            (0, parse_1.queryPythonIsDocstring)(block.parent)) {
            return true;
        }
        return false;
    }
    async isEmptyBlockStart(text, offset) {
        ...
        offset = rewindToNearestNonWs(text, offset);
        const [tree, version] = await (0, parse_1.parseTreeSitterIncludingVersion)(this.languageId, text);
        try {
            ...
            if ((this.languageId === 'javascript' || this.languageId === 'typescript') &&
                nodeAtPos.parent &&
            ...
            if (errorNode !== null) {
                ...
                //     - string
                //   - ERROR
                if (errorNode.previousSibling?.type === 'module' ||
...
function getBlockParser(languageId) {
    ...
    return wasmLanguageToBlockParser[(0, parse_1.languageIdToWasmLanguage)(languageId)];
}
