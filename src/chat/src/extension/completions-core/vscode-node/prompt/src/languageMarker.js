...
exports.languageMarkers = void 0;
exports.mdCodeBlockLangToLanguageId = mdCodeBlockLangToLanguageId;
exports.isShebangLine = isShebangLine;
exports.hasLanguageMarker = hasLanguageMarker;
exports.comment = comment;
exports.commentBlockAsSingles = commentBlockAsSingles;
exports.getLanguageMarker = getLanguageMarker;
exports.getPathMarker = getPathMarker;
...
const mdLanguageIdToLanguageId = {};
for (const [languageId, info] of Object.entries(exports.languageMarkers)) {
...
const defaultCommentMarker = { start: '//', end: '' };
const dontAddLanguageMarker = [
...
function comment(text, languageId) {
    const markers = exports.languageMarkers[languageId] ? exports.languageMarkers[languageId].lineComment : defaultCommentMarker;
    if (markers) {
...
function _getLanguage(languageId) {
    if (exports.languageMarkers[languageId] !== undefined) {
        return { languageId, ...exports.languageMarkers[languageId] };
    }
    else {
        return { languageId, lineComment: { start: '//', end: '' } };
    }
}
//# sourceMappingURL=languageMarker.js.map