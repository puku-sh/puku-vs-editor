...
suite('Copilot Annotations', function () {
    class TestCopilotAnnotation {
        constructor(id, start_offset, stop_offset, cursor) {
            this.id = id;
    ...
    test('add a new annotation', function () {
        const annotations = new stream_1.StreamCopilotAnnotations();
...
suite('SSEProcessor', function () {
    ...
    test('empty response yields no results', async function () {
        const processor = await stream_1.SSEProcessor.create(accessor, 1, (0, fetcher_1.createFakeStreamResponse)(''), telemetry_1.TelemetryWithExp.createEmptyConfigForTesting());
        const results = await (0, iterableHelpers_1.asyncIterableToArray)(processor.processSSE());
        assertSimplifiedResultsEqual(results, {});
    });
    test('done response yields no results', async function () {
        const processor = await stream_1.SSEProcessor.create(accessor, 1, (0, fetcher_1.createFakeStreamResponse)('data: [DONE]\n'), telemetry_1.TelemetryWithExp.createEmptyConfigForTesting());
        const results = await (0, iterableHelpers_1.asyncIterableToArray)(processor.processSSE());
        assertSimplifiedResultsEqual(results, {});
    });
    test('broken JSON response is skipped', async function () {
        const processor = await stream_1.SSEProcessor.create(accessor, 1, (0, fetcher_1.createFakeStreamResponse)('data: {\n'), telemetry_1.TelemetryWithExp.createEmptyConfigForTesting());
        const results = await (0, iterableHelpers_1.asyncIterableToArray)(processor.processSSE());
        assertSimplifiedResultsEqual(results, {});
    });
...
data: [DONE]
`;
        const processor = await stream_1.SSEProcessor.create(accessor, 1, (0, fetcher_1.createFakeStreamResponse)(response), telemetry_1.TelemetryWithExp.createEmptyConfigForTesting());
        const results = await (0, iterableHelpers_1.asyncIterableToArray)(processor.processSSE());
        assertSimplifiedResultsEqual(results, {
            0: {
                finishReason: 'stop',
...
data: [DONE]
`;
        const processor = await stream_1.SSEProcessor.create(accessor, 2, (0, fetcher_1.createFakeStreamResponse)(response), telemetry_1.TelemetryWithExp.createEmptyConfigForTesting());
        const results = await (0, iterableHelpers_1.asyncIterableToArray)(processor.processSSE());
        assertSimplifiedResultsEqual(results, {
            0: {
                finishReason: 'stop',
...
data: [DONE]
`;
        const processor = await stream_1.SSEProcessor.create(accessor, 1, (0, fetcher_1.createFakeStreamResponse)(response), telemetry_1.TelemetryWithExp.createEmptyConfigForTesting(), ['content_filter']);
        const results = await (0, iterableHelpers_1.asyncIterableToArray)(processor.processSSE());
        assertSimplifiedResultsEqual(results, {});
    });
...
`;
        const processor = await stream_1.SSEProcessor.create(accessor, 1, (0, fetcher_1.createFakeStreamResponse)(response), telemetry_1.TelemetryWithExp.createEmptyConfigForTesting());
        await (0, iterableHelpers_1.asyncIterableToArray)(processor.processSSE((text, delta) => {
...
data: [DONE]
	`;
        const processor = await stream_1.SSEProcessor.create(accessor, 1, (0, fetcher_1.createFakeStreamResponse)(response), telemetry_1.TelemetryWithExp.createEmptyConfigForTesting());
        const results = await (0, iterableHelpers_1.asyncIterableToArray)(processor.processSSE(() => 0));
        assertSimplifiedResultsEqual(results, {
            0: {
                finishReason: null,
                chunks: ['foo\n'],
                ...
                results: [
                    {
                        ...
                        excerpt: 'React v18.0. March 29, 2022 by The React Team. React 18 is now available on npm! In our last post, we shared step-by-step instructions for upgrading your app to React 18. In this post, weÃ¢Â€Â™ll give an overview of whatÃ¢Â€Â™s new in React 18, and what it means for the future. Our latest major version includes out-of-the-box improvements like ...',
                        url: 'https://react.dev/blog/2022/03/29/react-v18',
                    },
                    {
                        title: 'React Versions Ã¢Â€Â“ React',
                        excerpt: 'React Versions. The React docs at react.dev provide documentation for the latest version of React. We aim to keep the docs updated within major versions, and do not publish versions for each minor or patch version. When a new major is released, we archive the docs for the previous version as x.react.dev. See our versioning policy for more info.',
                        url: 'https://react.dev/versions',
                    },
                    {
                        title: 'React 19 RC Ã¢Â€Â“ React',
                        excerpt: 'April 25, 2024 by The React Team. React 19 RC is now available on npm! In our React 19 RC Upgrade Guide, we shared step-by-step instructions for upgrading your app to React 19. In this post, weÃ¢Â€Â™ll give an overview of the new features in React 19, and how you can adopt them. WhatÃ¢Â€Â™s new in React 19. Improvements in React 19.',
                        url: 'https://react.dev/blog/2024/04/25/react-19',
                    },
                    {
                        title: 'React 18: A Comprehensive Guide to the Latest Features and ... - Medium',
                        excerpt: 'Lets explore the most recent version of React, diving into key features, improvements, and best practices to leverage in your projects. Hey fellow developer! Welcome to this comprehensive guide onÃ¢Â€Â¦',
                        url: 'https://medium.com/@vyakymenko/react-18-a-comprehensive-guide-to-the-latest-features-and-improvements-82825f209ae7',
                    },
                    {
                        title: 'React',
                        excerpt: 'React is designed to let you seamlessly combine components written by independent people, teams, and organizations. ... Latest React News. React Conf 2024 Recap. May 22, 2024. React 19 RC. April 25, 2024. React 19 RC Upgrade Guide. April 25, 2024. React Labs: February 2024. February 15, 2024.',
