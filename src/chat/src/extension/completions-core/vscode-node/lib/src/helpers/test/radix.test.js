...
suite('LRURadixTrie', function () {
    let trie;
    setup(function () {
        trie = new radix_1.LRURadixTrie(20);
    });
    suite('set', function () {
        ...
        test('evicts least recently used when exceeding max size', function () {
            trie = new radix_1.LRURadixTrie(3);
            trie.set('a', 'first');
            trie.set('b', 'second');
            trie.set('c', 'third');
            trie.set('d', 'fourth');
        ...
        test('shorter key as prefix of longer key', function () {
            const trie = new radix_1.LRURadixTrie(20);
            trie.set('test', '1');
            trie.set('t', '2');
        ...
        test('insertion order does not matter', function () {
            const trie1 = new radix_1.LRURadixTrie(20);
            const trie2 = new radix_1.LRURadixTrie(20);
            trie1.set('t', '2');
            trie1.set('test', '1');
            trie2.set('test', '1');
            trie2.set('t', '2');
