...
const fullExpectedPrefix = '// This is a number 1\n// This goes first\n// This goes last\n// This is a number 2\n// Raw text\n// Another raw text\nconst a = 1;\nfunction f';
...
for (const lineEnding of ['\n', '\r\n']) {
    ...
    suite(`Completions Prompt Renderer (line ending: ${JSON.stringify(lineEnding)})`, function () {
        ...
        setup(async function () {
            ...
            renderer = new completionsPromptRenderer_1.CompletionsPromptRenderer();
        ...
        test('multiple types of context blocks ', function () {
            const prompt = ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(completionsContext_1.CompletionsContext, { children: [(0, jsx_runtime_1.jsx)(components_1.Text, { children: "This is context" }), (0, jsx_runtime_1.jsx)(components_1.Text, { children: "This is more context" })] }), (0, jsx_runtime_1.jsxs)(completionsContext_1.StableCompletionsContext, { children: [(0, jsx_runtime_1.jsx)(components_1.Text, { children: "This is other context" }), (0, jsx_runtime_1.jsx)(components_1.Text, { children: "This is extra context" })] }), (0, jsx_runtime_1.jsx)(currentFile_1.CurrentFile, {})] }));
            const virtualPrompt = new virtualPrompt_1.VirtualPrompt(prompt);
            const { snapshot } = virtualPrompt.snapshot();
            const rendered = renderer.render(snapshot, renderingOptions);
            assert.deepStrictEqual(rendered.status, 'ok');
        ...
        test('renders prefix and suffix using configured delimiter', function () {
            const expectedPrefix = '// This is a number 1?// This goes first?// This goes last?// This is a number 2?// Raw text?// Another raw text?const a = 1;\nfunction f';
        ...
        test('renders delimiter only if components do not already end with delimiter', function () {
            const expectedPrefix = '// This is a number 1text// This goes firsttext// This goes lasttext// This is a number 2text// Raw text// Another raw textconst a = 1;\nfunction f';
        ...
        test('computes metadata with stable updateDataTimeMs tolerance', function () {
            ...
            expectedComponents.forEach(expected => {
                ...
                assert.strictEqual(actual.expectedTokens, expected.expectedTokens, `Expected tokens for ${expected.componentPath} do not match`);
        ...
        test('computes usage statistics after elision', function () {
            ...
            assert.deepStrictEqual(actualStatsFiltered.reduce((acc, curr) => acc + (curr.actualTokens ?? 0), 0), 34);
        ...
        test('throws error when tree does not contain completions document component', function () {
            ...
            assert.strictEqual(prompt.error.message, `Node of type ${currentFile_1.CurrentFile.name} not found`);
        });
...
//# sourceMappingURL=completionsPromptRenderer.test.js.map