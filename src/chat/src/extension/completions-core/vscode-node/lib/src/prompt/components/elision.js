...
exports.WishlistElision = void 0;
exports.makePrompt = makePrompt;
exports.makePrefixPrompt = makePrefixPrompt;
exports.makeContextPrompt = makeContextPrompt;
/**
...
class WishlistElision {
    elide(prefixBlocks, prefixTokenLimit, suffixBlock, suffixTokenLimit, tokenizer) {
        ...
        const { elidedSuffix, adjustedPrefixTokenLimit } = this.elideSuffix(suffixBlock, suffixTokenLimit, prefixTokenLimit, maxPrefixTokens, tokenizer);
    ...
    preparePrefixBlocks(blocks, tokenizer) {
     ...
     */
    elideSuffix(suffixBlock, suffixTokenLimit, prefixTokenLimit, maxPrefixTokens, tokenizer) {
    ...
    elidePrefix(elidablePrefixBlocks, tokenLimit, maxPrefixTokens, tokenizer) {
        ...
        for (const block of elidablePrefixBlocks) {
            ...
            if (block.chunks && block.chunks.size > 0) {
                ...
                for (const relatedBlock of elidablePrefixBlocks) {
                    if (!relatedBlock.markedForRemoval &&
                        relatedBlock.chunks &&
    ...
    trimPrefixLinesToFit(linesWithComponentPath, tokenLimit, tokenizer) {
 ...
 */
function makeContextPrompt(elidedBlocks) {
...
//# sourceMappingURL=elision.js.map