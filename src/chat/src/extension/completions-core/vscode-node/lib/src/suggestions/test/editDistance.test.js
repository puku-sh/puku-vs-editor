...
const ed = __importStar(require("../editDistance"));
suite('Edit-Distance Test Suite', function () {
    function test_alignment(haystack, needle, expected_dist, expected_match) {
...
suite('Lexical Analyzer for Edit-Distance Test Suite', function () {
    function test_lexing(s, expected_lexemes) {
        ...
        assert.deepStrictEqual(lexemes.map(([lid]) => lookup[lid]), expected_lexemes);
    }
    ...
    test('lex alternative alphabets form words', function () {
        ...
        test_lexing('a\u03B1\u03B2\u03B3\u03B4\u03B5\u03B6\u03B7\u03B8\u03B9\u03BA\u03BB\u03BC\u03BD\u03BE\u03BF\u03C0\u03C1\u03C2\u03C3\u03C4\u03C5', [
            'a\u03B1\u03B2\u03B3\u03B4\u03B5\u03B6\u03B7\u03B8\u03B9\u03BA\u03BB\u03BC\u03BD\u03BE\u03BF\u03C0\u03C1\u03C2\u03C3\u03C4\u03C5',
        ]);
    });
    function test_lex_alignment(haystack, needle, expected_lex_dist, expected_match) {
    ...
    test('lex-edit-dist long words small distance', function () {
        test_lex_alignment('a bee is a tee in deed', 'a hippopotamus is a pachyderm in deed', 2, 'a bee is a tee in deed');
    });
    ...
    test('lex-edit-dist last needle lexeme match prefix of lexeme in haystack', function () {
        test_lex_alignment('uncomfortable with promptOrExplode', 'comfortable with prompt', 0, 'uncomfortable with promptOrExplode');
    });
    ...
    test('lexed deletions', function () {
        test_lex_alignment('XX XX XX aa bb XX cc dd XX ee ff XX gg hh XX XX XX ', 'aa bb cc dd ee ff gg hh', 3, 'aa bb XX cc dd XX ee ff XX gg hh');
    });
    ...
    test('lexed deletions and substitutions', function () {
        test_lex_alignment('XX XX XX aa bb XX SS dd ee SS XX gg hh XX XX XX ', 'aa bb cc dd ee ff gg hh', 4, 'aa bb XX SS dd ee SS XX gg hh');
    });
    ...
    test('lexed insertions from the middle of needle', function () {
        test_lex_alignment('XX XX XX XX aa bb XX cc ff XX gg hh XX XX XX XX XX ', 'aa bb cc dd ee ff gg hh', 4, 'aa bb XX cc ff XX gg hh');
    });
...
//# sourceMappingURL=editDistance.test.js.map