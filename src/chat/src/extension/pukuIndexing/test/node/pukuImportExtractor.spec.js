...
const pukuImportExtractor_1 = require("../../node/pukuImportExtractor");
(0, vitest_1.suite)('PukuImportExtractor', () => {
    let extractor;
    (0, vitest_1.beforeEach)(() => {
        extractor = new pukuImportExtractor_1.PukuImportExtractor();
    });
    (0, vitest_1.afterEach)(() => {
        extractor.clearCache();
    });
    (0, vitest_1.suite)('TypeScript/JavaScript import extraction', () => {
        (0, vitest_1.test)('extracts ES6 import statements', async () => {
            const code = `
...
`;
        ...
        (0, vitest_1.test)('extracts require() calls', async () => {
            const code = `
...
`;
        ...
        (0, vitest_1.test)('handles mixed import styles', async () => {
            const code = `
...
`;
    ...
    (0, vitest_1.suite)('Python import extraction', () => {
        (0, vitest_1.test)('extracts relative imports', async () => {
            const code = `
...
`;
        ...
        (0, vitest_1.test)('filters external packages', async () => {
            const code = `
import os
import sys
...
`;
    ...
    (0, vitest_1.suite)('Go import extraction', () => {
        (0, vitest_1.test)('extracts local package imports', async () => {
            const code = `
package main
...
`;
    ...
    (0, vitest_1.suite)('Rust import extraction', () => {
        (0, vitest_1.test)('extracts use declarations', async () => {
            const code = `
...
`;
    ...
    (0, vitest_1.suite)('C/C++ include extraction', () => {
        (0, vitest_1.test)('extracts local includes with quotes', async () => {
            const code = `
#include <stdio.h>
#include "utils.h"
...
`;
    ...
    (0, vitest_1.suite)('Java import extraction', () => {
        (0, vitest_1.test)('extracts local imports', async () => {
            const code = `
package com.example;
...
`;
    ...
    (0, vitest_1.suite)('Ruby import extraction', () => {
        (0, vitest_1.test)('extracts require and require_relative', async () => {
            const code = `
require 'json'
require './utils'
...
`;
    ...
    (0, vitest_1.suite)('PHP import extraction', () => {
        (0, vitest_1.test)('extracts require/include statements', async () => {
            const code = `
<?php
require './config.php';
...
`;
    ...
    (0, vitest_1.suite)('Cache functionality', () => {
        (0, vitest_1.test)('caches import extraction results', async () => {
        ...
        (0, vitest_1.test)('invalidates cache on content change', async () => {
        ...
        (0, vitest_1.test)('limits cache size to 100 files', async () => {
            for (let i = 0; i < 150; i++) {
                await extractor.extractImportsWithCache(`import x from './file${i}';`, 'typescript', `file:///test${i}.ts`);
            }
            // Cache should have evicted old entries
            // This is a smoke test to ensure no crashes with large cache
            assert.ok(true);
        });
        (0, vitest_1.test)('clears cache', async () => {
            const code = `import utils from './utils';`;
    ...
    (0, vitest_1.suite)('Edge cases', () => {
        ...
        (0, vitest_1.test)('handles file with no imports', async () => {
            const code = `
function hello() {
	return 'world';
}
`;
        ...
        (0, vitest_1.test)('handles unsupported language gracefully', async () => {
    ...
    (0, vitest_1.suite)('External package filtering', () => {
        (0, vitest_1.test)('filters common npm packages', async () => {
            const code = `
import react from 'react';
import vue from 'vue';
...
`;
        ...
        (0, vitest_1.test)('filters scoped packages', async () => {
            const code = `
...
//# sourceMappingURL=pukuImportExtractor.spec.js.map