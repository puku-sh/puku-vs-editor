...
exports.pukuImportExtractor = exports.PukuImportExtractor = void 0;
...
class PukuImportExtractor {
     ...
     */
    async extractImportsWithCache(content, languageId, fileUri) {
     ...
     */
    async extractImports(content, languageId) {
        ...
        try {
            ...
            const treeRef = await (0, parserWithCaching_1._parse)(wasmLanguage, content);
     ...
     */
    _extractImportsFromNode(node, content, imports, languageId) {
     ...
     */
    _extractStringLiteral(node, content) {
        for (let i = 0; i < node.childCount; i++) {
            const child = node.child(i);
            if (!child)
                continue;
     ...
     */
    _extractPythonImportPath(node, content) {
     ...
     */
    _extractRustUsePath(node, content) {
     ...
     */
    _extractJavaImportPath(node, content) {
     ...
     */
    _extractCSharpUsingPath(node, content) {
     ...
     */
    _isCommonJavaPackage(packageName) {
...
exports.PukuImportExtractor = PukuImportExtractor;
/**
 * Singleton instance
 */
exports.pukuImportExtractor = new PukuImportExtractor();
//# sourceMappingURL=pukuImportExtractor.js.map