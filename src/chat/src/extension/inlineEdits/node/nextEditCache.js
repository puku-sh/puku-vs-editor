    ...
    constructor(workspace, _logService, configService, expService) {
        ...
        (0, observableInternal_1.mapObservableArrayCached)(this, workspace.openDocuments, (doc, store) => {
            ...
            store.add((0, observable_1.autorunWithChanges)(this, {
                ...
                if (configService.getExperimentBasedConfig(configurationService_1.ConfigKey.AdvancedExperimentalExperiments.InlineEditsTriggerOnEditorChangeAfterSeconds, expService) !== undefined) {
