...
exports.ExternalEditTracker = void 0;
 ...
 */
class ExternalEditTracker {
    constructor() {
        this._ongoingEdits = new Map();
    }
    /**
     ...
     */
    async trackEdit(editKey, uris, stream, token) {
...
exports.ExternalEditTracker = ExternalEditTracker;
//# sourceMappingURL=externalEditTracker.js.map