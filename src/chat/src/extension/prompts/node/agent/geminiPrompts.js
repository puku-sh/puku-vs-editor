...
exports.DefaultGeminiAgentPrompt = void 0;
 ...
 */
class DefaultGeminiAgentPrompt extends prompt_tsx_1.PromptElement {
...
exports.DefaultGeminiAgentPrompt = DefaultGeminiAgentPrompt;
class GeminiPromptResolver {
    constructor() { }
    static { this.familyPrefixes = ['gemini']; }
    resolvePrompt(endpoint) {
        return DefaultGeminiAgentPrompt;
    }
}
promptRegistry_1.PromptRegistry.registerPrompt(GeminiPromptResolver);
//# sourceMappingURL=geminiPrompts.js.map