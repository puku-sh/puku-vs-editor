...
exports.DefaultOpenAIAgentPrompt = void 0;
...
class DefaultOpenAIAgentPrompt extends prompt_tsx_1.PromptElement {
...
exports.DefaultOpenAIAgentPrompt = DefaultOpenAIAgentPrompt;
class DefaultOpenAIPromptResolver {
    // This is overridden by `matchesModel` in the more specific prompt resolvers
    static { this.familyPrefixes = ['gpt', 'o4-mini', 'o3-mini', 'OpenAI']; }
    resolvePrompt(endpoint) {
        return DefaultOpenAIAgentPrompt;
    }
}
promptRegistry_1.PromptRegistry.registerPrompt(DefaultOpenAIPromptResolver);
//# sourceMappingURL=defaultOpenAIPrompt.js.map