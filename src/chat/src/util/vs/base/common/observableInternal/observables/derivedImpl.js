...
class Derived extends baseObservable_1.BaseObservable {
    get debugName() {
    ...
    onLastObserverRemoved() {
        ...
        this._state = 0 /* DerivedState.initial */;
        this._value = undefined;
        (0, logging_1.getLogger)()?.handleDerivedCleared(this);
    ...
    get() {
        ...
        if (this._isComputing && checkEnabled) {
            ...
            throw new deps_1.BugIndicatingError('Cyclic deriveds are not supported yet!');
        }
    ...
    _recompute() {
        ...
        try {
            ...
            (0, logging_1.getLogger)()?.handleObservableUpdated(this, {
                oldValue,
    ...
    handleChange(observable, change) {
        if (this._dependencies.has(observable) && !this._dependenciesToBeRemoved.has(observable) || this._isInBeforeUpdate) {
            (0, logging_1.getLogger)()?.handleDerivedDependencyChanged(this, observable, change);
