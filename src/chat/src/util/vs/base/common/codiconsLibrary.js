 ...
 *--------------------------------------------------------------------------------------------*/
const codiconsUtil_1 = require("./codiconsUtil");
...
exports.codiconsLibrary = {
    ...
    goToEditingSession: (0, codiconsUtil_1.register)('go-to-editing-session', 0xec35),
    editSession: (0, codiconsUtil_1.register)('edit-session', 0xec36),
    codeReview: (0, codiconsUtil_1.register)('code-review', 0xec37),
    copilotWarning: (0, codiconsUtil_1.register)('copilot-warning', 0xec38),
    python: (0, codiconsUtil_1.register)('python', 0xec39),
    copilotLarge: (0, codiconsUtil_1.register)('copilot-large', 0xec3a),
    copilotWarningLarge: (0, codiconsUtil_1.register)('copilot-warning-large', 0xec3b),
    keyboardTab: (0, codiconsUtil_1.register)('keyboard-tab', 0xec3c),
    copilotBlocked: (0, codiconsUtil_1.register)('copilot-blocked', 0xec3d),
    copilotNotConnected: (0, codiconsUtil_1.register)('copilot-not-connected', 0xec3e),
    flag: (0, codiconsUtil_1.register)('flag', 0xec3f),
    lightbulbEmpty: (0, codiconsUtil_1.register)('lightbulb-empty', 0xec40),
    symbolMethodArrow: (0, codiconsUtil_1.register)('symbol-method-arrow', 0xec41),
    copilotUnavailable: (0, codiconsUtil_1.register)('copilot-unavailable', 0xec42),
    repoPinned: (0, codiconsUtil_1.register)('repo-pinned', 0xec43),
    keyboardTabAbove: (0, codiconsUtil_1.register)('keyboard-tab-above', 0xec44),
    keyboardTabBelow: (0, codiconsUtil_1.register)('keyboard-tab-below', 0xec45),
    gitPullRequestDone: (0, codiconsUtil_1.register)('git-pull-request-done', 0xec46),
    mcp: (0, codiconsUtil_1.register)('mcp', 0xec47),
    extensionsLarge: (0, codiconsUtil_1.register)('extensions-large', 0xec48),
    layoutPanelDock: (0, codiconsUtil_1.register)('layout-panel-dock', 0xec49),
    layoutSidebarLeftDock: (0, codiconsUtil_1.register)('layout-sidebar-left-dock', 0xec4a),
    layoutSidebarRightDock: (0, codiconsUtil_1.register)('layout-sidebar-right-dock', 0xec4b),
    copilotInProgress: (0, codiconsUtil_1.register)('copilot-in-progress', 0xec4c),
    copilotError: (0, codiconsUtil_1.register)('copilot-error', 0xec4d),
    copilotSuccess: (0, codiconsUtil_1.register)('copilot-success', 0xec4e),
    chatSparkle: (0, codiconsUtil_1.register)('chat-sparkle', 0xec4f),
    searchSparkle: (0, codiconsUtil_1.register)('search-sparkle', 0xec50),
    editSparkle: (0, codiconsUtil_1.register)('edit-sparkle', 0xec51),
    copilotSnooze: (0, codiconsUtil_1.register)('copilot-snooze', 0xec52),
    sendToRemoteAgent: (0, codiconsUtil_1.register)('send-to-remote-agent', 0xec53),
    commentDiscussionSparkle: (0, codiconsUtil_1.register)('comment-discussion-sparkle', 0xec54),
    chatSparkleWarning: (0, codiconsUtil_1.register)('chat-sparkle-warning', 0xec55),
    chatSparkleError: (0, codiconsUtil_1.register)('chat-sparkle-error', 0xec56),
    collection: (0, codiconsUtil_1.register)('collection', 0xec57),
    newCollection: (0, codiconsUtil_1.register)('new-collection', 0xec58),
    thinking: (0, codiconsUtil_1.register)('thinking', 0xec59),
    build: (0, codiconsUtil_1.register)('build', 0xec5a),
    commentDiscussionQuote: (0, codiconsUtil_1.register)('comment-discussion-quote', 0xec5b),
    cursor: (0, codiconsUtil_1.register)('cursor', 0xec5c),
    eraser: (0, codiconsUtil_1.register)('eraser', 0xec5d),
    fileText: (0, codiconsUtil_1.register)('file-text', 0xec5e),
    gitLens: (0, codiconsUtil_1.register)('git-lens', 0xec5f),
    quotes: (0, codiconsUtil_1.register)('quotes', 0xec60),
    rename: (0, codiconsUtil_1.register)('rename', 0xec61),
    runWithDeps: (0, codiconsUtil_1.register)('run-with-deps', 0xec62),
    debugConnected: (0, codiconsUtil_1.register)('debug-connected', 0xec63),
    strikethrough: (0, codiconsUtil_1.register)('strikethrough', 0xec64),
    openInProduct: (0, codiconsUtil_1.register)('open-in-product', 0xec65),
    indexZero: (0, codiconsUtil_1.register)('index-zero', 0xec66),
};
