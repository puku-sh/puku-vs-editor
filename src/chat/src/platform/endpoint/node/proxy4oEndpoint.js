...
exports.Proxy4oEndpoint = void 0;
...
let Proxy4oEndpoint = class Proxy4oEndpoint extends chatEndpoint_1.ChatEndpoint {
    constructor(domainService, capiClientService, fetcherService, telemetryService, authService, chatMLFetcher, tokenizerProvider, instantiationService, configurationService, experimentationService, logService) {
        const model = configurationService.getExperimentBasedConfig(configurationService_1.ConfigKey.Internal.InstantApplyModelName, experimentationService) ?? "gpt-4o-instant-apply-full-ft-v66" /* CHAT_MODEL.GPT4OPROXY */;
        const modelInfo = {
            id: model,
            name: model,
            version: 'unknown',
    ...
    get urlOrRequestMetadata() {
        return { type: pukuRequestTypes_1.RequestType.ProxyChatCompletions };
    }
};
exports.Proxy4oEndpoint = Proxy4oEndpoint;
exports.Proxy4oEndpoint = Proxy4oEndpoint = __decorate([
...
//# sourceMappingURL=proxy4oEndpoint.js.map