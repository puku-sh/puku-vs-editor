...
let AlternativeNotebookContentService = class AlternativeNotebookContentService {
    ...
    getFormat(options) {
        ...
        return this.configurationService.getExperimentBasedConfig(configurationService_1.ConfigKey.AdvancedExperimentalExperiments.NotebookAlternativeDocumentFormat, this.experimentationService);
    }
    create(format) {
