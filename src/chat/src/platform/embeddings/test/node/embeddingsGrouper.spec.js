...
const embeddingsGrouper_1 = require("../../common/embeddingsGrouper");
...
function createNode(name, category, embedding) {
    return {
        value: { name, category },
...
(0, vitest_1.describe)('EmbeddingsGrouper', () => {
    let grouper;
    (0, vitest_1.beforeEach)(() => {
        grouper = new embeddingsGrouper_1.EmbeddingsGrouper();
    });
    (0, vitest_1.describe)('constructor and initial state', () => {
        (0, vitest_1.it)('should initialize with empty clusters', () => {
            (0, vitest_1.expect)(grouper.getClusters()).toHaveLength(0);
        });
        (0, vitest_1.it)('should accept custom options', () => {
            ...
            const customGrouper = new embeddingsGrouper_1.EmbeddingsGrouper(options);
            (0, vitest_1.expect)(customGrouper.getClusters()).toHaveLength(0);
        });
    });
    (0, vitest_1.describe)('addNode', () => {
        (0, vitest_1.it)('should create singleton cluster for first node', () => {
            ...
            (0, vitest_1.expect)(clusters[0].nodes).toHaveLength(1);
            (0, vitest_1.expect)(clusters[0].nodes[0]).toBe(node);
        });
        (0, vitest_1.it)('should create separate clusters for dissimilar nodes', () => {
            ...
            (0, vitest_1.expect)(clusters.every(c => c.nodes.length === 1)).toBe(true);
        });
        (0, vitest_1.it)('should add similar nodes to existing clusters when possible', () => {
            ...
            (0, vitest_1.expect)(cluster.nodes.some(n => n === nodes[1])).toBe(true);
        });
    });
    (0, vitest_1.describe)('addNodes (bulk)', () => {
        (0, vitest_1.it)('should handle empty array efficiently', () => {
            grouper.addNodes([]);
            (0, vitest_1.expect)(grouper.getClusters()).toHaveLength(0);
        });
        (0, vitest_1.it)('should add multiple nodes and cluster them efficiently', () => {
            const embeddings = createSimilarEmbeddings();
            const nodes = [
            ...
            (0, vitest_1.expect)(totalNodesInClusters).toBe(nodes.length);
        });
        (0, vitest_1.it)('should allow deferring clustering with reclusterAfter=false', () => {
            const nodes = [
            ...
            const clusters = grouper.getClusters();
            (0, vitest_1.expect)(clusters).toHaveLength(3);
            (0, vitest_1.expect)(clusters.every(c => c.nodes.length === 1)).toBe(true);
            ...
            (0, vitest_1.expect)(clustersAfterRecluster.length).toBeLessThanOrEqual(clusters.length);
        });
    });
    (0, vitest_1.describe)('removeNode', () => {
        (0, vitest_1.it)('should return false for non-existent node', () => {
            const node = createNode('tool1', 'category1', [1, 0, 0, 0]);
            const result = grouper.removeNode(node);
            (0, vitest_1.expect)(result).toBe(false);
        });
        (0, vitest_1.it)('should remove node and return true for existing node', () => {
            const node = createNode('tool1', 'category1', [1, 0, 0, 0]);
            grouper.addNode(node);
            const result = grouper.removeNode(node);
        ...
        (0, vitest_1.it)('should remove empty clusters when last node is removed', () => {
            const node = createNode('tool1', 'category1', [1, 0, 0, 0]);
            grouper.addNode(node);
            (0, vitest_1.expect)(grouper.getClusters()).toHaveLength(1);
            grouper.removeNode(node);
            (0, vitest_1.expect)(grouper.getClusters()).toHaveLength(0);
        });
        (0, vitest_1.it)('should update cluster when node is removed from multi-node cluster', () => {
            const embeddings = createSimilarEmbeddings();
            const nodes = [
                createNode('tool1', 'category1', embeddings[0]),
                createNode('tool2', 'category1', embeddings[1]),
            ...
            if (clusterWithMultipleNodes && clusterWithMultipleNodes.nodes.length > 1) {
                ...
                (0, vitest_1.expect)(updatedCluster).toBeDefined();
                (0, vitest_1.expect)(updatedCluster.nodes.some(n => n === nodeToRemove)).toBe(false);
            }
        });
    });
    (0, vitest_1.describe)('recluster', () => {
        (0, vitest_1.it)('should handle empty node list', () => {
            grouper.recluster();
            (0, vitest_1.expect)(grouper.getClusters()).toHaveLength(0);
        });
        (0, vitest_1.it)('should create single cluster for single node', () => {
            const node = createNode('tool1', 'category1', [1, 0, 0, 0]);
            grouper.addNode(node);
            grouper.recluster();
            const clusters = grouper.getClusters();
        ...
        (0, vitest_1.it)('should group similar embeddings together', () => {
            const embeddings = createSimilarEmbeddings();
            const nodes = [
                createNode('search', 'lookup', embeddings[0]),
                createNode('find', 'lookup', embeddings[1]), // Similar to search
            ...
            (0, vitest_1.expect)(searchCluster).toBeDefined();
            (0, vitest_1.expect)(findCluster).toBeDefined();
            (0, vitest_1.expect)(createCluster).toBeDefined();
            (0, vitest_1.expect)(makeCluster).toBeDefined();
        });
        (0, vitest_1.it)('should respect minimum cluster size option', () => {
            const grouper = new embeddingsGrouper_1.EmbeddingsGrouper({ minClusterSize: 3 });
            const embeddings = createSimilarEmbeddings();
            const nodes = [
            ...
            const clusters = grouper.getClusters();
            (0, vitest_1.expect)(clusters.every(c => c.nodes.length < 3)).toBe(true);
        });
    });
    (0, vitest_1.describe)('getClusterForNode', () => {
        (0, vitest_1.it)('should return undefined for non-existent node', () => {
            const node = createNode('tool1', 'category1', [1, 0, 0, 0]);
            const cluster = grouper.getClusterForNode(node);
            (0, vitest_1.expect)(cluster).toBeUndefined();
        });
        (0, vitest_1.it)('should return correct cluster for existing node', () => {
            const node = createNode('tool1', 'category1', [1, 0, 0, 0]);
            grouper.addNode(node);
            const cluster = grouper.getClusterForNode(node);
            (0, vitest_1.expect)(cluster).toBeDefined();
            (0, vitest_1.expect)(cluster.nodes).toContain(node);
        });
    });
    (0, vitest_1.describe)('clustering quality', () => {
        (0, vitest_1.it)('should handle identical embeddings', () => {
            ...
            const clusters = grouper.getClusters();
            (0, vitest_1.expect)(clusters).toHaveLength(1);
            (0, vitest_1.expect)(clusters[0].nodes).toHaveLength(3);
        });
        (0, vitest_1.it)('should handle zero vectors', () => {
            ...
            const clusters = grouper.getClusters();
            (0, vitest_1.expect)(clusters).toHaveLength(1);
            (0, vitest_1.expect)(clusters[0].centroid).toEqual([0, 0, 0, 0]);
        });
        (0, vitest_1.it)('should handle varied similarity distributions', () => {
            ...
            grouper.recluster();
            const clusters = grouper.getClusters();
            (0, vitest_1.expect)(clusters.length).toBeGreaterThan(1);
            (0, vitest_1.expect)(clusters.length).toBeLessThanOrEqual(nodes.length);
            // Verify each node is assigned to exactly one cluster
            const allNodesInClusters = clusters.flatMap(c => c.nodes);
            (0, vitest_1.expect)(allNodesInClusters).toHaveLength(nodes.length);
        });
    });
    (0, vitest_1.describe)('adaptive threshold behavior', () => {
        (0, vitest_1.it)('should work with different similarity percentiles', () => {
            const strictGrouper = new embeddingsGrouper_1.EmbeddingsGrouper({ eps: 0.95 }); // High similarity required
            const lenientGrouper = new embeddingsGrouper_1.EmbeddingsGrouper({ eps: 0.8 }); // Lower similarity required
            const embeddings = createSimilarEmbeddings();
            const nodes = embeddings.map((emb, i) => createNode(`tool${i}`, 'category', emb));
            ...
            (0, vitest_1.expect)(strictClusters.length).toBeGreaterThanOrEqual(lenientClusters.length);
        });
    });
    (0, vitest_1.describe)('centroid computation', () => {
        (0, vitest_1.it)('should compute correct centroids for clusters', () => {
            const nodes = [
                createNode('tool1', 'cat1', [1, 0, 0, 0]),
            ...
            clusters.forEach(cluster => {
                (0, vitest_1.expect)(cluster.centroid).toBeDefined();
                (0, vitest_1.expect)(cluster.centroid.length).toBeGreaterThan(0);
    ...
    (0, vitest_1.describe)('threshold tuning optimization', () => {
        (0, vitest_1.it)('should find optimal percentile for target cluster count', () => {
            const embeddings = createSimilarEmbeddings();
            const nodes = [
                createNode('search', 'lookup', embeddings[0]),
                createNode('find', 'lookup', embeddings[1]), // Similar to search
            ...
            (0, vitest_1.expect)(result.clusterCount).toBeLessThanOrEqual(4);
            (0, vitest_1.expect)(result.percentile).toBeGreaterThanOrEqual(80);
            (0, vitest_1.expect)(result.percentile).toBeLessThanOrEqual(99);
            (0, vitest_1.expect)(result.threshold).toBeGreaterThan(0);
        });
        (0, vitest_1.it)('should apply percentile and recluster efficiently', () => {
            const embeddings = createSimilarEmbeddings();
            const nodes = embeddings.map((emb, i) => createNode(`tool${i}`, 'category', emb));
            grouper.addNodes(nodes);
            ...
            (0, vitest_1.expect)(strictClusterCount).toBeGreaterThanOrEqual(lenientClusterCount);
            ...
            (0, vitest_1.expect)(totalNodes).toBe(nodes.length);
        });
        (0, vitest_1.it)('should cache similarities for efficient repeated tuning', () => {
            ...
            (0, vitest_1.expect)(result1.clusterCount).toBeLessThanOrEqual(15);
            (0, vitest_1.expect)(result2.clusterCount).toBeLessThanOrEqual(8);
            // For the strictest case, we have 3 natural groups, so expect something reasonable
            (0, vitest_1.expect)(result3.clusterCount).toBeLessThanOrEqual(5);
            // Verify the algorithm works in the right direction (more restrictive = fewer clusters)
            (0, vitest_1.expect)(result1.clusterCount).toBeGreaterThanOrEqual(result2.clusterCount);
            (0, vitest_1.expect)(result2.clusterCount).toBeGreaterThanOrEqual(result3.clusterCount);
        });
        (0, vitest_1.it)('should handle edge cases in threshold tuning', () => {
            // Empty grouper
            const emptyResult = grouper.tuneThresholdForTargetClusters(5);
            (0, vitest_1.expect)(emptyResult.clusterCount).toBe(0);
            // Single node
            grouper.addNode(createNode('single', 'cat', [1, 0, 0, 0]));
            const singleResult = grouper.tuneThresholdForTargetClusters(5);
            (0, vitest_1.expect)(singleResult.clusterCount).toBe(1);
            ...
            (0, vitest_1.expect)(highTargetResult.clusterCount).toBeLessThanOrEqual(3); // At most 3 nodes total
        });
    });
    (0, vitest_1.describe)('edge cases', () => {
        (0, vitest_1.it)('should handle single dimension embeddings', () => {
            const nodes = [
        ...
        (0, vitest_1.it)('should handle large number of nodes efficiently', () => {
            const nodes = [];
            for (let i = 0; i < 100; i++) {
...
//# sourceMappingURL=embeddingsGrouper.spec.js.map