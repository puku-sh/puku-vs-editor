...
exports.EmbeddingsGrouper = void 0;
/**
 ...
 */
class EmbeddingsGrouper {
    constructor(options) {
        this.nodes = [];
        this.clusters = [];
        this.nodeToClusterId = new Map();
        this.clusterCounter = 0;
        this.normalizedEmbeddings = new Map();
        this.lastUsedThreshold = 0.9; // Fallback default
        this.options = {
    ...
    findBestClusterForNode(node, threshold) {
        ...
        for (const cluster of this.clusters) {
            const similarity = this.dotProduct(this.getNormalizedEmbedding(node), cluster.centroid);
...
exports.EmbeddingsGrouper = EmbeddingsGrouper;
//# sourceMappingURL=embeddingsGrouper.js.map