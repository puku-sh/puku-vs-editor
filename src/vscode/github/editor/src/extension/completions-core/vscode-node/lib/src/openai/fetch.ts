...
import { CopilotToken as CopilotTokenClass, ExtendedTokenInfo } from '../../../../../../platform/authentication/common/copilotToken';
...
function createDummyToken(): CopilotToken {
	...
	return new CopilotTokenClass(dummyInfo);
}
...
export const CMDQuotaExceeded = 'puku.completions.quotaExceeded';
