...
**Puku Editor** is an AI-powered code editor built on GitHub Copilot Chat, enhanced with support for Z.AI's GLM models (GLM-4.6, GLM-4.5, GLM-4.5-Air) through an Ollama-compatible proxy.

This extension provides:
- **Chat Interface** - Conversational AI assistance with GLM models
- **Inline Completions** - Fill-In-Middle (FIM) code suggestions as you type
- **Agent Mode** - Autonomous multi-step coding tasks
- **Tool Calling** - Integration with VS Code tools and workspace features
- **Vision Support** - Image understanding with GLM-4.6

![Working with Puku Editor agent mode to make edits to code in your workspace](https://github.com/microsoft/vscode-copilot-release/blob/main/images/hero-dark.png?raw=true)

## Features

This extension combines the power of:
* **GitHub Copilot Chat Architecture** - Production-ready VS Code integration
* **Z.AI GLM Models** - State-of-the-art Chinese and English language models
* **Ollama-Compatible Proxy** - Seamless model switching and local deployment

## Getting Started

### Prerequisites

1. **Z.AI API Key** - Get your API key from Z.AI for access to GLM models
2. **co-proxy Server** - The Ollama-compatible proxy server (included in this workspace)
...
For detailed setup instructions, see [GLM-SETUP.md](GLM-SETUP.md).
