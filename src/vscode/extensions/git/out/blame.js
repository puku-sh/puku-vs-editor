...
let GitBlameController = (() => {
    let _instanceExtraInitializers = [];
    let __updateTextEditorBlameInformation_decorators;
    return class GitBlameController {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __updateTextEditorBlameInformation_decorators = [decorators_1.throttle];
            __esDecorate(this, null, __updateTextEditorBlameInformation_decorators, { kind: "method", name: "_updateTextEditorBlameInformation", static: false, private: false, access: { has: obj => "_updateTextEditorBlameInformation" in obj, get: obj => obj._updateTextEditorBlameInformation }, metadata: _metadata }, null, _instanceExtraInitializers);
            if (_metadata) Object.defineProperty(this, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        }
        _model = __runInitializers(this, _instanceExtraInitializers);
        ...
        async getBlameInformationHover(documentUri, blameInformation) {
            ...
            if (repository) {
                try {
                    ...
                    const avatarQuery = {
                        ...
                        size: historyProvider_1.AVATAR_SIZE
                    };
            ...
            // Commands
            const commands = [
                (0, historyProvider_1.getHistoryItemHoverCommitHashCommands)(documentUri, hash),
                (0, historyProvider_1.processHistoryItemRemoteHoverCommands)(remoteHoverCommands, hash)
            ];
            commands.push([{
                    title: `$(gear)`,
            ...
            return (0, historyProvider_1.getHistoryItemHover)(commitAvatar, authorName, authorEmail, authorDate, message, commitInformation?.shortStat, undefined, commands);
        }
