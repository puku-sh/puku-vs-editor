    ...
    async doOpen(workspace, options) {
        ...
        if (!opened) {
            await this.dialogService.prompt({
                ...
                message: workspace ?
                    localize(15517, null, this.getRecentLabel(workspace)) :
                    localize(15518, null),
                custom: {
                    markdownDetails: [{ markdown: new MarkdownString(localize(15519, null, 'https://aka.ms/allow-vscode-popup'), true) }]
                },
                buttons: [
                    {
                        label: localize(15520, null),
