...
export class FileDialogService extends AbstractFileDialogService {
    ...
    async pickFileFolderAndOpen(options) {
        ...
        throw new Error(localize(15212, null));
    }
    ...
    async pickFolderAndOpen(options) {
        ...
        throw new Error(localize(15213, null));
    }
    async pickWorkspaceAndOpen(options) {
        ...
        throw new Error(localize(15214, null));
    }
    ...
    async showUnsupportedBrowserWarning(context) {
        ...
        await this.dialogService.prompt({
            ...
            message: localize(15218, null),
            detail: localize(15219, null),
            buttons
        });
        return undefined;
    }
