...
export class WorkingCopyHistoryModel {
    ...
    static { this.FILE_SAVED_SOURCE = SaveSourceRegistry.registerSource('default.source', localize(16214, null)); }
...
let WorkingCopyHistoryService = class WorkingCopyHistoryService extends Disposable {
    ...
    static { this.FILE_MOVED_SOURCE = SaveSourceRegistry.registerSource('moved.source', localize(16215, null)); }
    static { this.FILE_RENAMED_SOURCE = SaveSourceRegistry.registerSource('renamed.source', localize(16216, null)); }
...
let NativeWorkingCopyHistoryService = class NativeWorkingCopyHistoryService extends WorkingCopyHistoryService {
    ...
    onWillShutdown(e) {
        ...
        e.join(this.storeAll(e.token), { id: 'join.workingCopyHistory', label: localize(16217, null) });
    }
    onDidChangeModels() {
