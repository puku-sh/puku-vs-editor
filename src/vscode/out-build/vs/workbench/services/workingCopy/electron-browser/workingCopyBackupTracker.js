...
let NativeWorkingCopyBackupTracker = class NativeWorkingCopyBackupTracker extends WorkingCopyBackupTracker {
    ...
    async handleModifiedBeforeShutdown(modifiedWorkingCopies, reason) {
        ...
        if (backupError) {
            ...
            return this.showErrorDialog(localize(16220, null), remainingModifiedWorkingCopies, backupError, reason);
        }
        ...
        try {
            ...
            return this.showErrorDialog(localize(16221, null), remainingModifiedWorkingCopies, error, reason);
        }
    }
    ...
    async showErrorDialog(message, workingCopies, error, reason) {
        ...
        const advice = localize(16222, null);
    ...
    toForceShutdownLabel(reason) {
        switch (reason) {
            case 1 /* ShutdownReason.CLOSE */:
            case 4 /* ShutdownReason.LOAD */:
                return localize(16224, null);
            case 2 /* ShutdownReason.QUIT */:
                return localize(16225, null);
            case 3 /* ShutdownReason.RELOAD */:
                return localize(16226, null);
        }
    }
    async backupBeforeShutdown(modifiedWorkingCopies) {
        ...
        }, localize(16227, null), localize(16228, null));
