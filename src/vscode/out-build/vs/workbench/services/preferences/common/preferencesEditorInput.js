...
const SettingsEditorIcon = registerIcon('settings-editor-label-icon', Codicon.settings, nls.localize(15625, null));
let SettingsEditor2Input = class SettingsEditor2Input extends EditorInput {
    ...
    getName() {
        return nls.localize(15626, null);
    }
    getIcon() {
...
const PreferencesEditorIcon = registerIcon('preferences-editor-label-icon', Codicon.settings, nls.localize(15627, null));
export class PreferencesEditorInput extends EditorInput {
    ...
    getName() {
        return nls.localize(15628, null);
    }
    getIcon() {
