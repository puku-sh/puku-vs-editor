...
const SOURCE_SYSTEM = localize(15613, null);
const SOURCE_EXTENSION = localize(15614, null);
const SOURCE_USER = localize(15615, null);
...
let KeybindingsEditorModel = KeybindingsEditorModel_1 = class KeybindingsEditorModel extends EditorModel {
    ...
    static getCommandDefaultLabel(menuCommand) {
        if (!Language.isDefaultVariant()) {
            if (menuCommand && menuCommand.title && menuCommand.title.original) {
                ...
                return category ? localize(15616, null, category, title) : title;
            }
        }
        return null;
    }
    static getCommandLabel(menuCommand, editorActionLabel) {
        if (menuCommand) {
            ...
            return category ? localize(15617, null, category, title) : title;
        }
...
class KeybindingItemMatches {
    ...
    wordMatchesAltModifier(word) {
        ...
        if (strings.equalsIgnoreCase(localize(15618, null), word)) {
            return true;
        }
        return false;
    }
    ...
    wordMatchesMetaModifier(word) {
        ...
        if (strings.equalsIgnoreCase(localize(15619, null), word)) {
            return true;
        }
        return false;
    }
