...
let ViewsService = class ViewsService extends Disposable {
    ...
    getFocusedViewName() {
        const textEditorFocused = this.editorService.activeTextEditorControl?.hasTextFocus() ? localize(16065, null) : undefined;
                    ...
                    super({
                        ...
                        get title() {
                            ...
                            if (viewContainerLocation === 0 /* ViewContainerLocation.Sidebar */) {
                                return { value: localize(16066, null, localizedTitle), original: `Show ${originalTitle}` };
                            }
                            else {
                                return { value: localize(16067, null, localizedTitle), original: `Toggle ${originalTitle}` };
                            }
                        },
            ...
            constructor() {
                super({
                    ...
                    get title() {
                        ...
                        const originalTitle = typeof title === 'string' ? title : title.original;
                        if (viewContainerLocation === 0 /* ViewContainerLocation.Sidebar */) {
                            return { value: localize(16068, null, localizedTitle), original: `Show ${originalTitle}` };
                        }
                        else {
                            return { value: localize(16069, null, localizedTitle), original: `Toggle ${originalTitle}` };
                        }
                    },
                    category: Categories.View,
                    ...
                    metadata: {
                        description: localize(16070, null, viewDescriptor.name.value),
                        args: [
                            {
                                name: 'options',
                                schema: {
                                    ...
                                    properties: {
                                        'preserveFocus': {
                                            type: 'boolean',
                                            default: false,
                                            description: localize(16071, null)
                                        }
                                    },
                                }
                            }
    ...
    registerFocusViewAction(viewDescriptor, category) {
        return registerAction2(class FocusViewAction extends Action2 {
            constructor() {
                const title = localize2(16072, "Focus on {0} View", viewDescriptor.name.value);
                super({
        ...
        return registerAction2(class ResetViewLocationAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(16073, "Reset Location"),
                    menu: [{
