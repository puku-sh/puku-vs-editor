...
export const defaultUserDataProfileIcon = registerIcon('defaultProfile-icon', Codicon.settings, localize(16014, null));
export const PROFILES_TITLE = localize2(16016, 'Profiles');
export const PROFILES_CATEGORY = { ...PROFILES_TITLE };
export const PROFILE_EXTENSION = 'code-profile';
export const PROFILE_FILTER = [{ name: localize(16015, null), extensions: [PROFILE_EXTENSION] }];
