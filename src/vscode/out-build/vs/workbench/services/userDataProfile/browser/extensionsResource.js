                ...
                if (installExtensionInfos.length) {
                    if (token) {
                        ...
                        for (const installExtensionInfo of installExtensionInfos) {
                            ...
                            progress?.(localize(15954, null, installExtensionInfo.extension.displayName ?? installExtensionInfo.extension.identifier.id));
...
export class ExtensionsResourceTreeItem {
    constructor() {
        ...
        this.label = { label: localize(15955, null) };
    ...
    async getChildren() {
        ...
        return extensions.map(e => ({
            ...
            description: e.applicationScoped ? localize(15956, null) : undefined,
            ...
            checkbox: that.checkbox ? {
                ...
                tooltip: localize(15957, null, e.displayName || e.identifier.id),
                accessibilityInformation: {
                    label: localize(15958, null, e.displayName || e.identifier.id),
                }
            } : undefined,
