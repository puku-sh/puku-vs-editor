...
const getStartedWalkthrough = {
    ...
    properties: {
        id: {
            description: nls.localize(15671, null),
            type: 'string'
        },
    }
};
const remoteHelpExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: nls.localize(15672, null),
        type: 'object',
        properties: {
            'getStarted': {
                description: nls.localize(15673, null),
                oneOf: [
                    { type: 'string' },
            ...
            'documentation': {
                description: nls.localize(15674, null),
                type: 'string'
            },
            'feedback': {
                description: nls.localize(15675, null),
                type: 'string',
                markdownDeprecationMessage: nls.localize(15676, null, '`reportIssue`')
            },
            'reportIssue': {
                description: nls.localize(15677, null),
                type: 'string'
            },
            'issues': {
                description: nls.localize(15678, null),
                type: 'string'
            }
        }
    }
