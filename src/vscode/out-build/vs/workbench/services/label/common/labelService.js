...
const resourceLabelFormattersExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: localize(15554, null),
        type: 'array',
        items: {
            type: 'object',
            ...
            properties: {
                scheme: {
                    type: 'string',
                    description: localize(15555, null),
                },
                authority: {
                    type: 'string',
                    description: localize(15556, null),
                },
                formatting: {
                    description: localize(15557, null),
                    type: 'object',
                    properties: {
                        label: {
                            type: 'string',
                            description: localize(15558, null)
                        },
                        separator: {
                            type: 'string',
                            description: localize(15559, null)
                        },
                        stripPathStartingSeparator: {
                            type: 'boolean',
                            description: localize(15560, null)
                        },
                        tildify: {
                            type: 'boolean',
                            description: localize(15561, null)
                        },
                        workspaceSuffix: {
                            type: 'string',
                            description: localize(15562, null)
                        }
                    }
                }
            }
...
let LabelService = class LabelService extends Disposable {
    ...
    doGetWorkspaceLabel(workspaceUri, options) {
        ...
        if (isUntitledWorkspace(workspaceUri, this.environmentService)) {
            return localize(15563, null);
        }
        // Workspace: Temporary
        if (isTemporaryWorkspace(workspaceUri)) {
            return localize(15564, null);
        }
        // Workspace: Saved
        ...
        switch (options?.verbose) {
            ...
            case 2 /* Verbosity.LONG */:
                label = localize(15565, null, this.getUriLabel(joinPath(dirname(workspaceUri), filename)));
                break;
            case 1 /* Verbosity.MEDIUM */:
            default:
                label = localize(15566, null, filename);
                break;
        }
