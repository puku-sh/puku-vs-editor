...
let FilesConfigurationService = class FilesConfigurationService extends Disposable {
    ...
    static { this.READONLY_MESSAGES = {
        providerReadonly: { value: localize(15503, null), isTrusted: true },
        sessionReadonly: { value: localize(15504, null, 'workbench.action.files.setActiveEditorWriteableInSession'), isTrusted: true },
        configuredReadonly: { value: localize(15505, null, `workbench.action.openSettings?${encodeURIComponent('["files.readonly"]')}`, 'workbench.action.files.toggleActiveEditorReadonlyInSession'), isTrusted: true },
        fileLocked: { value: localize(15506, null, 'workbench.action.files.setActiveEditorWriteableInSession'), isTrusted: true },
        fileReadonly: { value: localize(15507, null), isTrusted: true }
    }; }
