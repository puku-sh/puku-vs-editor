        ...
        if (featureState.disabled === undefined) {
            ...
            if (feature.access.requireUserConsent) {
                ...
                const confirmationResult = await this.dialogService.confirm({
                    title: localize(15291, null, feature.label),
                    message: localize(15292, null, extensionDescription?.displayName ?? extension._lower, feature.label),
                    detail: justification ?? feature.description,
                    custom: true,
                    primaryButton: localize(15293, null),
                    cancelButton: localize(15294, null),
                });
