...
let SettingsTargetsWidget = class SettingsTargetsWidget extends Widget {
    ...
    resetLabels() {
        ...
        this.userLocalSettings.label = localize(10880, null);
        this.userRemoteSettings.label = localize(10881, null) + (hostLabel ? ` [${hostLabel}]` : '');
        this.workspaceSettings.label = localize(10882, null);
        this.folderSettingsAction.label = localize(10883, null);
    }
    create(parent) {
        ...
        this.userLocalSettings.tooltip = localize(10885, null);
        ...
        const remoteAuthority = this.environmentService.remoteAuthority;
        const hostLabel = remoteAuthority && this.labelService.getHostLabel(Schemas.vscodeRemote, remoteAuthority);
        this.userRemoteSettings.tooltip = localize(10886, null) + (hostLabel ? ` [${hostLabel}]` : '');
    ...
    async update() {
        ...
        this.workspaceSettings.tooltip = localize(10889, null);
    }
};
