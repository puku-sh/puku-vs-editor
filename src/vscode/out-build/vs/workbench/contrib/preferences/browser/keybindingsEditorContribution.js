...
const NLS_KB_LAYOUT_ERROR_MESSAGE = nls.localize(10773, null);
    ...
    _createDecoration(isError, uiLabel, usLabel, model, keyNode) {
        ...
        if (isError) {
            ...
            if (usLabel && uiLabel !== usLabel) {
                msg = new MarkdownString(nls.localize(10774, null, uiLabel, usLabel));
                ...
                msg = new MarkdownString(nls.localize(10775, null, uiLabel));
