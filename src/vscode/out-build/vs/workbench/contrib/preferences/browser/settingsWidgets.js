...
let ListSettingWidget = class ListSettingWidget extends AbstractListSettingWidget {
    ...
    renderEdit(item, idx) {
        ...
        okButton.label = localize(11048, null);
        ...
        cancelButton.label = localize(11049, null);
    ...
    addTooltipsToRow(rowElementGroup, { value, sibling }) {
        const title = isUndefinedOrNull(sibling)
            ? localize(11050, null, value.data)
            : localize(11051, null, value.data, sibling);
    ...
    getLocalizedStrings() {
        return {
            deleteActionTooltip: localize(11052, null),
            editActionTooltip: localize(11053, null),
            addButtonLabel: localize(11054, null),
            inputPlaceholder: localize(11055, null),
            siblingInputPlaceholder: localize(11056, null),
        };
    }
...
export class ExcludeSettingWidget extends ListSettingWidget {
    ...
    addTooltipsToRow(rowElementGroup, item) {
        let title = isUndefinedOrNull(item.sibling)
            ? localize(11057, null, item.value.data)
            : localize(11058, null, item.value.data, item.sibling);
        if (item.source) {
            title += localize(11059, null, item.source);
        }
    ...
    getLocalizedStrings() {
        return {
            deleteActionTooltip: localize(11060, null),
            editActionTooltip: localize(11061, null),
            addButtonLabel: localize(11062, null),
            inputPlaceholder: localize(11063, null),
            siblingInputPlaceholder: localize(11064, null),
        };
    }
}
export class IncludeSettingWidget extends ListSettingWidget {
    ...
    addTooltipsToRow(rowElementGroup, item) {
        let title = isUndefinedOrNull(item.sibling)
            ? localize(11065, null, item.value.data)
            : localize(11066, null, item.value.data, item.sibling);
        if (item.source) {
            title += localize(11067, null, item.source);
        }
        const markdownTitle = new MarkdownString().appendMarkdown(title);
        const { rowElement } = rowElementGroup;
        this.listDisposables.add(this.hoverService.setupDelayedHover(rowElement, { content: markdownTitle }));
    ...
    getLocalizedStrings() {
        return {
            deleteActionTooltip: localize(11068, null),
            editActionTooltip: localize(11069, null),
            addButtonLabel: localize(11070, null),
            inputPlaceholder: localize(11071, null),
            siblingInputPlaceholder: localize(11072, null),
        };
    }
}
let ObjectSettingDropdownWidget = class ObjectSettingDropdownWidget extends AbstractListSettingWidget {
    ...
    addTooltipsToRow(rowElementGroup, item) {
        ...
        if (item.source) {
            accessibleDescription = localize(11077, null, item.key.data, item.value.data, item.source);
        }
        else {
            accessibleDescription = localize(11078, null, item.key.data, item.value.data);
        }
    ...
    getLocalizedStrings() {
        return {
            deleteActionTooltip: localize(11079, null),
            resetActionTooltip: localize(11080, null),
            editActionTooltip: localize(11081, null),
            addButtonLabel: localize(11082, null),
            keyHeaderText: localize(11083, null),
            valueHeaderText: localize(11084, null),
        };
    }
};
...
let ObjectSettingCheckboxWidget = class ObjectSettingCheckboxWidget extends AbstractListSettingWidget {
    ...
    addTooltipsToRow(rowElementGroup, item) {
        const accessibleDescription = localize(11085, null, item.key.data, item.value.data);
    ...
    getLocalizedStrings() {
        return {
            deleteActionTooltip: localize(11086, null),
            resetActionTooltip: localize(11087, null),
            editActionTooltip: localize(11088, null),
            addButtonLabel: localize(11089, null),
            keyHeaderText: localize(11090, null),
            valueHeaderText: localize(11091, null),
        };
    }
};
