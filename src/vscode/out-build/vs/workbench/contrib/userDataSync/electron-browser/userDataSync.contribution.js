...
registerAction2(class OpenSyncBackupsFolder extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14289, "Open Local Backups Folder"),
            category: SYNC_TITLE,
            menu: {
    ...
    async run(accessor) {
        ...
        if (await fileService.exists(syncHome)) {
            ...
            notificationService.info(localize(14286, null));
        }
    }
});
registerAction2(class DownloadSyncActivityAction extends Action2 {
    ...
    async run(accessor) {
        ...
        if (folder) {
            notificationService.prompt(Severity.Info, localize(14287, null), [{
                    label: localize(14288, null),
