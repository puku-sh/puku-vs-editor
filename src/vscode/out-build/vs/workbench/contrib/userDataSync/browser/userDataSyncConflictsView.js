...
let UserDataSyncConflictsViewPane = class UserDataSyncConflictsViewPane extends TreeViewPane {
    ...
    renderTreeView(container) {
        ...
        const that = this;
        this.treeView.message = localize(14245, null);
    ...
    async open(conflictToOpen) {
        ...
        const remoteResourceName = localize(14249, null, basename(conflictToOpen.remoteResource));
        const localResourceName = localize(14250, null, basename(conflictToOpen.remoteResource));
        await this.editorService.openEditor({
            input1: { resource: conflictToOpen.remoteResource, label: localize(14251, null), description: remoteResourceName },
            input2: { resource: conflictToOpen.localResource, label: localize(14252, null), description: localResourceName },
