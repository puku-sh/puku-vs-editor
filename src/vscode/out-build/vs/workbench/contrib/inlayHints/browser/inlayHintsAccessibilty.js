...
let InlayHintsAccessibility = class InlayHintsAccessibility {
    ...
    static { this.IsReading = new RawContextKey('isReadingLineWithInlayHints', false, { type: 'boolean', description: localize(9039, null) }); }
    ...
    constructor(_editor, contextKeyService, _accessibilitySignalService, _instaService) {
        ...
        this._ariaElement.setAttribute('aria-description', localize(9040, null));
...
registerAction2(class StartReadHints extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(9041, "Read Line with Inlay Hints"),
...
registerAction2(class StopReadHints extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(9042, "Stop Inlay Hints Reading"),
