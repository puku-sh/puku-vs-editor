...
export class ShowCurrentReleaseNotesAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(13964, "Show Release Notes"),
                mnemonicTitle: localize(13958, null),
            },
    ...
    async run(accessor) {
        ...
        try {
            ...
            if (productService.releaseNotesUrl) {
                ...
                throw new Error(localize(13959, null, productService.nameLong));
            }
        }
    }
}
export class ShowCurrentReleaseNotesFromCurrentFileAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(13965, "Open Current File as Release Notes"),
                mnemonicTitle: localize(13960, null),
            },
            category: localize2(13966, "Developer"),
            f1: true,
        });
    }
    async run(accessor) {
        ...
        try {
            ...
            throw new Error(localize(13961, null));
        }
    }
}
...
export class CheckForUpdateAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(13967, 'Check for Updates...'),
            category: { value: product.nameShort, original: product.nameShort },
            f1: true,
...
class DownloadUpdateAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(13968, 'Download Update'),
            category: { value: product.nameShort, original: product.nameShort },
            f1: true,
...
class InstallUpdateAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(13969, 'Install Update'),
            category: { value: product.nameShort, original: product.nameShort },
            f1: true,
...
class RestartToUpdateAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(13970, 'Restart to Update'),
            category: { value: product.nameShort, original: product.nameShort },
            f1: true,
...
class DownloadAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(13971, "Download {0}", product.nameLong),
    ...
    class DeveloperApplyUpdateAction extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(13972, 'Apply Update...'),
        ...
        async run(accessor) {
            ...
            const updatePath = await fileDialogService.showOpenDialog({
                title: localize(13962, null),
                filters: [{ name: 'Setup', extensions: ['exe'] }],
                canSelectFiles: true,
                openLabel: mnemonicButtonLabel(localize(13963, null))
            });
