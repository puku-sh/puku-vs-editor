...
export const externalUriOpenersConfigurationNode = {
    ...
    properties: {
        [externalUriOpenersSettingId]: {
            type: 'object',
            markdownDescription: nls.localize(8603, null),
            defaultSnippets: [{
                    body: {
                        'example.com': '$1'
                    }
            ...
            additionalProperties: {
                anyOf: [
                    {
                        type: 'string',
                        markdownDescription: nls.localize(8604, null, exampleUriPatterns),
                    },
                    {
                        type: 'string',
                        markdownDescription: nls.localize(8605, null, exampleUriPatterns),
                        enum: [defaultExternalUriOpenerId],
                        enumDescriptions: [nls.localize(8606, null)],
                    },
