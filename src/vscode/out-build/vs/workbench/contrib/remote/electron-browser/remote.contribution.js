...
let WSLContextKeyInitializer = class WSLContextKeyInitializer extends Disposable {
    ...
    constructor(contextKeyService, nativeHostService, storageService, lifecycleService) {
        ...
        const hasWSLFeatureContext = new RawContextKey(contextKeyId, !!defaultValue, nls.localize(11375, null));
...
Registry.as(ConfigurationExtensions.Configuration)
    ...
    id: 'remote',
    title: nls.localize(11376, null),
    type: 'object',
    properties: {
        'remote.downloadExtensionsLocally': {
            type: 'boolean',
            markdownDescription: nls.localize(11377, null),
            default: false
        },
    }
});
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize(11378, null),
            category: localize(11379, null),
            menu: [{
