...
class PortColumn {
    constructor() {
        this.label = nls.localize(11269, null);
        this.tooltip = nls.localize(11270, null);
        this.weight = 1;
        this.templateId = 'actionbar';
    }
    project(row) {
...
class LocalAddressColumn {
    constructor() {
        this.label = nls.localize(11271, null);
        this.tooltip = nls.localize(11272, null);
        this.weight = 1;
        this.templateId = 'actionbar';
    }
    project(row) {
    ...
    static getHoverText(localAddress) {
        return function (configurationService) {
            ...
            if (editorConf.multiCursorModifier === 'ctrlCmd') {
                if (isMacintosh) {
                    clickLabel = nls.localize(11273, null);
                }
                else {
                    clickLabel = nls.localize(11274, null);
                }
            }
            else {
                if (isMacintosh) {
                    clickLabel = nls.localize(11275, null);
                }
                else {
                    clickLabel = nls.localize(11276, null);
                }
            }
...
class RunningProcessColumn {
    constructor() {
        this.label = nls.localize(11277, null);
        this.tooltip = nls.localize(11278, null);
        this.weight = 2;
        this.templateId = 'actionbar';
    }
    project(row) {
...
class OriginColumn {
    constructor() {
        this.label = nls.localize(11279, null);
        this.tooltip = nls.localize(11280, null);
        this.weight = 1;
        this.templateId = 'actionbar';
    }
    project(row) {
...
class PrivacyColumn {
    constructor() {
        this.label = nls.localize(11281, null);
        this.tooltip = nls.localize(11282, null);
        this.weight = 1;
        this.templateId = 'actionbar';
    }
    project(row) {
...
let ActionBarRenderer = class ActionBarRenderer extends Disposable {
    ...
    renderInputBox(container, editableData) {
        ...
        const inputBox = new InputBox(container, this.contextViewService, {
            ariaLabel: nls.localize(11283, null),
            validationOptions: {
                validation: (value) => {
...
class TunnelItem {
    ...
    get processDescription() {
        ...
        if (this.runningProcess) {
            ...
            description = nls.localize(11284, null);
        }
        return description;
    }
    get tooltipPostfix() {
        ...
        if (this.localAddress) {
            information = nls.localize(11285, null, this.remoteHost, this.remotePort, this.localAddress);
        }
        else {
            information = nls.localize(11286, null, this.remoteHost, this.remotePort);
        }
        return information;
    }
    get iconTooltip() {
        ...
        if (!isAdd) {
            return `${this.processDescription ? nls.localize(11287, null) :
                nls.localize(11288, null)}`;
        }
        else {
            return this.label;
        }
    ...
    get portTooltip() {
        const isAdd = this.tunnelType === TunnelType.Add;
        if (!isAdd) {
            return `${this.name ? nls.localize(11289, null, this.name) : ''}`;
        }
        else {
            return '';
        }
...
const TunnelViewFocusContextKey = new RawContextKey('tunnelViewFocus', false, nls.localize(11292, null));
...
let TunnelPanel = class TunnelPanel extends ViewPane {
    ...
    static { this.TITLE = nls.localize2(11324, "Ports"); }
    ...
    createTable() {
        ...
        this.table = this.instantiationService.createInstance(WorkbenchTable, 'RemoteTunnels', widgetContainer, new TunnelTreeVirtualDelegate(this.remoteExplorerService), columns, [actionBarRenderer], {
            ...
            accessibilityProvider: {
                ...
                getWidgetAriaLabel: () => nls.localize(11293, null)
            },
...
(function (LabelTunnelAction) {
    ...
    LabelTunnelAction.LABEL = nls.localize(11294, null);
            ...
            if (tunnelContext) {
                ...
                return new Promise(resolve => {
                    ...
                    remoteExplorerService.setEditable(tunnelItem, TunnelEditId.Label, {
                        ...
                        placeholder: nls.localize(11295, null),
                        startingValue
                    });
                });
            }
...
const invalidPortString = nls.localize(11296, null);
const maxPortNumber = 65536;
const invalidPortNumberString = nls.localize(11297, null, maxPortNumber);
const requiresSudoString = nls.localize(11298, null);
const alreadyForwarded = nls.localize(11299, null);
...
(function (ForwardPortAction) {
    ...
    ForwardPortAction.LABEL = nls.localize2(11325, "Forward a Port");
    ForwardPortAction.TREEITEM_LABEL = nls.localize(11300, null);
    const forwardPrompt = nls.localize(11301, null);
    ...
    function error(notificationService, tunnelOrError, host, port) {
        if (!tunnelOrError) {
            notificationService.warn(nls.localize(11302, null, host, port));
        }
        else if (typeof tunnelOrError === 'string') {
            notificationService.warn(nls.localize(11303, null, host, port, tunnelOrError));
        }
    }
...
function makeTunnelPicks(tunnels, remoteExplorerService, tunnelService) {
    ...
    if (picks.length === 0) {
        picks.push({
            label: nls.localize(11304, null, ForwardPortAction.LABEL.value)
        });
    }
    return picks;
}
...
(function (ClosePortAction) {
    ...
    ClosePortAction.LABEL = nls.localize2(11326, "Stop Forwarding Port");
    function inlineHandler() {
        return async (accessor, arg) => {
    ...
    function commandPaletteHandler() {
        return async (accessor) => {
            ...
            const result = await quickInputService.pick(picks, { placeHolder: nls.localize(11305, null) });
...
(function (OpenPortInBrowserAction) {
    ...
    OpenPortInBrowserAction.LABEL = nls.localize(11306, null);
    function handler() {
        return async (accessor, arg) => {
            let key;
            if (isITunnelItem(arg)) {
...
(function (OpenPortInPreviewAction) {
    ...
    OpenPortInPreviewAction.LABEL = nls.localize(11307, null);
    function handler() {
        return async (accessor, arg) => {
            let key;
            if (isITunnelItem(arg)) {
...
(function (OpenPortInBrowserCommandPaletteAction) {
    ...
    OpenPortInBrowserCommandPaletteAction.LABEL = nls.localize(11308, null);
    function handler() {
        return async (accessor, arg) => {
            const remoteExplorerService = accessor.get(IRemoteExplorerService);
            const tunnelService = accessor.get(ITunnelService);
            ...
            if (options.length === 0) {
                options.push({
                    label: nls.localize(11309, null)
                });
            }
            else {
                options.push({
                    label: nls.localize(11310, null)
                });
            }
            const picked = await quickPickService.pick(options, { placeHolder: nls.localize(11311, null) });
...
(function (CopyAddressAction) {
    ...
    CopyAddressAction.INLINE_LABEL = nls.localize(11312, null);
    CopyAddressAction.COMMANDPALETTE_LABEL = nls.localize(11313, null);
    ...
    function commandPaletteHandler() {
        return async (accessor, arg) => {
            ...
            const result = await quickInputService.pick(makeTunnelPicks(tunnels, remoteExplorerService, tunnelService), { placeHolder: nls.localize(11314, null) });
            if (result && result.tunnel) {
...
(function (ChangeLocalPortAction) {
    ...
    ChangeLocalPortAction.LABEL = nls.localize(11315, null);
    function validateInput(tunnelService, value, canElevate) {
        if (!value.match(/^[0-9]+$/)) {
            return { content: nls.localize(11316, null), severity: Severity.Error };
        }
                    ...
                    onFinish: async (value, success) => {
                        ...
                        if (success) {
                            ...
                            if (newForward && (typeof newForward !== 'string') && newForward.tunnelLocalPort !== numberValue) {
                                notificationService.warn(nls.localize(11317, null, value, newForward.tunnelLocalPort ?? newForward.localAddress));
                            }
                        }
                    },
                    validationMessage: (value) => validateInput(tunnelService, value, tunnelService.canElevate),
                    placeholder: nls.localize(11318, null)
                });
            }
        };
    }
...
(function (SetTunnelProtocolAction) {
    ...
    SetTunnelProtocolAction.LABEL_HTTP = nls.localize(11319, null);
    SetTunnelProtocolAction.LABEL_HTTPS = nls.localize(11320, null);
...
registerColor('ports.iconRunningProcessForeground', STATUS_BAR_REMOTE_ITEM_BACKGROUND, nls.localize(11323, null));
