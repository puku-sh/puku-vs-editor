    ...
    toggleStatusbarItem(active) {
        if (active) {
            if (!this.statusBarEntry.value) {
                const text = localize(11671, null);
                const tooltip = localize(11672, null);
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    id: 'workbench.action.toggleLockedScrolling',
                    title: {
                        ...localize2(11676, "Toggle Locked Scrolling Across Editors"),
                        mnemonicTitle: localize(11673, null),
                    },
                    category: Categories.View,
                    f1: true,
                    metadata: {
                        description: localize(11674, null),
                    }
                });
            }
            run() {
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: {
                        ...localize2(11677, "Hold Locked Scrolling Across Editors"),
                        mnemonicTitle: localize(11675, null),
                    },
                    category: Categories.View,
                });
            }
