...
registerAction2(class ToggleQueryDetailsAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11796, "Toggle Query Details"),
            category,
            keybinding: {
...
registerAction2(class CloseReplaceAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11797, "Close Replace Widget"),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
registerAction2(class ToggleCaseSensitiveCommandAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11798, "Toggle Case Sensitive"),
            category,
...
registerAction2(class ToggleWholeWordCommandAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11799, "Toggle Whole Word"),
            keybinding: Object.assign({
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
registerAction2(class ToggleRegexCommandAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11800, "Toggle Regex"),
            keybinding: Object.assign({
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                when: Constants.SearchContext.SearchViewFocusedKey,
...
registerAction2(class TogglePreserveCaseAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11801, "Toggle Preserve Case"),
            keybinding: Object.assign({
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                when: Constants.SearchContext.SearchViewFocusedKey,
...
registerAction2(class OpenMatchAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11802, "Open Match"),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
registerAction2(class OpenMatchToSideAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11803, "Open Match To Side"),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                when: ContextKeyExpr.and(Constants.SearchContext.SearchViewVisibleKey, Constants.SearchContext.FileMatchOrMatchFocusKey),
...
registerAction2(class AddCursorsAtSearchResultsAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11804, "Add Cursors at Search Results"),
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                when: ContextKeyExpr.and(Constants.SearchContext.SearchViewVisibleKey, Constants.SearchContext.FileMatchOrMatchFocusKey),
...
registerAction2(class FocusNextInputAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11805, "Focus Next Input"),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
registerAction2(class FocusPreviousInputAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11806, "Focus Previous Input"),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
registerAction2(class FocusSearchFromResultsAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11807, "Focus Search From Results"),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
registerAction2(class ToggleSearchOnTypeAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(11808, "Toggle Search on Type"),
            category,
        });
    }
    async run(accessor) {
...
registerAction2(class FocusSearchListCommandAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11809, "Focus List"),
            category,
            f1: true
        });
    }
...
registerAction2(class FocusNextSearchResultAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11810, "Focus Next Search Result"),
            keybinding: [{
...
registerAction2(class FocusPreviousSearchResultAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11811, "Focus Previous Search Result"),
            keybinding: [{
...
registerAction2(class ReplaceInFilesAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11812, "Replace in Files"),
            keybinding: [{
