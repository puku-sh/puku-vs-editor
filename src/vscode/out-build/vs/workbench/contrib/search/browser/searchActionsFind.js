...
registerAction2(class RestrictSearchToFolderAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11788, "Restrict Search to Folder"),
            category,
            keybinding: {
...
registerAction2(class ExcludeFolderFromSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11789, "Exclude Folder from Search"),
            category,
            menu: [
                {
                    id: MenuId.SearchContext,
...
registerAction2(class ExcludeFileTypeFromSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11790, "Exclude File Type from Search"),
            category,
            menu: [
                {
                    id: MenuId.SearchContext,
...
registerAction2(class IncludeFileTypeInSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11791, "Include File Type from Search"),
            category,
            menu: [
                {
                    id: MenuId.SearchContext,
...
registerAction2(class RevealInSideBarForSearchResultsAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11792, "Reveal in Explorer View"),
            category,
            menu: [{
                    id: MenuId.SearchContext,
...
registerAction2(class FindInFilesAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(11793, "Find in Files"),
                mnemonicTitle: nls.localize(11785, null),
            },
            metadata: {
                description: nls.localize(11786, null),
                args: [
                    {
                        name: nls.localize(11787, null),
                        schema: {
                            type: 'object',
                            properties: {
                                query: { 'type': 'string' },
...
registerAction2(class FindInFolderAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(11794, "Find in Folder..."),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
registerAction2(class FindInWorkspaceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(11795, "Find in Workspace..."),
            category,
            menu: [
                {
                    id: MenuId.ExplorerContext,
