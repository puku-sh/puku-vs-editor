...
const SEARCH_CANCELLED_MESSAGE = nls.localize(11874, null);
...
let SearchView = class SearchView extends ViewPane {
    ...
    renderBody(parent) {
        ...
        const toggleQueryDetailsLabel = nls.localize(11875, null);
        ...
        const filesToIncludeTitle = nls.localize(11876, null);
        ...
        this.inputPatternIncludes = this._register(this.instantiationService.createInstance(IncludePatternInputWidget, folderIncludesList, this.contextViewService, {
            ...
            placeholder: nls.localize(11877, null),
        ...
        const excludesTitle = nls.localize(11878, null);
        dom.append(excludesList, $('h4', undefined, excludesTitle));
        this.inputPatternExcludes = this._register(this.instantiationService.createInstance(ExcludePatternInputWidget, excludesList, this.contextViewService, {
            ariaLabel: excludesTitle,
            placeholder: nls.localize(11879, null),
            showPlaceholderOnFocus: true,
    ...
    replaceAll() {
        ...
        const confirmation = {
            title: nls.localize(11880, null),
            message: this.buildReplaceAllConfirmationMessage(occurrences, fileCount, replaceValue),
            primaryButton: nls.localize(11881, null)
        };
    ...
    buildAfterReplaceAllMessage(occurrences, fileCount, replaceValue) {
        if (occurrences === 1) {
            if (fileCount === 1) {
                if (replaceValue) {
                    return nls.localize(11882, null, occurrences, fileCount, replaceValue);
                }
                return nls.localize(11883, null, occurrences, fileCount);
            }
            if (replaceValue) {
                return nls.localize(11884, null, occurrences, fileCount, replaceValue);
            }
            return nls.localize(11885, null, occurrences, fileCount);
        }
        if (fileCount === 1) {
            if (replaceValue) {
                return nls.localize(11886, null, occurrences, fileCount, replaceValue);
            }
            return nls.localize(11887, null, occurrences, fileCount);
        }
        if (replaceValue) {
            return nls.localize(11888, null, occurrences, fileCount, replaceValue);
        }
        return nls.localize(11889, null, occurrences, fileCount);
    }
        ...
        if (occurrences === 1) {
            if (fileCount === 1) {
                if (displayReplaceValue) {
                    return nls.localize(11890, null, occurrences, fileCount, displayReplaceValue);
                }
                return nls.localize(11891, null, occurrences, fileCount);
            }
            if (displayReplaceValue) {
                return nls.localize(11892, null, occurrences, fileCount, displayReplaceValue);
            }
            return nls.localize(11893, null, occurrences, fileCount);
        }
        if (fileCount === 1) {
            if (displayReplaceValue) {
                return nls.localize(11894, null, occurrences, fileCount, displayReplaceValue);
            }
            return nls.localize(11895, null, occurrences, fileCount);
        }
        if (displayReplaceValue) {
            return nls.localize(11896, null, occurrences, fileCount, displayReplaceValue);
        }
        return nls.localize(11897, null, occurrences, fileCount);
    }
    clearMessage() {
    ...
    clearSearchResults(clearInput = true) {
        ...
        this.tree.ariaLabel = nls.localize(11898, null);
    ...
    validateQuery(query) {
        ...
        return Promise.all(folderQueriesExistP).then(existResults => {
            ...
            if (!query.folderQueries.length || existingFolderQueries.length) {
                ...
                const searchPathNotFoundError = nls.localize(11899, null, nonExistantPath);
    ...
    appendSearchWithAIButton(messageEl) {
        const searchWithAIButtonTooltip = appendKeyBindingLabel(nls.localize(11900, null), this.keybindingService.lookupKeybinding("search.action.searchWithAI" /* Constants.SearchCommandIds.SearchWithAIActionId */));
        const searchWithAIButtonText = nls.localize(11901, null);
        ...
        if (!allResults) {
            ...
            if (!completed) {
                ...
                if (hasIncludes && hasExcludes) {
                    message = nls.localize(11902, null, includePatternText, excludePatternText);
                }
                else if (hasIncludes) {
                    message = nls.localize(11903, null, includePatternText);
                }
                else if (hasExcludes) {
                    message = nls.localize(11904, null, excludePatternText);
                }
                else {
                    message = nls.localize(11905, null);
                }
            }
            else {
                if (hasIncludes && hasExcludes) {
                    message = nls.localize(11906, null, includePatternText, excludePatternText);
                }
                else if (hasIncludes) {
                    message = nls.localize(11907, null, includePatternText);
                }
                else if (hasExcludes) {
                    message = nls.localize(11908, null, excludePatternText);
                }
                else {
                    message = nls.localize(11909, null);
                }
            }
            ...
            if (!completed) {
                const searchAgainButton = this.messageDisposables.add(new SearchLinkButton(nls.localize(11910, null), () => this.triggerQueryChange({ preserveFocus: false }), this.hoverService));
                dom.append(messageEl, searchAgainButton.element);
            }
            else if (hasIncludes || hasExcludes) {
                const searchAgainButton = this.messageDisposables.add(new SearchLinkButton(nls.localize(11911, null), this.onSearchAgain.bind(this), this.hoverService));
                dom.append(messageEl, searchAgainButton.element);
            }
            else {
                const openSettingsButton = this.messageDisposables.add(new SearchLinkButton(nls.localize(11912, null), this.onOpenSettings.bind(this), this.hoverService));
            ...
            aria.status(nls.localize(11913, null, this.viewModel.searchResult.count(), this.viewModel.searchResult.fileCount()));
        }
        if (completed && completed.limitHit) {
            completed.messages.push({ type: TextSearchCompleteMessageType.Warning, text: nls.localize(11914, null) });
        }
    ...
    updateSearchResultCount(disregardExcludesAndIgnores, onlyOpenEditors, clear = false) {
        ...
        this.tree.ariaLabel = resultMsg + nls.localize(11915, null, this.searchResult.query?.contentPattern.pattern ?? '');
        dom.append(messageEl, resultMsg);
        if (fileCount > 0) {
            if (disregardExcludesAndIgnores) {
                const excludesDisabledMessage = ' - ' + nls.localize(11916, null) + ' ';
                const enableExcludesButton = this.messageDisposables.add(new SearchLinkButton(nls.localize(11917, null), this.onEnableExcludes.bind(this), this.hoverService, nls.localize(11918, null)));
                dom.append(messageEl, $('span', undefined, excludesDisabledMessage, '(', enableExcludesButton.element, ')'));
            }
            if (onlyOpenEditors) {
                const searchingInOpenMessage = ' - ' + nls.localize(11919, null) + ' ';
                const disableOpenEditorsButton = this.messageDisposables.add(new SearchLinkButton(nls.localize(11920, null), this.onDisableSearchInOpenEditors.bind(this), this.hoverService, nls.localize(11921, null)));
                dom.append(messageEl, $('span', undefined, searchingInOpenMessage, '(', disableOpenEditorsButton.element, ')'));
            }
            dom.append(messageEl, ' - ');
            const openInEditorTooltip = appendKeyBindingLabel(nls.localize(11922, null), this.keybindingService.lookupKeybinding("search.action.openInEditor" /* Constants.SearchCommandIds.OpenInEditorCommandId */));
            const openInEditorButton = this.messageDisposables.add(new SearchLinkButton(nls.localize(11923, null), () => this.instantiationService.invokeFunction(createEditorFromSearchResult, this.searchResult, this.searchIncludePattern.getValue(), this.searchExcludePattern.getValue(), this.searchIncludePattern.onlySearchInOpenEditors()), this.hoverService, openInEditorTooltip));
    ...
    updateKeywordSuggestionUI(keyword) {
        ...
        if (this._cachedKeywords.length > 0) {
            ...
            const resultMsg = nls.localize(11924, null);
            dom.append(messageEl, resultMsg);
    ...
    buildResultCountMessage(resultCount, fileCount) {
        if (resultCount === 1 && fileCount === 1) {
            return nls.localize(11925, null, resultCount, fileCount);
        }
        else if (resultCount === 1) {
            return nls.localize(11926, null, resultCount, fileCount);
        }
        else if (fileCount === 1) {
            return nls.localize(11927, null, resultCount, fileCount);
        }
        else {
            return nls.localize(11928, null, resultCount, fileCount);
        }
    }
    showSearchWithoutFolderMessage() {
        this.searchWithoutFolderMessageElement = this.clearMessage();
        const textEl = dom.append(this.searchWithoutFolderMessageElement, $('p', undefined, nls.localize(11929, null)));
        const openFolderButton = this.messageDisposables.add(new SearchLinkButton(nls.localize(11930, null), () => {
