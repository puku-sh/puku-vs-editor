...
registerAction2(class ClearSearchHistoryCommandAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11821, "Clear Search History"),
            category,
            f1: true
        });
    }
...
registerAction2(class CancelSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11822, "Cancel Search"),
            icon: searchStopIcon,
            category,
            f1: true,
...
registerAction2(class RefreshAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11823, "Refresh"),
...
registerAction2(class CollapseDeepestExpandedLevelAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11824, "Collapse All"),
            category,
...
registerAction2(class ExpandAllAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11825, "Expand All"),
            category,
...
registerAction2(class ClearSearchResultsAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11826, "Clear Search Results"),
            category,
...
registerAction2(class ViewAsTreeAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11827, "View as Tree"),
            category,
...
registerAction2(class ViewAsListAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11828, "View as List"),
            category,
...
registerAction2(class SearchWithAIAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11829, "Search with AI"),
            category,
            f1: true,
