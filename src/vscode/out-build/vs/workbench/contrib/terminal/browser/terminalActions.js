...
export const switchTerminalShowTabsTitle = localize(12565, null);
        ...
        case 'workspaceRoot':
            if (folders !== undefined && commandService !== undefined) {
                if (folders.length === 1) {
                    ...
                    const options = {
                        placeHolder: localize(12566, null)
                    };
...
let TerminalLaunchHelpAction = class TerminalLaunchHelpAction extends Action {
    constructor(_openerService) {
        super('workbench.action.terminal.launchHelp', localize(12567, null));
...
export function registerTerminalActions() {
    registerTerminalAction({
        ...
        title: localize2(12584, 'Create New Terminal (In Active Workspace)'),
        run: async (c) => {
    ...
    registerTerminalAction({
        ...
        title: localize2(12585, 'Create New Terminal in Editor Area'),
        run: async (c, _, args) => {
    ...
    registerTerminalAction({
        ...
        title: localize2(12586, 'Create New Terminal in Editor Area'),
        f1: false,
    ...
    registerTerminalAction({
        ...
        title: localize2(12587, 'Create New Terminal in Editor Area to the Side'),
        run: async (c) => {
            const instance = await c.service.createTerminal({
    ...
    registerTerminalAction({
        ...
        title: localize2(12588, 'Focus Previous Terminal in Terminal Group'),
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(12589, 'Focus Next Terminal in Terminal Group'),
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(12590, 'Resize Terminal Left'),
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(12591, 'Resize Terminal Right'),
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(12592, 'Resize Terminal Up'),
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(12593, 'Resize Terminal Down'),
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(12594, 'Focus Terminal Tabs View'),
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(12595, 'Focus Next Terminal Group'),
        precondition: sharedWhenClause.terminalAvailable,
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(12596, 'Focus Previous Terminal Group'),
        precondition: sharedWhenClause.terminalAvailable,
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(12597, 'Run Selected Text In Active Terminal'),
    ...
    registerTerminalAction({
        ...
        title: localize2(12598, 'Run Active File In Active Terminal'),
        precondition: sharedWhenClause.terminalAvailable,
        run: async (c, accessor) => {
            const codeEditorService = accessor.get(ICodeEditorService);
            ...
            if ((!isRemote && uri.scheme !== Schemas.file && uri.scheme !== Schemas.vscodeUserData) || (isRemote && uri.scheme !== Schemas.vscodeRemote)) {
                notificationService.warn(localize(12568, null));
                return;
            }
    ...
    registerActiveXtermAction({
        ...
        title: localize2(12599, 'Scroll Down (Line)'),
        keybinding: {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(12600, 'Scroll Down (Page)'),
        keybinding: {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(12601, 'Scroll to Bottom'),
        keybinding: {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(12602, 'Scroll Up (Line)'),
        keybinding: {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(12603, 'Scroll Up (Page)'),
        f1: true,
        keybinding: {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(12604, 'Scroll to Top'),
        keybinding: {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(12605, 'Clear Selection'),
        keybinding: {
    ...
    registerActiveInstanceAction({
        ...
        title: localize2(12606, 'Detach Session'),
    ...
    registerTerminalAction({
        ...
        title: localize2(12607, 'Attach to Session'),
        run: async (c, accessor) => {
            ...
            if (items.length === 0) {
                notificationService.info(localize(12569, null));
                return;
            }
    ...
    registerActiveInstanceAction({
        ...
        title: localize2(12608, 'Select to Previous Command'),
        keybinding: {
    ...
    registerActiveInstanceAction({
        ...
        title: localize2(12609, 'Select to Next Command'),
        keybinding: {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(12610, 'Select to Previous Line'),
        precondition: sharedWhenClause.terminalAvailable,
    ...
    registerActiveXtermAction({
        ...
        title: localize2(12611, 'Select to Next Line'),
        precondition: sharedWhenClause.terminalAvailable,
        run: async (xterm, _, instance) => {
        ...
        metadata: {
            ...
            args: [{
                    ...
                    schema: {
                        ...
                        properties: {
                            cwd: {
                                description: localize(12570, null),
                                type: 'string'
                            }
                        },
                    }
    ...
    registerActiveInstanceAction({
        ...
        metadata: {
            ...
            args: [{
                    ...
                    schema: {
                        ...
                        properties: {
                            name: {
                                description: localize(12571, null),
                                type: 'string',
                                minLength: 1
                            }
                        }
        ...
        run: async (activeInstance, c, accessor, args) => {
            ...
            if (!name) {
                notificationService.warn(localize(12572, null));
                return;
            }
    ...
    registerActiveInstanceAction({
        ...
        title: localize2(12612, 'Relaunch Active Terminal'),
    ...
    registerTerminalAction({
        ...
        title: localize2(12613, 'Join Terminals'),
    ...
    registerTerminalAction({
        ...
        title: localize2(12614, 'Join Terminals...'),
        precondition: sharedWhenClause.terminalAvailable,
        run: async (c, accessor) => {
            ...
            if (c.groupService.instances.length <= 1) {
                notificationService.warn(localize(12573, null));
                return;
            }
            ...
            if (picks.length === 0) {
                notificationService.warn(localize(12574, null));
                return;
            }
    ...
    registerActiveInstanceAction({
        ...
        title: localize2(12615, 'Split Terminal (In Active Workspace)'),
        run: async (instance, c) => {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(12616, 'Select All'),
        precondition: sharedWhenClause.terminalAvailable,
        keybinding: [{
    ...
    registerTerminalAction({
        ...
        title: localize2(12617, 'Create New Terminal'),
        precondition: ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.webExtensionContributedProfile),
    ...
    registerTerminalAction({
        ...
        title: localize2(12618, 'Kill the Active Terminal Instance'),
    ...
    registerTerminalAction({
        ...
        title: localize2(12619, 'Kill All Terminals'),
        precondition: ContextKeyExpr.or(sharedWhenClause.terminalAvailable, TerminalContextKeys.isOpen),
        icon: Codicon.trash,
        run: async (c) => {
    ...
    registerTerminalAction({
        ...
        title: localize2(12620, 'Kill the Active Terminal in Editor Area'),
        precondition: sharedWhenClause.terminalAvailable,
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(12622, 'Select Default Profile'),
    ...
    registerTerminalAction({
        ...
        title: localize2(12623, 'Configure Terminal Settings'),
        precondition: sharedWhenClause.terminalAvailable,
    ...
    registerActiveInstanceAction({
        ...
        title: localize2(12624, 'Set Fixed Dimensions'),
        precondition: sharedWhenClause.terminalAvailable_and_opened,
    ...
    registerTerminalAction({
        ...
        title: localize2(12625, 'Switch Terminal'),
        precondition: sharedWhenClause.terminalAvailable,
        run: async (c, accessor, args) => {
    ...
    newWithProfileAction = registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(12626, 'Create New Terminal (With Profile)'),
                f1: true,
                precondition: ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.webExtensionContributedProfile),
                metadata: {
        ...
        async run(accessor, eventOrOptionsOrProfile, profile) {
            ...
            if (folders.length > 1) {
                ...
                const options = {
                    placeHolder: localize(12580, null)
                };
                const workspace = await commandService.executeCommand(PICK_WORKSPACE_FOLDER_COMMAND_ID, [options]);
                if (!workspace) {
                    // Don't create the instance if the workspace picker was canceled
...
async function pickTerminalCwd(accessor, cancel) {
    ...
    const folderPicks = shrinkedPairs.map(pair => {
        ...
        const description = pair.isOverridden
            ? localize(12581, null, labelService.getUriLabel(pair.cwd, { relative: !pair.isAbsolute }))
    ...
    const options = {
        placeHolder: localize(12582, null),
