...
let Debugger = class Debugger {
    ...
    async createDebugAdapter(session) {
        ...
        throw new Error(nls.localize(7704, null, this.type));
    }
    ...
    getInitialConfigurationContent(initialConfigs) {
        ...
        const comment1 = nls.localize(7705, null);
        const comment2 = nls.localize(7706, null);
        const comment3 = nls.localize(7707, null, 'https://go.microsoft.com/fwlink/?linkid=830387');
        let content = [
            '{',
            `\t// ${comment1}`,
            `\t// ${comment2}`,
    ...
    getSchemaAttributes(definitions) {
        ...
        return Object.entries(this.debuggerContribution.configurationAttributes).map(([request, attributes]) => {
            ...
            properties['type'] = {
                ...
                description: nls.localize(7708, null),
                pattern: '^(?!node2)',
                ...
                errorMessage: nls.localize(7709, null),
                patternErrorMessage: nls.localize(7710, null)
            };
            properties['request'] = {
                enum: [request],
                description: nls.localize(7711, null),
            };
            ...
            attributesCopy.properties = {
                ...
                ...{
                    windows: {
                        ...
                        description: nls.localize(7712, null),
                    },
                    osx: {
                        $ref: `#/definitions/${platformSpecificDefinitionId}`,
                        description: nls.localize(7713, null),
                    },
                    linux: {
                        $ref: `#/definitions/${platformSpecificDefinitionId}`,
                        description: nls.localize(7714, null),
                    }
                }
            };
