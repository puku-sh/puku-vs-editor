    ...
    constructor() {
        super({
            ...
            title: {
                ...
                mnemonicTitle: nls.localize(7524, null)
            },
            metadata: {
                description: nls.localize2(7528, 'Opens the file used to configure how your program is debugged')
            },
            f1: true,
            icon: debugConfigure,
        ...
        if (configurationManager.selectedConfiguration.name) {
            ...
            if (launches.length === 1) {
                ...
                const picked = await quickInputService.pick(picks, {
                    activeItem: picks[0],
                    placeHolder: nls.localize(7525, null)
                });
                if (picked) {
