...
const breakpointHelperDecoration = {
    ...
    glyphMarginHoverMessage: new MarkdownString().appendText(nls.localize(6998, null)),
...
let BreakpointEditorContribution = class BreakpointEditorContribution {
            ...
            if (e.event.rightButton || (env.isMacintosh && e.event.leftButton && e.event.ctrlKey)) {
                ...
                if (breakpoints.length) {
                    ...
                    if (isShiftPressed) {
                        ...
                        const breakpointType = logPoint ? nls.localize(6999, null) : nls.localize(7000, null);
                        const disabledBreakpointDialogMessage = nls.localize(7001, null, breakpointType.toLowerCase(), logPoint ? nls.localize(7002, null) : nls.localize(7003, null));
                        const enabledBreakpointDialogMessage = nls.localize(7004, null, breakpointType.toLowerCase(), logPoint ? nls.localize(7005, null) : nls.localize(7006, null));
                        await this.dialogService.prompt({
                            type: severity.Info,
                            message: enabled ? enabledBreakpointDialogMessage : disabledBreakpointDialogMessage,
                            buttons: [
                                {
                                    label: nls.localize(7007, null, breakpointType),
                                    run: () => breakpoints.forEach(bp => this.debugService.removeBreakpoints(bp.getId()))
                                },
                                {
                                    label: nls.localize(7008, null, enabled ? nls.localize(7009, null) : nls.localize(7010, null), breakpointType),
    ...
    getContextMenuActions(breakpoints, uri, lineNumber, column) {
        ...
        if (breakpoints.length === 1) {
            const breakpointType = breakpoints[0].logMessage ? nls.localize(7011, null) : nls.localize(7012, null);
            actions.push(toAction({
                id: 'debug.removeBreakpoint', label: nls.localize(7013, null, breakpointType), enabled: true, run: async () => {
                    await this.debugService.removeBreakpoints(breakpoints[0].getId());
                }
            }));
            actions.push(toAction({
                id: 'workbench.debug.action.editBreakpointAction',
                label: nls.localize(7014, null, breakpointType),
                enabled: true,
            ...
            actions.push(toAction({
                ...
                label: breakpoints[0].enabled ? nls.localize(7015, null, breakpointType) : nls.localize(7016, null, breakpointType),
                enabled: true,
            ...
            actions.push(new SubmenuAction('debug.removeBreakpoints', nls.localize(7017, null), sorted.map(bp => toAction({
                id: 'removeInlineBreakpoint',
                label: bp.column ? nls.localize(7018, null, bp.column) : nls.localize(7019, null),
                enabled: true,
                run: () => this.debugService.removeBreakpoints(bp.getId())
            }))));
            actions.push(new SubmenuAction('debug.editBreakpoints', nls.localize(7020, null), sorted.map(bp => toAction({
                id: 'editBreakpoint',
                label: bp.column ? nls.localize(7021, null, bp.column) : nls.localize(7022, null),
                enabled: true,
                run: () => Promise.resolve(this.showBreakpointWidget(bp.lineNumber, bp.column))
            }))));
            actions.push(new SubmenuAction('debug.enableDisableBreakpoints', nls.localize(7023, null), sorted.map(bp => toAction({
                id: bp.enabled ? 'disableColumnBreakpoint' : 'enableColumnBreakpoint',
                label: bp.enabled ? (bp.column ? nls.localize(7024, null, bp.column) : nls.localize(7025, null))
                    : (bp.column ? nls.localize(7026, null, bp.column) : nls.localize(7027, null)),
                enabled: true,
...
export const debugIconBreakpointForeground = registerColor('debugIcon.breakpointForeground', '#E51400', nls.localize(7033, null));
const debugIconBreakpointDisabledForeground = registerColor('debugIcon.breakpointDisabledForeground', '#848484', nls.localize(7034, null));
const debugIconBreakpointUnverifiedForeground = registerColor('debugIcon.breakpointUnverifiedForeground', '#848484', nls.localize(7035, null));
const debugIconBreakpointCurrentStackframeForeground = registerColor('debugIcon.breakpointCurrentStackframeForeground', { dark: '#FFCC00', light: '#BE8700', hcDark: '#FFCC00', hcLight: '#BE8700' }, nls.localize(7036, null));
const debugIconBreakpointStackframeForeground = registerColor('debugIcon.breakpointStackframeForeground', '#89D185', nls.localize(7037, null));
