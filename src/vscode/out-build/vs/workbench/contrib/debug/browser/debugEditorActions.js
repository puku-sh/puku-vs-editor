...
class ToggleBreakpointAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(7349, "Debug: Toggle Breakpoint"),
                mnemonicTitle: nls.localize(7338, null),
            },
            f1: true,
...
class ConditionalBreakpointAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(7350, "Debug: Add Conditional Breakpoint..."),
            precondition: CONTEXT_DEBUGGERS_AVAILABLE,
            menuOpts: {
                menuId: MenuId.MenubarNewBreakpointMenu,
                title: nls.localize(7339, null),
                group: '1_breakpoints',
                order: 1,
                when: CONTEXT_DEBUGGERS_AVAILABLE
            }
...
class LogPointAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(7351, "Debug: Add Logpoint..."),
            precondition: CONTEXT_DEBUGGERS_AVAILABLE,
            menuOpts: [
                {
                    menuId: MenuId.MenubarNewBreakpointMenu,
                    title: nls.localize(7340, null),
                    group: '1_breakpoints',
                    order: 4,
                    when: CONTEXT_DEBUGGERS_AVAILABLE,
                }
...
class TriggerByBreakpointAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize(7341, null),
            precondition: CONTEXT_DEBUGGERS_AVAILABLE,
            alias: 'Debug: Triggered Breakpoint...',
            menuOpts: [
                {
                    menuId: MenuId.MenubarNewBreakpointMenu,
                    title: nls.localize(7342, null),
                    group: '1_breakpoints',
                    order: 4,
                    when: CONTEXT_DEBUGGERS_AVAILABLE,
                }
...
class EditBreakpointAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize(7343, null),
            alias: 'Debug: Edit Existing Breakpoint',
            precondition: CONTEXT_DEBUGGERS_AVAILABLE,
            menuOpts: {
                menuId: MenuId.MenubarNewBreakpointMenu,
                title: nls.localize(7344, null),
                group: '1_breakpoints',
                order: 1,
                when: CONTEXT_DEBUGGERS_AVAILABLE
            }
...
class OpenDisassemblyViewAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(7352, "Open Disassembly View"),
                mnemonicTitle: nls.localize(7345, null),
            },
...
class ToggleDisassemblyViewSourceCodeAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(7353, "Toggle Source Code in Disassembly View"),
                mnemonicTitle: nls.localize(7346, null),
            },
            metadata: {
                description: nls.localize2(7354, 'Shows or hides source code in disassembly')
            },
            f1: true,
        });
    }
...
export class RunToCursorAction extends EditorAction {
    ...
    static { this.LABEL = nls.localize2(7355, "Run to Cursor"); }
    constructor() {
        super({
...
export class SelectionToReplAction extends EditorAction {
    ...
    static { this.LABEL = nls.localize2(7356, "Evaluate in Debug Console"); }
    constructor() {
        super({
...
export class SelectionToWatchExpressionsAction extends EditorAction {
    ...
    static { this.LABEL = nls.localize2(7357, "Add to Watch"); }
    constructor() {
        super({
...
class ShowDebugHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(7358, "Debug: Show Hover"),
...
const NO_TARGETS_MESSAGE = nls.localize(7347, null);
class StepIntoTargetsAction extends EditorAction {
    static { this.ID = 'editor.debug.action.stepIntoTargets'; }
    static { this.LABEL = nls.localize(7348, null); }
    constructor() {
        super({
...
class GoToNextBreakpointAction extends GoToBreakpointAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize2(7359, "Debug: Go to Next Breakpoint"),
            precondition: CONTEXT_DEBUGGERS_AVAILABLE
        });
    }
}
class GoToPreviousBreakpointAction extends GoToBreakpointAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize2(7360, "Debug: Go to Previous Breakpoint"),
            precondition: CONTEXT_DEBUGGERS_AVAILABLE
        });
    }
}
class CloseExceptionWidgetAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(7361, "Close Exception Widget"),
