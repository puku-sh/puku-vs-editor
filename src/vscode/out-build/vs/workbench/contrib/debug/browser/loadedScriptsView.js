...
class LoadedScriptsRenderer {
    ...
    render(element, labels, data, filterData) {
        ...
        if (element instanceof RootFolderTreeItem) {
            ...
            options.title = nls.localize(7547, null);
...
class LoadedSciptsAccessibilityProvider {
    getWidgetAriaLabel() {
        return nls.localize(7548, null);
    }
    getAriaLabel(element) {
        if (element instanceof RootFolderTreeItem) {
            return nls.localize(7549, null, element.getLabel());
        }
        if (element instanceof SessionTreeItem) {
            return nls.localize(7550, null, element.getLabel());
        }
        if (element.hasChildren()) {
            return nls.localize(7551, null, element.getLabel());
        }
        else {
            return nls.localize(7552, null, element.getLabel());
        }
    }
}
