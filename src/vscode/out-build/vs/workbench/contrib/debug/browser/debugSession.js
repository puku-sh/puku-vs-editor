...
let DebugSession = class DebugSession {
    ...
    async launchOrAttach(config) {
        if (!this.raw) {
            throw new Error(localize(7455, null, 'launch or attach'));
        }
    ...
    async restart() {
        if (!this.raw) {
            throw new Error(localize(7456, null, 'restart'));
        }
        this.cancelAllRequests();
        if (this._options.lifecycleManagedByParent && this.parentSession) {
    ...
    async sendBreakpoints(modelUri, breakpointsToSend, sourceModified) {
        if (!this.raw) {
            throw new Error(localize(7457, null, 'breakpoints'));
        }
    ...
    async sendFunctionBreakpoints(fbpts) {
        if (!this.raw) {
            throw new Error(localize(7458, null, 'function breakpoints'));
        }
        if (this.raw.readyForBreakpoints) {
    ...
    async sendExceptionBreakpoints(exbpts) {
        if (!this.raw) {
            throw new Error(localize(7459, null, 'exception breakpoints'));
        }
        if (this.raw.readyForBreakpoints) {
    ...
    dataBytesBreakpointInfo(address, bytes) {
        if (this.raw?.capabilities.supportsDataBreakpointBytes === false) {
            throw new Error(localize(7460, null));
        }
    ...
    async _dataBreakpointInfo(args) {
        if (!this.raw) {
            throw new Error(localize(7461, null, 'data breakpoints info'));
        }
        if (!this.raw.readyForBreakpoints) {
            throw new Error(localize(7462, null));
        }
    ...
    async sendDataBreakpoints(dataBreakpoints) {
        if (!this.raw) {
            throw new Error(localize(7463, null, 'data breakpoints'));
        }
        if (this.raw.readyForBreakpoints) {
    ...
    async sendInstructionBreakpoints(instructionBreakpoints) {
        if (!this.raw) {
            throw new Error(localize(7464, null, 'instruction breakpoints'));
        }
        if (this.raw.readyForBreakpoints) {
    ...
    async breakpointsLocations(uri, lineNumber) {
        if (!this.raw) {
            throw new Error(localize(7465, null, 'breakpoints locations'));
        }
    ...
    customRequest(request, args) {
        if (!this.raw) {
            throw new Error(localize(7466, null, request));
        }
        return this.raw.custom(request, args);
    }
    stackTrace(threadId, startFrame, levels, token) {
        if (!this.raw) {
            throw new Error(localize(7467, null, 'stackTrace'));
        }
    ...
    async exceptionInfo(threadId) {
        if (!this.raw) {
            throw new Error(localize(7468, null, 'exceptionInfo'));
        }
    ...
    scopes(frameId, threadId) {
        if (!this.raw) {
            throw new Error(localize(7469, null, 'scopes'));
        }
    ...
    variables(variablesReference, threadId, filter, start, count) {
        if (!this.raw) {
            throw new Error(localize(7470, null, 'variables'));
        }
    ...
    evaluate(expression, frameId, context, location) {
        if (!this.raw) {
            throw new Error(localize(7471, null, 'evaluate'));
        }
    ...
    async restartFrame(frameId, threadId) {
        ...
        if (!this.raw) {
            throw new Error(localize(7472, null, 'restartFrame'));
        }
    ...
    async next(threadId, granularity) {
        await this.waitForTriggeredBreakpoints();
        if (!this.raw) {
            throw new Error(localize(7473, null, 'next'));
        }
    ...
    async stepIn(threadId, targetId, granularity) {
        await this.waitForTriggeredBreakpoints();
        if (!this.raw) {
            throw new Error(localize(7474, null, 'stepIn'));
        }
        this.setLastSteppingGranularity(threadId, granularity);
    ...
    async stepOut(threadId, granularity) {
        await this.waitForTriggeredBreakpoints();
        if (!this.raw) {
            throw new Error(localize(7475, null, 'stepOut'));
        }
        this.setLastSteppingGranularity(threadId, granularity);
    ...
    async stepBack(threadId, granularity) {
        await this.waitForTriggeredBreakpoints();
        if (!this.raw) {
            throw new Error(localize(7476, null, 'stepBack'));
        }
        this.setLastSteppingGranularity(threadId, granularity);
    ...
    async continue(threadId) {
        await this.waitForTriggeredBreakpoints();
        if (!this.raw) {
            throw new Error(localize(7477, null, 'continue'));
        }
    ...
    async reverseContinue(threadId) {
        await this.waitForTriggeredBreakpoints();
        if (!this.raw) {
            throw new Error(localize(7478, null, 'reverse continue'));
        }
        await this.raw.reverseContinue({ threadId });
    }
    async pause(threadId) {
        if (!this.raw) {
            throw new Error(localize(7479, null, 'pause'));
        }
        await this.raw.pause({ threadId });
    }
    async terminateThreads(threadIds) {
        if (!this.raw) {
            throw new Error(localize(7480, null, 'terminateThreads'));
        }
        await this.raw.terminateThreads({ threadIds });
    }
    setVariable(variablesReference, name, value) {
        if (!this.raw) {
            throw new Error(localize(7481, null, 'setVariable'));
        }
        return this.raw.setVariable({ variablesReference, name, value });
    }
    setExpression(frameId, expression, value) {
        if (!this.raw) {
            throw new Error(localize(7482, null, 'setExpression'));
        }
        return this.raw.setExpression({ expression, value, frameId });
    }
    gotoTargets(source, line, column) {
        if (!this.raw) {
            throw new Error(localize(7483, null, 'gotoTargets'));
        }
        return this.raw.gotoTargets({ source, line, column });
    }
    goto(threadId, targetId) {
        if (!this.raw) {
            throw new Error(localize(7484, null, 'goto'));
        }
        return this.raw.goto({ threadId, targetId });
    }
    loadSource(resource) {
        if (!this.raw) {
            return Promise.reject(new Error(localize(7485, null, 'loadSource')));
        }
    ...
    async getLoadedSources() {
        if (!this.raw) {
            return Promise.reject(new Error(localize(7486, null, 'getLoadedSources')));
        }
    ...
    async completions(frameId, threadId, text, position, token) {
        if (!this.raw) {
            return Promise.reject(new Error(localize(7487, null, 'completions')));
        }
    ...
    async stepInTargets(frameId) {
        if (!this.raw) {
            return Promise.reject(new Error(localize(7488, null, 'stepInTargets')));
        }
    ...
    async cancel(progressId) {
        if (!this.raw) {
            return Promise.reject(new Error(localize(7489, null, 'cancel')));
        }
        return this.raw.cancel({ progressId });
    }
    async disassemble(memoryReference, offset, instructionOffset, instructionCount) {
        if (!this.raw) {
            return Promise.reject(new Error(localize(7490, null, 'disassemble')));
        }
    ...
    registerListeners() {
        ...
        this.rawListeners.add(this.raw.onDidTerminateDebugee(async (event) => {
            aria.status(localize(7497, null));
