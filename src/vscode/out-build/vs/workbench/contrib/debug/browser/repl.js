...
let Repl = class Repl extends FilterViewPane {
    ...
    constructor(options, debugService, instantiationService, storageService, themeService, modelService, contextKeyService, codeEditorService, viewDescriptorService, contextMenuService, configurationService, textResourcePropertiesService, editorService, keybindingService, openerService, hoverService, menuService, languageFeaturesService, logService) {
        ...
        super({
            ...options,
            filterOptions: {
                placeholder: localize(7559, null),
                text: filterText,
    ...
    get refreshScheduler() {
        ...
        return new RunOnceScheduler(async () => {
            ...
            this.filterWidget.updateBadge(total === filtered || total === 0 ? undefined : localize(7560, null, filtered, total));
    ...
    getAriaLabel() {
        let ariaLabel = localize(7561, null);
        ...
        if (keybinding) {
            ariaLabel = localize(7562, null, ariaLabel, keybinding);
        }
        else {
            ariaLabel = localize(7563, null, ariaLabel);
        }
        return ariaLabel;
    }
    onContextMenu(e) {
    ...
    updateInputDecoration() {
        ...
        if (this.isReadonly && this.replInput.hasTextFocus() && !this.replInput.getValue()) {
            ...
            decorations.push({
                ...
                renderOptions: {
                    after: {
                        contentText: localize(7564, null),
...
class AcceptReplInputAction extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(7573, "Debug Console: Accept Input"),
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            viewId: REPL_VIEW_ID,
            title: localize2(7574, 'Clear Console'),
            metadata: {
                description: localize2(7575, 'Clears all program output from your debug REPL')
            },
            f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(7576, "Focus on Debug Console View"),
        });
    }
    async run(accessor) {
