...
let LinkDetector = class LinkDetector {
    ...
    decorateLink(link, uri, fulltext, hoverBehavior, onClick) {
        ...
        const followLink = uri && this.tunnelService.canTunnel(uri) ? localize(7541, null) : localize(7542, null);
        const title = link.ariaLabel = fulltext
            ? (platform.isMacintosh ? localize(7543, null, followLink, fulltext) : localize(7544, null, followLink, fulltext))
            : (platform.isMacintosh ? localize(7545, null, followLink) : localize(7546, null, followLink));
