...
export const DEBUG_COMMAND_CATEGORY = nls.localize2(7301, 'Debug');
export const RESTART_LABEL = nls.localize2(7302, "Restart");
export const STEP_OVER_LABEL = nls.localize2(7303, "Step Over");
export const STEP_INTO_LABEL = nls.localize2(7304, "Step Into");
export const STEP_INTO_TARGET_LABEL = nls.localize2(7305, "Step Into Target");
export const STEP_OUT_LABEL = nls.localize2(7306, "Step Out");
export const PAUSE_LABEL = nls.localize2(7307, "Pause");
export const DISCONNECT_LABEL = nls.localize2(7308, "Disconnect");
export const DISCONNECT_AND_SUSPEND_LABEL = nls.localize2(7309, "Disconnect and Suspend");
export const STOP_LABEL = nls.localize2(7310, "Stop");
export const CONTINUE_LABEL = nls.localize2(7311, "Continue");
export const FOCUS_SESSION_LABEL = nls.localize2(7312, "Focus Session");
export const SELECT_AND_START_LABEL = nls.localize2(7313, "Select and Start Debugging");
export const DEBUG_CONFIGURE_LABEL = nls.localize(7294, null, 'launch.json');
export const DEBUG_START_LABEL = nls.localize2(7314, "Start Debugging");
export const DEBUG_RUN_LABEL = nls.localize2(7315, "Start Without Debugging");
export const NEXT_DEBUG_CONSOLE_LABEL = nls.localize2(7316, "Focus Next Debug Console");
export const PREV_DEBUG_CONSOLE_LABEL = nls.localize2(7317, "Focus Previous Debug Console");
export const OPEN_LOADED_SCRIPTS_LABEL = nls.localize2(7318, "Open Loaded Script...");
export const CALLSTACK_TOP_LABEL = nls.localize2(7319, "Navigate to Top of Call Stack");
export const CALLSTACK_BOTTOM_LABEL = nls.localize2(7320, "Navigate to Bottom of Call Stack");
export const CALLSTACK_UP_LABEL = nls.localize2(7321, "Navigate Up Call Stack");
export const CALLSTACK_DOWN_LABEL = nls.localize2(7322, "Navigate Down Call Stack");
export const COPY_EVALUATE_PATH_LABEL = nls.localize2(7323, "Copy as Expression");
export const COPY_VALUE_LABEL = nls.localize2(7324, "Copy Value");
export const COPY_ADDRESS_LABEL = nls.localize2(7325, "Copy Address");
export const ADD_TO_WATCH_LABEL = nls.localize2(7326, "Add to Watch");
export const SELECT_DEBUG_CONSOLE_LABEL = nls.localize2(7327, "Select Debug Console");
export const SELECT_DEBUG_SESSION_LABEL = nls.localize2(7328, "Select Debug Session");
...
CommandsRegistry.registerCommand({
    ...
    handler: async (accessor) => {
            ...
            if (source) {
                ...
                if (targets && targets.length) {
                    ...
                    if (targets.length > 1) {
                        ...
                        const pick = await quickInputService.pick(picks, { placeHolder: nls.localize(7295, null) });
                        if (!pick) {
                            return;
                        }
                        id = pick._id;
        ...
        return notificationService.warn(nls.localize(7296, null));
    }
});
CommandsRegistry.registerCommand({
    id: CALLSTACK_TOP_ID,
    ...
    handler: async (accessor, _, context) => {
        ...
        session.stepInTargets(frame.frameId).then(targets => {
            ...
            if (targets?.length) {
                ...
                qp.placeholder = nls.localize(7298, null);
            }
        });
    }
});
...
registerAction2(class AddConfigurationAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(7329, "Add Configuration..."),
            category: DEBUG_COMMAND_CATEGORY,
            f1: true,
            menu: {
...
registerAction2(class ToggleExceptionBreakpointsAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(7330, "Toggle Exception Breakpoints"),
            category: DEBUG_COMMAND_CATEGORY,
            f1: true,
    ...
    async run(accessor) {
        ...
        quickPick.placeholder = nls.localize(7300, null);
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(7331, "Attach to Current Code Renderer"),
        });
    }
    async run(accessor) {
