...
Registry.as(ConfigurationExtensions.Configuration).registerConfiguration({
    id: 'comments',
    order: 20,
    title: nls.localize(6850, null),
    type: 'object',
    properties: {
        'comments.openPanel': {
            enum: ['neverOpen', 'openOnSessionStart', 'openOnSessionStartWithComments'],
            default: 'openOnSessionStartWithComments',
            description: nls.localize(6851, null),
            restricted: false,
            markdownDeprecationMessage: nls.localize(6852, null)
        },
        'comments.openView': {
            enum: ['never', 'file', 'firstFile', 'firstFileUnresolved'],
            enumDescriptions: [nls.localize(6853, null), nls.localize(6854, null), nls.localize(6855, null), nls.localize(6856, null)],
            default: 'firstFile',
            description: nls.localize(6857, null),
            restricted: false
        },
        'comments.useRelativeTime': {
            type: 'boolean',
            default: true,
            description: nls.localize(6858, null)
        },
        'comments.visible': {
            type: 'boolean',
            default: true,
            description: nls.localize(6859, null)
        },
        'comments.maxHeight': {
            type: 'boolean',
            default: true,
            description: nls.localize(6860, null)
        },
        'comments.collapseOnResolve': {
            type: 'boolean',
            default: true,
            description: nls.localize(6861, null)
        },
        'comments.thread.confirmOnCollapse': {
            type: 'string',
            enum: ['whenHasUnsubmittedComments', 'never'],
            enumDescriptions: [nls.localize(6862, null), nls.localize(6863, null)],
            default: 'whenHasUnsubmittedComments',
            description: nls.localize(6864, null)
        }
    }
});
...
let UnresolvedCommentsBadge = class UnresolvedCommentsBadge extends Disposable {
    ...
    updateBadge(unresolved) {
        ...
        const message = nls.localize(6865, null, this.totalUnresolved);
