...
export class ShowSignalSoundHelp extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(4839, "Help: List Signal Sounds"),
            f1: true,
            metadata: {
                description: localize(4832, null)
            }
        });
    }
    async run(accessor) {
        ...
        qp.placeholder = localize(4834, null);
...
export class ShowAccessibilityAnnouncementHelp extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(4840, "Help: List Signal Announcements"),
            f1: true,
            metadata: {
    ...
    async run(accessor) {
        ...
        disposables.add(qp.onDidHide(() => disposables.dispose()));
        qp.placeholder = screenReaderOptimized ? localize(4837, null) : localize(4838, null);
        qp.canSelectMany = true;
        await qp.show();
    }
}
