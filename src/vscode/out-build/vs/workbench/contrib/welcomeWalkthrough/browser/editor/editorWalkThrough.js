...
export class EditorWalkThroughAction extends Action2 {
    ...
    static { this.LABEL = localize2(14604, 'Interactive Editor Playground'); }
    constructor() {
        super({
            ...
            f1: true,
            metadata: {
                description: localize2(14605, "Opens an interactive playground for learning about the editor.")
            }
        });
    }
    run(serviceAccessor) {
