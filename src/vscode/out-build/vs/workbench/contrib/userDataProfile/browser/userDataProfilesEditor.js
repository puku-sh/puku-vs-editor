...
const editIcon = registerIcon('profiles-editor-edit-folder', Codicon.edit, localize(14053, null));
const removeIcon = registerIcon('profiles-editor-remove-folder', Codicon.close, localize(14054, null));
export const profilesSashBorder = registerColor('profiles.sashBorder', PANEL_BORDER, localize(14055, null));
...
let UserDataProfilesEditor = class UserDataProfilesEditor extends EditorPane {
    ...
    renderNewProfileButton(parent) {
            ...
            actions: {
                getActions: () => {
                    ...
                    if (this.templates.length) {
                        actions.push(new SubmenuAction('from.template', localize(14057, null), this.getCreateFromTemplateActions()));
                        actions.push(new Separator());
                    }
                    actions.push(toAction({
                        id: 'importProfile',
                        label: localize(14058, null),
        ...
        button.label = localize(14059, null);
    ...
    getTreeContextMenuActions() {
        ...
        actions.push(toAction({
            id: 'newProfile',
            label: localize(14060, null),
            run: () => this.createNewProfile()
        }));
        const templateActions = this.getCreateFromTemplateActions();
        if (templateActions.length) {
            actions.push(new SubmenuAction('from.template', localize(14061, null), templateActions));
        }
        actions.push(new Separator());
        actions.push(toAction({
            id: 'importProfile',
            label: localize(14062, null),
            run: () => this.importProfile()
        }));
        return actions;
    }
    async importProfile() {
        ...
        const updateQuickPickItems = (value) => {
            ...
            if (value) {
                quickPickItems.push({ label: quickPick.value, description: localize(14063, null) });
            }
            quickPickItems.push({ label: localize(14064, null) });
            quickPick.items = quickPickItems;
        };
        quickPick.title = localize(14065, null);
        quickPick.placeholder = localize(14066, null);
...
let ProfileElementRenderer = class ProfileElementRenderer {
    ...
    renderTemplate(container) {
        ...
        append(description, $(`span${ThemeIcon.asCSSSelector(Codicon.check)}`), $('span', undefined, localize(14068, null)));
...
let ProfileNameRenderer = class ProfileNameRenderer extends ProfilePropertyRenderer {
    ...
    renderTemplate(parent) {
        ...
        append(nameContainer, $('.profile-label-element', undefined, localize(14075, null)));
        const nameInput = disposables.add(new InputBox(nameContainer, this.contextViewService, {
            inputBoxStyles: getInputBoxStyle({
                inputBorder: settingsTextInputBorder
            }),
            ariaLabel: localize(14076, null),
            placeholder: localize(14077, null),
            validationOptions: {
                validation: (value) => {
                    if (!value) {
                        return {
                            content: localize(14078, null),
                    ...
                    if (initialName !== value && this.userDataProfilesService.profiles.some(p => !p.isTransient && p.name === value)) {
                        return {
                            content: localize(14079, null, value),
                            type: 2 /* MessageType.WARNING */
                        };
                    }
                    return null;
        ...
        const renderName = (profileElement) => {
            ...
            if (isDefaultProfile) {
                nameInput.setTooltip(localize(14080, null));
            }
            else {
                nameInput.setTooltip(localize(14081, null));
            }
        };
        return {
            set element(element) {
...
let ProfileIconRenderer = class ProfileIconRenderer extends ProfilePropertyRenderer {
    ...
    renderTemplate(parent) {
        ...
        append(iconContainer, $('.profile-label-element', undefined, localize(14082, null)));
        const iconValueContainer = append(iconContainer, $('.profile-icon-container'));
        const iconElement = append(iconValueContainer, $(`${ThemeIcon.asCSSSelector(DEFAULT_ICON)}`, { 'tabindex': '0', 'role': 'button', 'aria-label': localize(14083, null) }));
        ...
        append(iconValueContainer, $('.profile-description-element', undefined, localize(14084, null)));
        const renderIcon = (profileElement) => {
            if (profileElement?.root instanceof UserDataProfileElement && profileElement.root.profile.isDefault) {
                iconValueContainer.classList.add('disabled');
                iconHover.update(localize(14085, null));
            }
            else {
                iconHover.update(localize(14086, null));
...
let UseForCurrentWindowPropertyRenderer = class UseForCurrentWindowPropertyRenderer extends ProfilePropertyRenderer {
    ...
    renderTemplate(parent) {
        ...
        append(useForCurrentWindowContainer, $('.profile-label-element', undefined, localize(14087, null)));
        const useForCurrentWindowValueContainer = append(useForCurrentWindowContainer, $('.profile-use-for-current-container'));
        const useForCurrentWindowTitle = localize(14088, null);
...
class UseAsDefaultProfileRenderer extends ProfilePropertyRenderer {
    ...
    renderTemplate(parent) {
        ...
        append(useAsDefaultProfileContainer, $('.profile-label-element', undefined, localize(14089, null)));
        const useAsDefaultProfileValueContainer = append(useAsDefaultProfileContainer, $('.profile-use-as-default-container'));
        const useAsDefaultProfileTitle = localize(14090, null);
...
let CopyFromProfileRenderer = class CopyFromProfileRenderer extends ProfilePropertyRenderer {
    ...
    renderTemplate(parent) {
        ...
        append(copyFromContainer, $('.profile-label-element', undefined, localize(14091, null)));
        append(copyFromContainer, $('.profile-description-element', undefined, localize(14092, null)));
    ...
    getCopyFromOptions(profileElement) {
        ...
        copyFromOptions.push({ text: localize(14094, null) });
        ...
        if (this.templates.length) {
            copyFromOptions.push({ ...SeparatorSelectOption, decoratorRight: localize(14095, null) });
            for (const template of this.templates) {
                copyFromOptions.push({ text: template.name, id: template.url, source: URI.parse(template.url) });
            }
        }
        copyFromOptions.push({ ...SeparatorSelectOption, decoratorRight: localize(14096, null) });
...
let ContentsProfileRenderer = class ContentsProfileRenderer extends ProfilePropertyRenderer {
    ...
    renderTemplate(parent) {
        ...
        append(configureRowContainer, $('.profile-label-element', undefined, localize(14097, null)));
        ...
        const optionsLabel = $('.options-header', undefined, $('span', undefined, localize(14098, null)));
        append(contentsTreeHeader, $(''), $('', undefined, localize(14099, null)), optionsLabel, $(''));
        ...
        const updateDescription = (element) => {
            ...
            if (element.root instanceof UserDataProfileElement && element.root.profile.isDefault) {
                markdown.appendMarkdown(localize(14100, null));
            }
            else {
                markdown.appendMarkdown(localize(14101, null));
                if (element.root instanceof NewProfileElement) {
                    ...
                    const optionName = copyFromName === this.userDataProfilesService.defaultProfile.name
                        ? localize(14102, null, copyFromName)
                        : copyFromName;
                    if (optionName) {
                        markdown
                            .appendMarkdown(localize(14103, null, optionName, copyFromName));
                    }
                    markdown
                        .appendMarkdown(localize(14104, null))
                        .appendMarkdown(localize(14105, null));
                }
            }
...
let ProfileWorkspacesRenderer = class ProfileWorkspacesRenderer extends ProfilePropertyRenderer {
    ...
    renderTemplate(parent) {
        ...
        append(profileWorkspacesRowContainer, $('.profile-label-element', undefined, localize(14106, null)));
            ...
            accessibilityProvider: {
                getAriaLabel: (item) => {
                    ...
                    if (hostLabel === undefined || hostLabel.length === 0) {
                        return localize(14109, null, this.labelService.getUriLabel(item.workspace));
                    }
                    return localize(14110, null, this.labelService.getUriLabel(item.workspace), hostLabel);
                },
                getWidgetAriaLabel: () => localize(14111, null)
            },
            identityProvider: {
                getId(element) {
        ...
        const addButton = this._register(buttonBar.addButton({ title: localize(14112, null), ...defaultButtonStyles }));
        addButton.label = localize(14113, null);
        disposables.add(addButton.onDidClick(async () => {
            const uris = await this.fileDialogService.showOpenDialog({
                canSelectFiles: false,
                canSelectFolders: true,
                canSelectMany: true,
                openLabel: localize(14114, null),
                title: localize(14115, null)
            });
            if (uris) {
                if (profileElement?.root instanceof UserDataProfileElement) {
        ...
        const updateTable = () => {
            if (profileElement?.root instanceof UserDataProfileElement && profileElement.root.workspaces?.length) {
                profileWorkspacesDescriptionElement.textContent = localize(14116, null);
                ...
                profileWorkspacesDescriptionElement.textContent = localize(14117, null);
    ...
    renderElement({ element: profileResourceTreeElement }, index, templateData) {
        ...
        const updateRadioItems = () => {
            templateData.radio.setItems([{
                    text: localize(14118, null),
                    tooltip: localize(14119, null, resourceTypeTitle),
                    isActive: root.getFlag(element.resourceType)
                },
                {
                    text: root.name,
                    tooltip: localize(14120, null, resourceTypeTitle, root.name),
                    isActive: !root.getFlag(element.resourceType)
                }]);
        };
...
let NewProfileResourceTreeRenderer = class NewProfileResourceTreeRenderer extends AbstractProfileResourceTreeRenderer {
    ...
    renderElement({ element: profileResourceTreeElement }, index, templateData) {
        ...
        const renderRadioItems = () => {
            const options = [{
                    text: localize(14121, null),
                    tooltip: localize(14122, null, resourceTypeTitle),
                },
                {
                    text: localize(14123, null),
                    tooltip: localize(14124, null, resourceTypeTitle)
                }];
            const copyFromName = root.getCopyFromName();
            const name = copyFromName === this.userDataProfilesService.defaultProfile.name
                ? localize(14125, null, copyFromName)
                : copyFromName;
            if (root.copyFrom && name) {
                templateData.radio.setItems([
                    {
                        text: name,
                        tooltip: name ? localize(14126, null, resourceTypeTitle, name) : localize(14127, null),
                    },
                    ...options
                ]);
...
let ChangeProfileAction = class ChangeProfileAction {
    constructor(item, userDataProfilesService) {
        ...
        this.enabled = true;
        this.tooltip = localize(14128, null);
        this.checked = false;
    }
    run() { }
...
function getHostLabel(labelService, workspaceUri) {
    return workspaceUri.authority ? labelService.getHostLabel(workspaceUri.scheme, workspaceUri.authority) : localize(14131, null);
}
let UserDataProfilesEditorInput = class UserDataProfilesEditorInput extends EditorInput {
    ...
    getName() { return localize(14132, null); }
