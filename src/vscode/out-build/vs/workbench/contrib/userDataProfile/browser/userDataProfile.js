...
let UserDataProfilesWorkbenchContribution = class UserDataProfilesWorkbenchContribution extends Disposable {
    ...
    registerEditor() {
        Registry.as(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(UserDataProfilesEditor, UserDataProfilesEditor.ID, localize(14027, null)), [
    ...
    registerProfileSubMenu() {
        const getProfilesTitle = () => {
            return localize(14028, null, this.userDataProfileService.currentProfile.name);
        };
        ...
        return registerAction2(class ProfileEntryAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: profile.name,
                    metadata: {
                        description: localize2(14037, "Switch to {0} profile", profile.name),
                    },
        ...
        return registerAction2(class NewWindowWithProfileAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(14038, "New Window with Profile..."),
            ...
            async run(accessor) {
                ...
                const pick = await quickInputService.pick(userDataProfilesService.profiles.map(profile => ({
                    ...
                    title: localize(14030, null),
                    placeHolder: localize(14031, null),
                    canPickMany: false
                });
                if (pick) {
    ...
    registerNewWindowAction(profile) {
        ...
        disposables.add(registerAction2(class NewWindowAction extends Action2 {
            constructor() {
                super({
                    id,
                    title: localize2(14039, "{0}", profile.name),
                    metadata: {
                        description: localize2(14040, "Open New Window with {0} Profile", profile.name),
                    },
                    menu: {
                        id: OpenProfileMenu,
                        group: '0_profiles',
        ...
        disposables.add(MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
            command: {
                id,
                category: PROFILES_CATEGORY,
                title: localize2(14041, "Open {0} Profile", profile.name),
                precondition: HAS_PROFILES_CONTEXT
            },
        }));
        return disposables;
        ...
        return registerAction2(class SwitchProfileAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(14042, 'Switch Profile...'),
                    category: PROFILES_CATEGORY,
                    f1: true,
                });
            }
            async run(accessor) {
                ...
                const result = await quickInputService.pick(items.sort((a, b) => a.profile.name.localeCompare(b.profile.name)), {
                    placeHolder: localize(14032, null)
                });
                if (result) {
    ...
    registerManageProfilesAction() {
        ...
        disposables.add(registerAction2(class ManageProfilesAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: {
                        ...localize2(14043, "Profiles"),
                        mnemonicTitle: localize(14033, null),
                    },
                    menu: [
                        {
        ...
        disposables.add(MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
            command: {
                ...
                title: localize2(14044, "Open Profiles (UI)"),
            },
        }));
        return disposables;
    }
    registerExportCurrentProfileAction() {
        ...
        disposables.add(registerAction2(class ExportProfileAction extends Action2 {
            constructor() {
                super({
                    id,
                    title: localize2(14045, "Export Profile..."),
                    category: PROFILES_CATEGORY,
                    f1: true,
                });
            }
        ...
        disposables.add(MenuRegistry.appendMenuItem(MenuId.MenubarShare, {
            command: {
                id,
                title: localize2(14046, "Export Profile ({0})...", that.userDataProfileService.currentProfile.name),
            },
        }));
        return disposables;
    }
        ...
        this._register(registerAction2(class CreateFromCurrentProfileAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(14047, "Save Current Profile As..."),
                    category: PROFILES_CATEGORY,
                    f1: true,
                });
            }
        ...
        this._register(registerAction2(class CreateProfileAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(14048, "New Profile..."),
                    category: PROFILES_CATEGORY,
                    f1: true,
                    menu: [
                        {
        ...
        this._register(registerAction2(class DeleteProfileAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(14049, "Delete Profile..."),
                    category: PROFILES_CATEGORY,
                    f1: true,
                    precondition: HAS_PROFILES_CONTEXT,
                });
            ...
            async run(accessor) {
                ...
                if (profiles.length) {
                    const picks = await quickInputService.pick(profiles.map(profile => ({
                        label: profile.name,
                        description: profile.id === userDataProfileService.currentProfile.id ? localize(14034, null) : undefined,
                        profile
                    })), {
                        title: localize(14035, null),
                        placeHolder: localize(14036, null),
                        canPickMany: true
                    });
                    if (picks) {
                        try {
