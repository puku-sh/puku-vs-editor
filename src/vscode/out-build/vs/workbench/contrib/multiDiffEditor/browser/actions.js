...
export class GoToFileAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10064, 'Open File'),
...
export class GoToNextChangeAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10065, 'Go to Next Change'),
...
export class GoToPreviousChangeAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10066, 'Go to Previous Change'),
...
export class CollapseAllAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10067, 'Collapse All Diffs'),
...
export class ExpandAllAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10068, 'Expand All Diffs'),
