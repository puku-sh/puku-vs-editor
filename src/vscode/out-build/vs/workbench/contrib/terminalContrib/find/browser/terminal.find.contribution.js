...
registerActiveXtermAction({
    ...
    title: localize2(13261, 'Focus Find'),
    keybinding: {
...
registerActiveXtermAction({
    ...
    title: localize2(13262, 'Hide Find'),
    keybinding: {
...
registerActiveXtermAction({
    ...
    title: localize2(13263, 'Toggle Find Using Regex'),
    keybinding: {
...
registerActiveXtermAction({
    ...
    title: localize2(13264, 'Toggle Find Using Whole Word'),
    keybinding: {
...
registerActiveXtermAction({
    ...
    title: localize2(13265, 'Toggle Find Using Case Sensitive'),
    keybinding: {
...
registerActiveXtermAction({
    ...
    title: localize2(13266, 'Find Next'),
    keybinding: [
        {
...
registerActiveXtermAction({
    ...
    title: localize2(13267, 'Find Previous'),
    keybinding: [
        {
...
registerActiveInstanceAction({
    ...
    title: localize2(13268, 'Search Workspace'),
    keybinding: [
        {
