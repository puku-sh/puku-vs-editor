...
quickAccessRegistry.registerQuickAccessProvider({
    ...
    placeholder: nls.localize(13309, null),
    helpEntries: [{ description: nls.localize(13310, null), commandId: "workbench.action.quickOpenTerm" /* TerminalQuickAccessCommandId.QuickOpenTerm */ }]
});
...
registerTerminalAction({
    ...
    title: nls.localize2(13311, 'Switch Active Terminal'),
