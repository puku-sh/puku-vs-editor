...
let TerminalStickyScrollOverlay = class TerminalStickyScrollOverlay extends Disposable {
    ...
    _ensureElement() {
        ...
        // Fill tooltip
        let hoverTitle = localize(13351, null);
        ...
        if (scrollToPreviousCommandKeybinding) {
            ...
            if (label) {
                hoverTitle += '\n' + localize(13352, null, terminalStrings.scrollToPreviousCommand.value, label);
            }
        }
        ...
        if (scrollToNextCommandKeybinding) {
            ...
            if (label) {
                hoverTitle += '\n' + localize(13353, null, terminalStrings.scrollToNextCommand.value, label);
            }
        }
