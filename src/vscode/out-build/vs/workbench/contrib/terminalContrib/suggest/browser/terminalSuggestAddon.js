...
let SuggestAddon = class SuggestAddon extends Disposable {
    ...
    constructor(_sessionId, shellType, _capabilities, _terminalSuggestWidgetVisibleContextKey, _terminalCompletionService, _configurationService, _instantiationService, _terminalConfigurationService, _logService) {
        ...
        this._kindToKindLabelMap = new Map([
            [TerminalCompletionItemKind.File, localize(13371, null)],
            [TerminalCompletionItemKind.Folder, localize(13372, null)],
            [TerminalCompletionItemKind.SymbolicLinkFile, localize(13373, null)],
            [TerminalCompletionItemKind.SymbolicLinkFolder, localize(13374, null)],
            [TerminalCompletionItemKind.Method, localize(13375, null)],
            [TerminalCompletionItemKind.Alias, localize(13376, null)],
            [TerminalCompletionItemKind.Argument, localize(13377, null)],
            [TerminalCompletionItemKind.Option, localize(13378, null)],
            [TerminalCompletionItemKind.OptionValue, localize(13379, null)],
            [TerminalCompletionItemKind.Flag, localize(13380, null)],
            [TerminalCompletionItemKind.Commit, localize(13381, null)],
            [TerminalCompletionItemKind.Branch, localize(13382, null)],
            [TerminalCompletionItemKind.Tag, localize(13383, null)],
            [TerminalCompletionItemKind.Stash, localize(13384, null)],
            [TerminalCompletionItemKind.Remote, localize(13385, null)],
            [TerminalCompletionItemKind.PullRequest, localize(13386, null)],
            [TerminalCompletionItemKind.PullRequestDone, localize(13387, null)],
            [TerminalCompletionItemKind.InlineSuggestion, localize(13388, null)],
            [TerminalCompletionItemKind.InlineSuggestionAlwaysOnTop, localize(13389, null)],
        ]);
