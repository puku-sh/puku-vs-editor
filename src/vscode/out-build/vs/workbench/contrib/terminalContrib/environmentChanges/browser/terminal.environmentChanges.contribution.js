...
registerActiveInstanceAction({
    ...
    title: localize2(13260, 'Show Environment Contributions'),
...
function describeEnvironmentChanges(collection, scope) {
    let content = `# ${localize(13257, null)}`;
    ...
    for (const [ext, coll] of collection.collections) {
        ...
        if (workspaceDescription) {
            ...
            const workspaceSuffix = globalDescription ? ` (${localize(13259, null)})` : '';
