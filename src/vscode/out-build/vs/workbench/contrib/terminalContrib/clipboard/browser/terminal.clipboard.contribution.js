...
registerActiveInstanceAction({
    ...
    title: localize2(13236, "Copy Last Command"),
...
registerActiveInstanceAction({
    ...
    title: localize2(13237, "Copy Last Command Output"),
    precondition: terminalAvailableWhenClause,
    run: async (instance, c, accessor) => {
        const clipboardService = accessor.get(IClipboardService);
        const commands = instance.capabilities.get(2 /* TerminalCapability.CommandDetection */)?.commands;
...
registerActiveInstanceAction({
    ...
    title: localize2(13238, "Copy Last Command and Output"),
    precondition: terminalAvailableWhenClause,
    run: async (instance, c, accessor) => {
        const clipboardService = accessor.get(IClipboardService);
        const commands = instance.capabilities.get(2 /* TerminalCapability.CommandDetection */)?.commands;
...
if (BrowserFeatures.clipboard.writeText) {
    registerActiveXtermAction({
        ...
        title: localize2(13239, 'Copy Selection'),
    ...
    registerActiveXtermAction({
        ...
        title: localize2(13240, 'Copy and Clear Selection'),
        precondition: ContextKeyExpr.or(TerminalContextKeys.textSelectedInFocused, ContextKeyExpr.and(terminalAvailableWhenClause, TerminalContextKeys.textSelected)),
        keybinding: [{
    ...
    registerActiveXtermAction({
        ...
        title: localize2(13241, 'Copy Selection as HTML'),
        f1: true,
...
if (BrowserFeatures.clipboard.readText) {
    registerActiveInstanceAction({
        ...
        title: localize2(13242, 'Paste into Active Terminal'),
        precondition: terminalAvailableWhenClause,
        keybinding: [{
...
if (BrowserFeatures.clipboard.readText && isLinux) {
    registerActiveInstanceAction({
        ...
        title: localize2(13243, 'Paste Selection into Active Terminal'),
        precondition: terminalAvailableWhenClause,
        keybinding: [{
