...
registerActiveInstanceAction({
    ...
    title: localize2(13282, 'Open Detected Link...'),
    f1: true,
    category,
...
registerActiveInstanceAction({
    ...
    title: localize2(13283, 'Open Last URL Link'),
    metadata: {
        description: localize2(13284, 'Opens the last detected URL/URI link in the terminal')
    },
    f1: true,
    category,
    precondition: TerminalContextKeys.terminalHasBeenCreated,
...
registerActiveInstanceAction({
    ...
    title: localize2(13285, 'Open Last Local File Link'),
    f1: true,
    category,
    precondition: TerminalContextKeys.terminalHasBeenCreated,
