...
const taskDefinitionSchema = {
    ...
    properties: {
        type: {
            type: 'string',
            description: nls.localize(12528, null)
        },
        required: {
            type: 'array',
            items: {
        ...
        properties: {
            type: 'object',
            description: nls.localize(12529, null),
        ...
        when: {
            type: 'string',
            markdownDescription: nls.localize(12530, null),
            default: ''
        }
    }
};
...
(function (Configuration) {
    function from(value, extensionId, messageCollector) {
        ...
        if (!taskType || taskType.length === 0) {
            messageCollector.error(nls.localize(12531, null));
            return undefined;
        }
        const required = [];
...
const taskDefinitionsExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: nls.localize(12532, null),
        type: 'array',
