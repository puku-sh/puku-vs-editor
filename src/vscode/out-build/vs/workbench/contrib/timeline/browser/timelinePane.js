...
class LoadMoreCommand {
    ...
    get label() {
        return this.loading ? localize(13915, null) : localize(13916, null);
    }
    get themeIcon() {
        return undefined;
    }
...
let TimelinePane = class TimelinePane extends ViewPane {
    static { this.TITLE = localize2(13930, "Timeline"); }
    ...
    *getItems() {
    ...
    refresh() {
        ...
        if (this.uri === undefined) {
            ...
            this.message = localize(13917, null);
        }
        else if (this._isEmpty) {
    ...
    renderBody(container) {
        ...
        this.message = localize(13923, null);
        ...
        this.tree = this.instantiationService.createInstance((WorkbenchObjectTree), 'TimelinePane', this.$tree, new TimelineListVirtualDelegate(), [this.treeRenderer], {
            ...
            accessibilityProvider: {
                getAriaLabel(element) {
                    ...
                    return element.accessibilityInformation ? element.accessibilityInformation.label : localize(13924, null, element.relativeTimeFullWord ?? '', element.label);
                },
                getRole(element) {
                    if (isLoadMoreCommand(element)) {
                        return 'treeitem';
    ...
    setLoadingUriMessage() {
        ...
        this.message = file ? localize(13926, null, file) : '';
    }
...
const timelineRefresh = registerIcon('timeline-refresh', Codicon.refresh, localize(13927, null));
const timelinePin = registerIcon('timeline-pin', Codicon.pin, localize(13928, null));
const timelineUnpin = registerIcon('timeline-unpin', Codicon.pinned, localize(13929, null));
    ...
    constructor(pane, timelineService, storageService, contextKeyService, menuService) {
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    id: 'timeline.refresh',
                    title: localize2(13931, "Refresh"),
                    icon: timelineRefresh,
                    category: localize2(13932, "Timeline"),
                    menu: {
        ...
        this._register(MenuRegistry.appendMenuItem(MenuId.TimelineTitle, ({
            command: {
                ...
                title: localize2(13933, 'Pin the Current Timeline'),
                icon: timelinePin,
                category: localize2(13934, "Timeline"),
            },
            group: 'navigation',
            order: 98,
        ...
        this._register(MenuRegistry.appendMenuItem(MenuId.TimelineTitle, ({
            command: {
                id: 'timeline.toggleFollowActiveEditor',
                title: localize2(13935, 'Unpin the Current Timeline'),
                icon: timelineUnpin,
                category: localize2(13936, "Timeline"),
            },
            group: 'navigation',
            order: 98,
