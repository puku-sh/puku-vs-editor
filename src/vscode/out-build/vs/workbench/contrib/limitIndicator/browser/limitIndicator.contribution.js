...
const configureSettingsLabel = nls.localize(9291, null);
/**
...
class ColorDecorationAccessor {
    constructor() {
        ...
        this.name = nls.localize(9292, null);
        this.label = nls.localize(9293, null);
        this.source = nls.localize(9294, null);
...
class FoldingRangeAccessor {
    constructor() {
        ...
        this.name = nls.localize(9295, null);
        this.label = nls.localize(9296, null);
        this.source = nls.localize(9297, null);
    ...
    updateStatusItem(info) {
        ...
        if (info && info.limited !== false) {
            const status = {
                ...
                detail: nls.localize(9298, null, info.limited),
