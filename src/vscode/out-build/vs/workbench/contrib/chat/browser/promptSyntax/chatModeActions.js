...
class ConfigAgentActionImpl extends Action2 {
    async run(accessor) {
        ...
        const placeholder = localize(6240, null);
...
class PickerConfigAgentAction extends ConfigAgentActionImpl {
    constructor() {
        super({
            ...
            title: localize2(6242, "Configure Custom Agents..."),
...
class ManageAgentsAction extends ConfigAgentActionImpl {
    constructor() {
        super({
            ...
            title: localize2(6243, "Configure Custom Agents..."),
            shortTitle: localize(6241, null),
