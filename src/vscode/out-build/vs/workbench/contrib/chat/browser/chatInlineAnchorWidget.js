...
registerAction2(class AddFileToChatAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(5785, "Add File to Chat"),
            menu: [{
...
registerAction2(class OpenToSideResourceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(5787, "Open to the Side"),
            f1: false,
            precondition: chatAttachmentResourceContextKey,
            keybinding: {
...
registerAction2(class GoToDefinitionAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(5788, "Go to Definition"),
                mnemonicTitle: nls.localize(5781, null),
            },
            menu: [MenuId.ChatInlineSymbolAnchorContext, MenuId.ChatInputSymbolAttachmentContext].map(id => ({
                id,
                group: '4_symbol_nav',
...
registerAction2(class GoToTypeDefinitionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(5789, "Go to Type Definitions"),
                mnemonicTitle: nls.localize(5782, null),
            },
            menu: [MenuId.ChatInlineSymbolAnchorContext, MenuId.ChatInputSymbolAttachmentContext].map(id => ({
                id,
                group: '4_symbol_nav',
...
registerAction2(class GoToImplementations extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(5790, "Go to Implementations"),
                mnemonicTitle: nls.localize(5783, null),
            },
            menu: [MenuId.ChatInlineSymbolAnchorContext, MenuId.ChatInputSymbolAttachmentContext].map(id => ({
                id,
                group: '4_symbol_nav',
...
registerAction2(class GoToReferencesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(5791, "Go to References"),
                mnemonicTitle: nls.localize(5784, null),
            },
            menu: [MenuId.ChatInlineSymbolAnchorContext, MenuId.ChatInputSymbolAttachmentContext].map(id => ({
                id,
                group: '4_symbol_nav',
