...
export class SaveAsPromptFileAction extends BaseSaveAsPromptFileAction {
    constructor() {
        super(createOptions(SAVE_AS_PROMPT_FILE_ACTION_ID, localize2(6317, "Save As Prompt File"), localize2(6318, "Save as prompt file"), PROMPT_LANGUAGE_ID), PromptsType.prompt);
    }
}
...
export class SaveAsAgentFileAction extends BaseSaveAsPromptFileAction {
    constructor() {
        super(createOptions(SAVE_AS_AGENT_FILE_ACTION_ID, localize2(6319, "Save As Agent File"), localize2(6320, "Save as agent file"), AGENT_LANGUAGE_ID), PromptsType.agent);
    }
}
...
export class SaveAsInstructionsFileAction extends BaseSaveAsPromptFileAction {
    constructor() {
        super(createOptions(SAVE_AS_INSTRUCTIONS_FILE_ACTION_ID, localize2(6321, "Save As Instructions File"), localize2(6322, "Save as instructions file"), INSTRUCTIONS_LANGUAGE_ID), PromptsType.instructions);
    }
}
