...
class AbstractNewPromptFileAction extends Action2 {
    ...
    async run(accessor) {
        ...
        notificationService.prompt(Severity.Info, localize(6244, null), [
            {
                label: localize(6245, null),
                run: () => {
...
class NewPromptFileAction extends AbstractNewPromptFileAction {
    constructor() {
        super(NEW_PROMPT_COMMAND_ID, localize(6247, null), PromptsType.prompt);
    }
}
class NewInstructionsFileAction extends AbstractNewPromptFileAction {
    constructor() {
        super(NEW_INSTRUCTIONS_COMMAND_ID, localize(6248, null), PromptsType.instructions);
    }
}
class NewAgentFileAction extends AbstractNewPromptFileAction {
    constructor() {
        super(NEW_AGENT_COMMAND_ID, localize(6249, null), PromptsType.agent);
    }
}
class NewUntitledPromptFileAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(6250, "New Untitled Prompt File"),
            f1: true,
            precondition: ChatContextKeys.enabled,
            category: CHAT_CATEGORY,
            keybinding: {
