...
const ScopedVoiceChatGettingReady = new RawContextKey('scopedVoiceChatGettingReady', false, { type: 'boolean', description: localize(6607, null) });
const ScopedVoiceChatInProgress = new RawContextKey('scopedVoiceChatInProgress', undefined, { type: 'string', description: localize(6608, null) });
...
let VoiceChatSessions = class VoiceChatSessions {
    ...
    onDidSpeechToTextSessionStart(controller, disposables) {
        ...
        const updatePlaceholder = () => {
            ...
            controller.setInputPlaceholder(`${localize(6609, null)}${'.'.repeat(dotCount)}`);
...
export class VoiceChatInChatViewAction extends VoiceChatWithHoldModeAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(6620, "Voice Chat in Chat View"),
...
export class HoldToVoiceChatInChatViewAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(6621, "Hold to Voice Chat in Chat View"),
            keybinding: {
...
export class InlineVoiceChatAction extends VoiceChatWithHoldModeAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(6622, "Inline Voice Chat"),
            category: CHAT_CATEGORY,
...
export class QuickVoiceChatAction extends VoiceChatWithHoldModeAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(6623, "Quick Voice Chat"),
            category: CHAT_CATEGORY,
            precondition: ContextKeyExpr.and(CanVoiceChat, ChatContextKeys.requestInProgress.negate() // disable when a chat request is in progress
            ),
            f1: true
...
export class StartVoiceChatAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(6624, "Start Voice Chat"),
            category: CHAT_CATEGORY,
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class StopListeningAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(6625, "Stop Listening"),
            category: CHAT_CATEGORY,
            f1: true,
            keybinding: {
...
export class StopListeningAndSubmitAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(6626, "Stop Listening and Submit"),
            category: CHAT_CATEGORY,
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
const ScopedChatSynthesisInProgress = new RawContextKey('scopedChatSynthesisInProgress', false, { type: 'boolean', description: localize(6610, null) });
...
export class ReadChatResponseAloud extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(6627, "Read Aloud"),
            icon: Codicon.unmute,
...
export class StopReadAloud extends Action2 {
    ...
    constructor() {
        super({
            id: StopReadAloud.ID,
            icon: syncing,
            title: localize2(6628, "Stop Reading Aloud"),
            f1: true,
            category: CHAT_CATEGORY,
...
export class StopReadChatItemAloud extends Action2 {
    ...
    constructor() {
        super({
            ...
            icon: Codicon.mute,
            title: localize2(6629, "Stop Reading Aloud"),
        ...
        registry.registerConfiguration({
            ...
            properties: {
                [KEYWORD_ACTIVIATION_SETTING_ID]: {
                    ...
                    'description': localize(6616, null),
                    'default': 'off',
                    'tags': ['accessibility']
                }
            }
...
let KeywordActivationStatusEntry = class KeywordActivationStatusEntry extends Disposable {
    ...
    static { this.STATUS_NAME = localize(6617, null); }
    static { this.STATUS_COMMAND = 'keywordActivation.status.command'; }
    static { this.STATUS_ACTIVE = localize(6618, null); }
    static { this.STATUS_INACTIVE = localize(6619, null); }
