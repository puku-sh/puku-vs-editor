...
const _ctxHasCallHierarchyProvider = new RawContextKey('editorHasCallHierarchyProvider', false, localize(4971, null));
const _ctxCallHierarchyVisible = new RawContextKey('callHierarchyVisible', false, localize(4972, null));
const _ctxCallHierarchyDirection = new RawContextKey('callHierarchyDirection', undefined, { type: 'string', description: localize(4973, null) });
    ...
    _showCallHierarchyWidget(position, direction, model, cts) {
        ...
        model.then(model => {
            ...
            if (model) {
                ...
                this._widget.showMessage(localize(4974, null));
            }
        }).catch(err => {
            ...
            this._widget.showMessage(localize(4975, null));
        });
    }
    showOutgoingCalls() {
...
registerAction2(class PeekCallHierarchyAction extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(4979, 'Peek Call Hierarchy'),
            menu: {
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(4980, 'Show Incoming Calls'),
            icon: registerIcon('callhierarchy-incoming', Codicon.callIncoming, localize(4976, null)),
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(4981, 'Show Outgoing Calls'),
            icon: registerIcon('callhierarchy-outgoing', Codicon.callOutgoing, localize(4977, null)),
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(4982, 'Refocus Call Hierarchy'),
