...
const testFilterDescriptions = {
    ["@failed" /* TestFilterTerm.Failed */]: localize(13659, null),
    ["@executed" /* TestFilterTerm.Executed */]: localize(13660, null),
    ["@doc" /* TestFilterTerm.CurrentDoc */]: localize(13661, null),
    ["@openedFiles" /* TestFilterTerm.OpenedFiles */]: localize(13662, null),
    ["@hidden" /* TestFilterTerm.Hidden */]: localize(13663, null),
};
let TestingExplorerFilter = class TestingExplorerFilter extends BaseActionViewItem {
    constructor(action, options, state, instantiationService, testService) {
        ...
        this.filtersAction = new Action('markersFiltersAction', localize(13664, null), 'testing-filter-button ' + ThemeIcon.asClassName(testingFilterIcon));
    ...
    render(container) {
        ...
        const input = this.input = this._register(this.instantiationService.createInstance(ContextScopedSuggestEnabledInputWithHistory, {
            ...
            suggestOptions: {
                ...
                placeholderText: localize(13666, null),
            },
