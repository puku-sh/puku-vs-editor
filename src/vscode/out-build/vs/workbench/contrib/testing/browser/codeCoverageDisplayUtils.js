...
export var labels;
(function (labels) {
    labels.showingFilterFor = (label) => localize(13506, null, label);
    labels.clickToChangeFiltering = localize(13507, null);
    labels.percentCoverage = (percent, precision) => localize(13508, null, displayPercent(percent, precision));
    labels.allTests = localize(13509, null);
    labels.pickShowCoverage = localize(13510, null);
})(labels || (labels = {}));
