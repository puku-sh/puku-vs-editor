...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            metadata: {
                description: localize2(14320, 'Opens a Walkthrough to help you get started in VS Code.')
            }
        });
    }
...
Registry.as(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(GettingStartedPage, GettingStartedPage.ID, localize(14304, null)), [
    new SyncDescriptor(GettingStartedInput)
]);
const category = localize2(14321, "Welcome");
registerAction2(class extends Action2 {
    constructor() {
        super({
            id: 'welcome.goBack',
            title: localize2(14322, 'Go Back'),
            category,
            keybinding: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14323, 'Open Walkthrough...'),
            category,
            f1: true,
            menu: {
                id: MenuId.MenubarHelpMenu,
    ...
    async run(accessor) {
        ...
        quickPick.placeholder = localize(14307, null);
...
export const WorkspacePlatform = new RawContextKey('workspacePlatform', undefined, localize(14308, null));
...
configurationRegistry.registerConfiguration({
    ...
    properties: {
        'workbench.welcomePage.walkthroughs.openOnInstall': {
            ...
            type: 'boolean',
            default: true,
            description: localize(14309, null)
        },
        'workbench.startupEditor': {
            ...
            'default': 'welcomePage',
            'description': localize(14316, null)
        },
        'workbench.welcomePage.preferReducedMotion': {
            scope: 1 /* ConfigurationScope.APPLICATION */,
            type: 'boolean',
            default: false,
            deprecationMessage: localize(14317, null),
            description: localize(14318, null)
        }
    }
});
