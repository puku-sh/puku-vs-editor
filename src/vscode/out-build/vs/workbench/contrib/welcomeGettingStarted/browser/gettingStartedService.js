...
const BUILT_IN_SOURCE = localize(14414, null);
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            category: localize2(14415, "Developer"),
            title: localize2(14416, "Reset Welcome Page Walkthrough Progress"),
            f1: true,
            metadata: {
                description: localize2(14417, 'Reset the progress of all Walkthrough steps on the Welcome Page to make them appear as if they are being viewed for the first time, providing a fresh start to the getting started experience.'),
            }
        });
    }
    run(accessor) {
