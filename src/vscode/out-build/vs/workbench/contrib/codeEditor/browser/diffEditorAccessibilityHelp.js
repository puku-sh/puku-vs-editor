...
export class DiffEditorAccessibilityHelp {
    ...
    getProvider(accessor) {
        ...
        const switchSides = localize(6677, null, '<keybinding:diffEditor.switchSide>');
        const diffEditorActiveAnnouncement = localize(6678, null);
        ...
        const content = [
            localize(6679, null),
            localize(6680, null, '<keybinding:' + AccessibleDiffViewerNext.id + '>', '<keybinding:' + AccessibleDiffViewerPrev.id + '>'),
            switchSides,
            diffEditorActiveAnnouncement,
            localize(6681, null, keys.join(', ')),
        ];
