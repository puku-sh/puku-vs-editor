...
class ToggleScreenReaderMode extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(6670, "Toggle Screen Reader Accessibility Mode"),
            metadata: {
                description: nls.localize2(6671, "Toggles an optimized mode for usage with screen readers, braille devices, and other assistive technologies."),
            },
            f1: true,
            keybinding: [{
