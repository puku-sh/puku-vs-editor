...
const EDITOR_WORD_WRAP = new RawContextKey('editorWordWrap', false, nls.localize(6745, null));
/**
...
class ToggleWordWrapAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(6749, "View: Toggle Word Wrap"),
