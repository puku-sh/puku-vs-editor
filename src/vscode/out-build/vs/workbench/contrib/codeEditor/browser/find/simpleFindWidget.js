...
const NLS_FIND_INPUT_LABEL = nls.localize(6692, null);
const NLS_FIND_INPUT_PLACEHOLDER = nls.localize(6693, null);
const NLS_PREVIOUS_MATCH_BTN_LABEL = nls.localize(6694, null);
const NLS_NEXT_MATCH_BTN_LABEL = nls.localize(6695, null);
const NLS_CLOSE_BTN_LABEL = nls.localize(6696, null);
...
export class SimpleFindWidget extends Widget {
    ...
    _announceSearchResults(label, searchString) {
        if (!searchString) {
            return nls.localize(6697, null);
        }
        if (label === NLS_NO_RESULTS) {
            return searchString === ''
                ? nls.localize(6698, null, label)
                : nls.localize(6699, null, label, searchString);
        }
        return nls.localize(6700, null, label, searchString);
    }
}
export const simpleFindWidgetSashBorder = registerColor('simpleFindWidget.sashBorder', { dark: '#454545', light: '#C8C8C8', hcDark: '#6FC3DF', hcLight: '#0F4A85' }, nls.localize(6701, null));
