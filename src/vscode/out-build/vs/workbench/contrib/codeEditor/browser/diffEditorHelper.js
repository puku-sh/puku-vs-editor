        ...
        if (!isEmbeddedDiffEditor) {
            ...
            this._register(autorunWithStore((reader, store) => {
                ...
                if (onlyWhiteSpaceChange.read(reader)) {
                    const helperWidget = store.add(this._instantiationService.createInstance(FloatingEditorClickWidget, this._diffEditor.getModifiedEditor(), localize(6682, null), null));
            ...
            this._register(this._diffEditor.onDidUpdateDiff(() => {
                ...
                if (diffComputationResult && diffComputationResult.quitEarly) {
                    this._notificationService.prompt(Severity.Warning, localize(6683, null, this._diffEditor.maxComputationTime), [{
                            label: localize(6684, null),
                            run: () => {
