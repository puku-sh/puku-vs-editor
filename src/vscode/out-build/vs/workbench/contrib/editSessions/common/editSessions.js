...
export const EDIT_SESSION_SYNC_CATEGORY = localize2(7862, 'Cloud Changes');
...
export const EDIT_SESSIONS_TITLE = localize2(7863, 'Cloud Changes');
export const EDIT_SESSIONS_VIEW_ICON = registerIcon('edit-sessions-view-icon', Codicon.cloudDownload, localize(7861, null));
