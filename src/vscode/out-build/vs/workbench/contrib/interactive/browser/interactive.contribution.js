...
const interactiveWindowCategory = localize2(9148, "Interactive Window");
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(9149, 'Open Interactive Window'),
            f1: false,
            category: interactiveWindowCategory,
            metadata: {
                description: localize(9139, null),
                args: [
                    {
                        name: 'showOptions',
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(9150, 'Execute Code'),
            category: interactiveWindowCategory,
            keybinding: [{
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(9151, 'Clear the interactive window input editor contents'),
            category: interactiveWindowCategory,
            f1: false
        });
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(9152, 'Previous value in history'),
            category: interactiveWindowCategory,
            f1: false,
            keybinding: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(9153, 'Next value in history'),
            category: interactiveWindowCategory,
            f1: false,
            keybinding: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(9154, 'Focus Input Editor'),
            category: interactiveWindowCategory,
            menu: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(9155, 'Focus History'),
            category: interactiveWindowCategory,
            menu: {
                id: MenuId.CommandPalette,
                when: ContextKeyExpr.equals('activeEditor', 'workbench.editor.interactive'),
...
Registry.as(ConfigurationExtensions.Configuration).registerConfiguration({
    ...
    'properties': {
        [ReplEditorSettings.interactiveWindowAlwaysScrollOnNewCell]: {
            type: 'boolean',
            default: true,
            markdownDescription: localize(9144, null)
        },
        [NotebookSetting.InteractiveWindowPromptToSave]: {
            type: 'boolean',
            default: false,
            markdownDescription: localize(9145, null)
        },
        [ReplEditorSettings.executeWithShiftEnter]: {
            type: 'boolean',
            default: false,
            markdownDescription: localize(9146, null),
            tags: ['replExecute']
        },
        [ReplEditorSettings.showExecutionHint]: {
            type: 'boolean',
            default: true,
            markdownDescription: localize(9147, null),
            tags: ['replExecute']
        }
    }
});
