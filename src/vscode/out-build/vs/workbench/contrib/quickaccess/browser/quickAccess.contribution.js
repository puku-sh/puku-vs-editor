...
quickAccessRegistry.registerQuickAccessProvider({
    ...
    placeholder: localize(11150, null, HelpQuickAccessProvider.PREFIX),
    helpEntries: [{
            description: localize(11151, null),
            commandCenterOrder: 70,
            commandCenterLabel: localize(11152, null)
        }]
});
quickAccessRegistry.registerQuickAccessProvider({
    ...
    placeholder: localize(11153, null),
    helpEntries: [{ description: localize(11154, null), commandId: OpenViewPickerAction.ID }]
});
quickAccessRegistry.registerQuickAccessProvider({
    ctor: CommandsQuickAccessProvider,
    prefix: CommandsQuickAccessProvider.PREFIX,
    contextKey: 'inCommandsPicker',
    placeholder: localize(11155, null),
    helpEntries: [{ description: localize(11156, null), commandId: ShowAllCommandsAction.ID, commandCenterOrder: 20 }]
});
//#endregion
