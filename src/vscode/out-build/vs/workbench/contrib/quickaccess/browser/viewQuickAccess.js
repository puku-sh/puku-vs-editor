...
let ViewQuickAccessProvider = class ViewQuickAccessProvider extends PickerQuickAccessProvider {
    ...
    doGetViewPickItems() {
        ...
        // Viewlets / Panels
        addPaneComposites(0 /* ViewContainerLocation.Sidebar */, localize(11164, null));
        addPaneComposites(1 /* ViewContainerLocation.Panel */, localize(11165, null));
        addPaneComposites(2 /* ViewContainerLocation.AuxiliaryBar */, localize(11166, null));
        ...
        this.terminalGroupService.groups.forEach((group, groupIndex) => {
            group.terminalInstances.forEach((terminal, terminalIndex) => {
                const label = localize(11167, null, `${groupIndex + 1}.${terminalIndex + 1}`, terminal.title);
                viewEntries.push({
                    label,
                    containerLabel: localize(11168, null),
                    accept: async () => {
        ...
        this.debugService.getModel().getSessions(true).filter(s => s.hasSeparateRepl()).forEach((session, _) => {
            ...
            viewEntries.push({
                label,
                containerLabel: localize(11169, null),
                accept: async () => {
        ...
        for (const channel of channels) {
            viewEntries.push({
                label: channel.label,
                containerLabel: localize(11170, null),
...
export class OpenViewPickerAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(11171, 'Open View'),
...
export class QuickAccessViewPickerAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(11172, 'Quick Open View'),
            category: Categories.View,
