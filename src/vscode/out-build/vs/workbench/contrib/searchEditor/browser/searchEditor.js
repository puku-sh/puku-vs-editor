...
let SearchEditor = class SearchEditor extends AbstractTextCodeEditor {
    ...
    createQueryEditor(container, scopedInstantiationService, inputBoxFocusedContextKey) {
        ...
        const toggleQueryDetailsLabel = localize(11962, null);
        ...
        const filesToIncludeTitle = localize(11963, null);
        ...
        const excludesTitle = localize(11965, null);
    ...
    toggleRunAgainMessage(show) {
        ...
        if (show) {
            const runAgainLink = DOM.append(this.messageBox, DOM.$('a.pointer.prominent.message', {}, localize(11967, null)));
    ...
    iterateThroughMatches(reverse) {
        ...
        alert(localize(11968, null, matchText, matchLineText, file.slice(0, file.length - 1)));
    }
    focusNextResult() {
    ...
    getAriaLabel() {
        return this.getInput()?.getName() ?? localize(11969, null);
    }
};
...
export { SearchEditor };
const searchEditorTextInputBorder = registerColor('searchEditor.textInputBorder', inputBorder, localize(11970, null));
