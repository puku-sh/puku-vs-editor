    ...
    _showKernelStatus(notebook) {
        ...
        if (all.length === 0) {
            ...
            this._kernelInfoElement.add(this._statusbarService.addEntry({
                name: nls.localize(10118, null),
                text: `$(notebook-kernel-select) ${kernel.label}`,
                ariaLabel: kernel.label,
                tooltip: isSuggested ? nls.localize(10119, null, tooltip) : tooltip,
            ...
            this._kernelInfoElement.add(this._statusbarService.addEntry({
                name: nls.localize(10120, null),
                text: nls.localize(10121, null),
                ariaLabel: nls.localize(10122, null),
                command: SELECT_KERNEL_ID,
                kind: 'prominent'
            }, SELECT_KERNEL_ID, 1 /* StatusbarAlignment.RIGHT */, 10));
        }
...
let ActiveCellStatus = class ActiveCellStatus extends Disposable {
    ...
    _getSelectionsText(editor) {
        ...
        return numSelected > 1 ?
            nls.localize(10124, null, idxFocused, numSelected) :
            nls.localize(10125, null, idxFocused, totalCells);
    }
};
...
let NotebookIndentationStatus = class NotebookIndentationStatus extends Disposable {
    ...
    _show(editor) {
        ...
        const entry = {
            name: nls.localize(10126, null),
            text: newText,
            ariaLabel: newText,
            tooltip: nls.localize(10127, null),
