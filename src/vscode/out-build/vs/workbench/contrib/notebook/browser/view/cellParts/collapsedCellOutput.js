...
let CollapsedCellOutput = class CollapsedCellOutput extends CellContentPart {
    constructor(notebookEditor, cellOutputCollapseContainer, keybindingService) {
        ...
        placeholder.textContent = localize(10597, null);
        ...
        if (keybinding) {
            placeholder.title = localize(10598, null, keybinding.getLabel());
            cellOutputCollapseContainer.title = localize(10599, null, keybinding.getLabel());
        }
