...
let TimerCellStatusBarItem = class TimerCellStatusBarItem extends Disposable {
    ...
    _getTimeItem(startTime, endTime, adjustment = 0, runtimeInformation) {
        ...
        if (runtimeInformation) {
            ...
            renderTimes += `\n*${localize(10105, null)}*\n`;
            tooltip = {
                value: localize(10106, null, lastExecution, formatCellDuration(executionDuration), formatCellDuration(timerDuration - executionDuration), renderTimes),
                isTrusted: true
            };
        }
        const executionText = this._isVerbose ?
            localize(10107, null, lastExecution, formatCellDuration(duration, false)) :
