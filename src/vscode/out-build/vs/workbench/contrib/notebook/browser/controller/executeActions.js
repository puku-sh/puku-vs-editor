...
registerAction2(class ExecuteNotebookAction extends NotebookAction {
    constructor() {
        super({
            ...
            title: localize(10264, null),
            icon: icons.executeAllIcon,
            metadata: {
                description: localize(10265, null),
                args: [
                    {
                        name: 'uri',
...
registerAction2(class ExecuteCell extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            metadata: {
                description: localize(10267, null),
...
registerAction2(class ExecuteCellFocusContainer extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            precondition: executeThisCellCondition,
            title: localize(10270, null),
            metadata: {
                description: localize(10271, null),
                args: cellExecutionArgs
            },
            icon: icons.executeIcon
        });
...
registerAction2(class CancelExecuteCell extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            metadata: {
                description: localize(10273, null),
                args: [
                    {
                        name: 'options',
...
registerAction2(class CancelAllNotebook extends CancelNotebook {
    constructor() {
        super({
            ...
            title: localize2(10283, "Stop Execution"),
            icon: icons.stopIcon,
            menu: [
                {
                    id: MenuId.EditorTitle,
...
registerAction2(class InterruptNotebook extends CancelNotebook {
    constructor() {
        super({
            ...
            title: localize2(10284, "Interrupt"),
...
registerAction2(class RevealRunningCellAction extends NotebookAction {
    constructor() {
        super({
            ...
            title: localize(10277, null),
            tooltip: localize(10278, null),
            shortTitle: localize(10279, null),
...
registerAction2(class RevealLastFailedCellAction extends NotebookAction {
    constructor() {
        super({
            ...
            title: localize(10280, null),
            tooltip: localize(10281, null),
            shortTitle: localize(10282, null),
