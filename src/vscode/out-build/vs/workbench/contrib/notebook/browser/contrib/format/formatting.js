...
registerAction2(class extends Action2 {
    constructor() {
        super({
            id: 'notebook.format',
            title: localize2(10154, 'Format Notebook'),
    ...
    async run(accessor) {
        ...
        try {
            if (!formatApplied) {
                ...
                await bulkEditService.apply(/* edit */ allCellEdits.flat(), { label: localize(10152, null), code: 'undoredo.formatNotebook', });
            }
        }
        finally {
            disposable.dispose();
...
registerEditorAction(class FormatCellAction extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(10155, "Format Cell"),
...
let FormatOnCellExecutionParticipant = class FormatOnCellExecutionParticipant {
    ...
    async onWillExecuteCell(executions) {
        ...
        try {
            ...
            await this.bulkEditService.apply(/* edit */ allCellEdits.flat(), { label: localize(10153, null), code: 'undoredo.notebooks.onWillExecuteFormat', });
        }
        finally {
            disposable.dispose();
        }
