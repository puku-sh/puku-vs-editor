...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(10076, "Move Cell Up"),
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(10077, "Move Cell Down"),
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(10078, "Copy Cell Up"),
            keybinding: {
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(10079, "Copy Cell Down"),
            keybinding: {
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(10080, "Split Cell"),
            menu: {
                id: MenuId.NotebookCellTitle,
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(10081, "Join With Previous Cell"),
            keybinding: {
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(10082, "Join With Next Cell"),
            keybinding: {
                when: NOTEBOOK_EDITOR_FOCUSED,
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(10083, "Join Selected Cells"),
            menu: {
                id: MenuId.NotebookCellTitle,
                when: ContextKeyExpr.and(NOTEBOOK_EDITOR_FOCUSED, NOTEBOOK_EDITOR_EDITABLE),
                group: "3_edit" /* CellOverflowToolbarGroups.Edit */,
...
registerAction2(class ChangeCellToCodeAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(10084, "Change Cell to Code"),
            keybinding: {
...
registerAction2(class ChangeCellToMarkdownAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(10085, "Change Cell to Markdown"),
            keybinding: {
                when: ContextKeyExpr.and(NOTEBOOK_EDITOR_FOCUSED, ContextKeyExpr.not(InputFocusedContextKey), NOTEBOOK_OUTPUT_FOCUSED.toNegated()),
...
registerAction2(class CollapseCellInputAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(10086, "Collapse Cell Input"),
            keybinding: {
...
registerAction2(class ExpandCellInputAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(10087, "Expand Cell Input"),
            keybinding: {
...
registerAction2(class CollapseCellOutputAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(10088, "Collapse Cell Output"),
            keybinding: {
...
registerAction2(class ExpandCellOuputAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(10089, "Expand Cell Output"),
            keybinding: {
...
registerAction2(class extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(10090, "Toggle Outputs"),
            metadata: {
                description: localize(10075, null),
...
registerAction2(class CollapseAllCellInputsAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(10091, "Collapse All Cell Inputs"),
            f1: true,
        });
    }
    async runWithContext(accessor, context) {
...
registerAction2(class ExpandAllCellInputsAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(10092, "Expand All Cell Inputs"),
            f1: true
        });
    }
    async runWithContext(accessor, context) {
...
registerAction2(class CollapseAllCellOutputsAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(10093, "Collapse All Cell Outputs"),
            f1: true,
        });
    }
    async runWithContext(accessor, context) {
...
registerAction2(class ExpandAllCellOutputsAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(10094, "Expand All Cell Outputs"),
            f1: true
        });
    }
    async runWithContext(accessor, context) {
...
registerAction2(class ToggleCellOutputScrolling extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(10095, "Toggle Scroll Cell Output"),
            keybinding: {
