...
let BackLayerWebView = class BackLayerWebView extends Themable {
    ...
    _generateStyles() {
        return {
            ...
            'notebook-cell-markup-empty-content': nls.localize(10604, null),
            'notebook-cell-renderer-not-found-error': nls.localize(10605, null),



            'notebook-cell-renderer-fallbacks-exhausted': nls.localize(10606, null),
