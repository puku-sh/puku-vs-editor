...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10373, 'Open File'),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10374, 'Toggle Collapse Unchanged Regions'),
            icon: Codicon.map,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            icon: openAsTextIcon,
            title: localize2(10375, 'Open Text Diff Editor'),
            precondition: ContextKeyExpr.or(ActiveEditorContext.isEqualTo(NotebookTextDiffEditor.ID), ActiveEditorContext.isEqualTo(NotebookMultiTextDiffEditor.ID)),
            menu: [{
                    id: MenuId.EditorTitle,
                    group: 'navigation',
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10376, 'Show Unchanged Cells'),
            icon: Codicon.unfold,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10377, 'Hide Unchanged Cells'),
            icon: Codicon.fold,
            precondition: ContextKeyExpr.and(ActiveEditorContext.isEqualTo(NotebookMultiTextDiffEditor.ID), ContextKeyExpr.has(NOTEBOOK_DIFF_HAS_UNCHANGED_CELLS.key)),
            menu: {
...
registerAction2(class GoToFileAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10378, 'Go To Cell'),
            icon: Codicon.goToFile,
            menu: {
...
const revertInput = localize(10361, null);
registerAction2(class extends Action2 {
    constructor() {
        super({
...
const revertOutputs = localize(10362, null);
registerAction2(class extends Action2 {
    constructor() {
        super({
...
const revertMetadata = localize(10363, null);
registerAction2(class extends Action2 {
    constructor() {
        super({
...
registerAction2(class extends ToggleRenderAction {
    constructor() {
        super('notebook.diff.showOutputs', localize2(10379, 'Show Outputs Differences'), ContextKeyExpr.or(ActiveEditorContext.isEqualTo(NotebookTextDiffEditor.ID), ActiveEditorContext.isEqualTo(NotebookMultiTextDiffEditor.ID)), ContextKeyExpr.notEquals('config.notebook.diff.ignoreOutputs', true), 2, true, undefined);
    }
});
registerAction2(class extends ToggleRenderAction {
    constructor() {
        super('notebook.diff.showMetadata', localize2(10380, 'Show Metadata Differences'), ContextKeyExpr.or(ActiveEditorContext.isEqualTo(NotebookTextDiffEditor.ID), ActiveEditorContext.isEqualTo(NotebookMultiTextDiffEditor.ID)), ContextKeyExpr.notEquals('config.notebook.diff.ignoreMetadata', true), 1, undefined, true);
    }
});
registerAction2(class extends Action2 {
    constructor() {
...
Registry.as(ConfigurationExtensions.Configuration).registerConfiguration({
    ...
    'properties': {
        'notebook.diff.ignoreMetadata': {
            type: 'boolean',
            default: false,
            markdownDescription: localize(10370, null)
        },
        'notebook.diff.ignoreOutputs': {
            type: 'boolean',
            default: false,
            markdownDescription: localize(10371, null)
        },
        'notebook.diff.experimental.toggleInline': {
            type: 'boolean',
            default: typeof product.quality === 'string' && product.quality !== 'stable', // only enable as default in insiders
            markdownDescription: localize(10372, null)
        },
    }
});
