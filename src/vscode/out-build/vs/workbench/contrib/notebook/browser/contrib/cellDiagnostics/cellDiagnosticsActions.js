...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(10097, "Show Cell Failure Actions"),
        ...
        if (context.cell instanceof CodeCellViewModel) {
            ...
            if (error?.location) {
                ...
                if (editor) {
                    ...
                    controller?.manualTriggerAtCurrentPosition(localize(10096, null), CodeActionTriggerSource.Default, { include: CodeActionKind.QuickFix });
                }
            }
        }
    }
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(10098, "Fix Cell Error"),
            precondition: ContextKeyExpr.and(NOTEBOOK_CELL_FOCUSED, NOTEBOOK_CELL_HAS_ERROR_DIAGNOSTICS, NOTEBOOK_CELL_EDITOR_FOCUSED.toNegated()),
            f1: true
        });
    }
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(10099, "Explain Cell Error"),
            precondition: ContextKeyExpr.and(NOTEBOOK_CELL_FOCUSED, NOTEBOOK_CELL_HAS_ERROR_DIAGNOSTICS, NOTEBOOK_CELL_EDITOR_FOCUSED.toNegated()),
            f1: true
        });
    }
