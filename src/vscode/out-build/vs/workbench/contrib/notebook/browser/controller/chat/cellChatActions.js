...
registerAction2(class extends NotebookAction {
    constructor() {
        super({
            ...
            title: {
                value: '$(sparkle) ' + localize(10217, null),
                original: '$(sparkle) Generate',
            },
            tooltip: localize(10218, null),
            metadata: {
                description: localize(10219, null),
                args: [
                    {
                        name: 'args',
                        schema: {
...
registerAction2(class extends NotebookAction {
    constructor() {
        super({
            ...
            title: {
                value: '$(sparkle) ' + localize(10220, null),
                original: '$(sparkle) Generate',
            },
            tooltip: localize(10221, null),
            f1: false,
            menu: [
                {
...
MenuRegistry.appendMenuItem(MenuId.NotebookToolbar, {
    command: {
        ...
        title: localize(10222, null),
        tooltip: localize(10223, null)
    },
    order: -10,
...
export class AcceptChangesAndRun extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(10226, "Accept and Run"),
            shortTitle: localize(10224, null),
            tooltip: localize(10225, null),
            icon: Codicon.check,
            f1: true,
