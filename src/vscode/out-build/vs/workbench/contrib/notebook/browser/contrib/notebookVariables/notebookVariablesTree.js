...
export const NOTEBOOK_TITLE = localize2(10182, "Notebook Variables");
export const REPL_TITLE = localize2(10183, "REPL Variables");
...
export class NotebookVariableAccessibilityProvider {
    ...
    getAriaLabel(element) {
        return localize(10181, null, element.name, element.value);
    }
}
