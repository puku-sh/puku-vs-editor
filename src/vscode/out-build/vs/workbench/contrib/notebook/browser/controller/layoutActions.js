...
registerAction2(class NotebookConfigureLayoutAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10319, "Select between Notebook Layouts"),
            f1: true,
...
registerAction2(class NotebookConfigureLayoutAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10320, "Customize Notebook Layout"),
            f1: true,
            category: NOTEBOOK_ACTIONS_CATEGORY,
            menu: [
                {
...
registerAction2(class NotebookConfigureLayoutFromEditorTitle extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10321, "Customize Notebook Layout"),
            f1: false,
            category: NOTEBOOK_ACTIONS_CATEGORY,
            menu: [
                {
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    ...
    title: localize2(10322, "Customize Notebook..."),
    icon: Codicon.gear,
    group: 'navigation',
    order: -1,
    when: NOTEBOOK_IS_ACTIVE_EDITOR
...
registerAction2(class ToggleLineNumberFromEditorTitle extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10323, 'Toggle Notebook Line Numbers'),
...
registerAction2(class ToggleCellToolbarPositionFromEditorTitle extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10324, 'Toggle Cell Toolbar Position'),
            menu: [{
                    id: MenuId.NotebookEditorLayoutConfigure,
                    group: 'notebookLayoutDetails',
                    order: 3
...
registerAction2(class ToggleBreadcrumbFromEditorTitle extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10325, 'Toggle Breadcrumbs'),
            menu: [{
                    id: MenuId.NotebookEditorLayoutConfigure,
                    group: 'notebookLayoutDetails',
                    order: 2
...
registerAction2(class SaveMimeTypeDisplayOrder extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10326, "Save Mimetype Display Order"),
            f1: true,
            category: NOTEBOOK_ACTIONS_CATEGORY,
    ...
    run(accessor) {
        ...
        qp.placeholder = localize(10313, null);
        qp.items = [
            { target: 2 /* ConfigurationTarget.USER */, label: localize(10314, null) },
            { target: 5 /* ConfigurationTarget.WORKSPACE */, label: localize(10315, null) },
        ];
...
registerAction2(class NotebookWebviewResetAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10327, "Reset Notebook Webview"),
            f1: false,
            category: NOTEBOOK_ACTIONS_CATEGORY
        });
    }
...
registerAction2(class ToggleNotebookStickyScroll extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(10328, "Toggle Notebook Sticky Scroll"),
                mnemonicTitle: localize(10316, null),
            },
            category: Categories.View,
            toggled: {
                condition: ContextKeyExpr.equals('config.notebook.stickyScroll.enabled', true),
                title: localize(10317, null),
                mnemonicTitle: localize(10318, null),
            },
            menu: [
