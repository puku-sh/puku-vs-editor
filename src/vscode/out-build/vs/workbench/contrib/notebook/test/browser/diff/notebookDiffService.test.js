...
suite('NotebookDiff Diff Service', () => {
    ...
    test('diff different source', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 0, originalLength: 1, modifiedStart: 0, modifiedLength: 1 }
        ]);
    });
    ...
    test('diff foo/foe (swapped cells)', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            ...
            { originalStart: 1, originalLength: 1, modifiedStart: 2, modifiedLength: 0 },
    ...
    test('diff foo/foe (swapped cells with changes in output)', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 0, originalLength: 2, modifiedStart: 0, modifiedLength: 2 },
        ]);
    });
    ...
    test('diff insert 3 at the top with lots of cells', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 0, originalLength: 0, modifiedStart: 0, modifiedLength: 3 },
        ]);
    });
    ...
    test('LCS (swap cells with outputs)', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 2, originalLength: 1, modifiedStart: 2, modifiedLength: 1 },
            { originalStart: 3, originalLength: 1, modifiedStart: 3, modifiedLength: 1 },
        ]);
    });
    ...
    test('Swap cells with output and with same code in each cell', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 2, originalLength: 1, modifiedStart: 2, modifiedLength: 1 },
            { originalStart: 3, originalLength: 1, modifiedStart: 3, modifiedLength: 1 },
            { originalStart: 5, originalLength: 1, modifiedStart: 5, modifiedLength: 1 },
            { originalStart: 6, originalLength: 1, modifiedStart: 6, modifiedLength: 1 },
        ]);
    });
    test('Change outputs of cells', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 2, originalLength: 2, modifiedStart: 2, modifiedLength: 2 },
            { originalStart: 5, originalLength: 2, modifiedStart: 5, modifiedLength: 2 },
        ]);
    });
    ...
    test('One cells and delete 1 cell', async () => {
        ...
        assert.deepStrictEqual(mapping, []);
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 0, originalLength: 1, modifiedStart: 0, modifiedLength: 0 },
        ]);
    });
    ...
    test('2 cells, inserted a cell in the middle', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 1, originalLength: 0, modifiedStart: 1, modifiedLength: 1 },
        ]);
    });
    ...
    test('Insert a md cell and modify the next code cell (few cells)', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 0, originalLength: 0, modifiedStart: 0, modifiedLength: 1 },
            { originalStart: 0, originalLength: 1, modifiedStart: 1, modifiedLength: 1 },
        ]);
    });
    test('Insert a md cell and modify the next code cell', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 3, originalLength: 0, modifiedStart: 3, modifiedLength: 1 },
            { originalStart: 3, originalLength: 1, modifiedStart: 4, modifiedLength: 1 },
        ]);
    });
    ...
    test('Insert a md cell and modify the next 2 code cells', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 3, originalLength: 0, modifiedStart: 3, modifiedLength: 1 },
            { originalStart: 3, originalLength: 1, modifiedStart: 4, modifiedLength: 1 },
            { originalStart: 4, originalLength: 1, modifiedStart: 5, modifiedLength: 1 },
        ]);
    });
    test('Insert a md cell, delete a cell and modify the next 2 code cells', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 3, originalLength: 1, modifiedStart: 3, modifiedLength: 1 },
            { originalStart: 4, originalLength: 1, modifiedStart: 4, modifiedLength: 1 },
            { originalStart: 5, originalLength: 1, modifiedStart: 5, modifiedLength: 1 },
        ]);
    });
    test('Insert a md cell, delete a code cell and modify the next 2 code cells (deleted and inserted lineup)', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 3, originalLength: 2, modifiedStart: 3, modifiedLength: 2 },
        ]);
    });
    test('Insert a few md cells and modify the next few code cells', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 4, originalLength: 0, modifiedStart: 4, modifiedLength: 2 },
            { originalStart: 4, originalLength: 1, modifiedStart: 6, modifiedLength: 1 },
            { originalStart: 6, originalLength: 1, modifiedStart: 8, modifiedLength: 1 },
    ...
    test('Modify, then delete ', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 2, originalLength: 1, modifiedStart: 2, modifiedLength: 1 },
            { originalStart: 3, originalLength: 1, modifiedStart: 3, modifiedLength: 0 },
            // { originalStart: 6, originalLength: 1, modifiedStart: 8, modifiedLength: 1 } satisfies IDiffChange,
            // { originalStart: 5, originalLength: 1, modifiedStart: 5, modifiedLength: 1 } satisfies IDiffChange,
        ]);
    });
    ...
    test('Detect modification in 2 cells', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 1, originalLength: 1, modifiedStart: 1, modifiedLength: 1 },
            { originalStart: 4, originalLength: 1, modifiedStart: 4, modifiedLength: 1 },
            { originalStart: 20, originalLength: 1, modifiedStart: 20, modifiedLength: 1 },
        ]);
    });
    test('Detect modification in multiple cells', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 4, originalLength: 1, modifiedStart: 4, modifiedLength: 1 },
            { originalStart: 10, originalLength: 1, modifiedStart: 10, modifiedLength: 1 },
            { originalStart: 16, originalLength: 1, modifiedStart: 16, modifiedLength: 1 },
            { originalStart: 18, originalLength: 1, modifiedStart: 18, modifiedLength: 1 },
            { originalStart: 20, originalLength: 1, modifiedStart: 20, modifiedLength: 1 },
        ]);
    });
    test('Modification with Insertion, detected as deletion of a cell', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 49, originalLength: 1, modifiedStart: 49, modifiedLength: 1 },
            { originalStart: 50, originalLength: 0, modifiedStart: 50, modifiedLength: 2 },
        ]);
    });
    test('Modification of three cells', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 6, originalLength: 1, modifiedStart: 6, modifiedLength: 1 },
            { originalStart: 15, originalLength: 1, modifiedStart: 15, modifiedLength: 1 },
            { originalStart: 36, originalLength: 1, modifiedStart: 36, modifiedLength: 1 },
    ...
    test('Modification of multiple cells', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 5, originalLength: 2, modifiedStart: 5, modifiedLength: 2 },
            { originalStart: 25, originalLength: 1, modifiedStart: 25, modifiedLength: 1 },
            { originalStart: 42, originalLength: 1, modifiedStart: 42, modifiedLength: 1 },
            { originalStart: 44, originalLength: 1, modifiedStart: 44, modifiedLength: 1 },
            { originalStart: 46, originalLength: 1, modifiedStart: 46, modifiedLength: 1 },
        ]);
    });
    test('Modification of a large cell and insert a new cell', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 52, originalLength: 1, modifiedStart: 52, modifiedLength: 1 },
            { originalStart: 53, originalLength: 0, modifiedStart: 53, modifiedLength: 2 },
        ]);
    });
    test('Misalignment due to 2 deleted cells', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 12, originalLength: 1, modifiedStart: 12, modifiedLength: 1 },
            { originalStart: 15, originalLength: 1, modifiedStart: 15, modifiedLength: 1 },
            { originalStart: 18, originalLength: 1, modifiedStart: 18, modifiedLength: 0 },
            { originalStart: 20, originalLength: 1, modifiedStart: 19, modifiedLength: 1 },
            { originalStart: 21, originalLength: 1, modifiedStart: 20, modifiedLength: 0 },
            { originalStart: 22, originalLength: 1, modifiedStart: 20, modifiedLength: 1 },
            { originalStart: 23, originalLength: 1, modifiedStart: 21, modifiedLength: 1 },
            { originalStart: 26, originalLength: 1, modifiedStart: 24, modifiedLength: 1 },
            { originalStart: 37, originalLength: 1, modifiedStart: 35, modifiedLength: 1 },
            { originalStart: 44, originalLength: 1, modifiedStart: 42, modifiedLength: 1 },
            { originalStart: 48, originalLength: 1, modifiedStart: 46, modifiedLength: 1 },
            { originalStart: 56, originalLength: 1, modifiedStart: 54, modifiedLength: 1 },
            { originalStart: 58, originalLength: 1, modifiedStart: 56, modifiedLength: 1 },
            { originalStart: 60, originalLength: 1, modifiedStart: 58, modifiedLength: 1 },
            { originalStart: 63, originalLength: 1, modifiedStart: 61, modifiedLength: 1 },
            { originalStart: 68, originalLength: 1, modifiedStart: 66, modifiedLength: 1 },
    ...
    test('Insert a few cells (one on top), modify a few and completely misaligned', async () => {
        ...
        assert.deepStrictEqual(diff.cellsDiff.changes, [
            { originalStart: 0, originalLength: 0, modifiedStart: 0, modifiedLength: 1 },
            { originalStart: 0, originalLength: 1, modifiedStart: 1, modifiedLength: 1 },
            { originalStart: 1, originalLength: 1, modifiedStart: 2, modifiedLength: 1 },
            { originalStart: 7, originalLength: 0, modifiedStart: 8, modifiedLength: 1 },
            { originalStart: 8, originalLength: 0, modifiedStart: 10, modifiedLength: 1 },
        ]);
    });
    let uriCounter = 0;
    async function mapCells(original, modified) {
    ...
    function cellToMainCellTdo(notebookUri, cell, index) {
        return {
            source: cell[0],
            language: cell[1],
            cellKind: cell[2],
...
//# sourceMappingURL=notebookDiffService.test.js.map