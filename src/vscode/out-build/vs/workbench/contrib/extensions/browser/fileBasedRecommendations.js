...
let FileBasedRecommendations = class FileBasedRecommendations extends ExtensionRecommendations {
    ...
    promptFromRecommendations(uri, model, extensionRecommendations) {
        ...
        if (importantRecommendations.size &&
            this.promptRecommendedExtensionForFileType(languageName && isImportantRecommendationForLanguage && language !== PLAINTEXT_LANGUAGE_ID ? localize(8530, null, languageName) : basename(uri), language, [...importantRecommendations])) {
            return;
        }
    }
