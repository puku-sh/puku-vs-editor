...
const ExtensionEditorIcon = registerIcon('extensions-editor-label-icon', Codicon.extensions, localize(8540, null));
export class ExtensionsInput extends EditorInput {
    ...
    getName() {
        return localize(8541, null, this._extension.displayName);
    }
    getIcon() {
