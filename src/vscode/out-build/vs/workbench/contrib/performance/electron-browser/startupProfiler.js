    ...
    _stopProfiling() {
        ...
        markerFile.then(() => {
            ...
            return this._dialogService.confirm({
                type: 'info',
                message: localize(10732, null),
                detail: localize(10733, null, profileFiles),
                primaryButton: localize(10734, null),
                cancelButton: localize(10735, null)
            }).then(res => {
                if (res.confirmed) {
                    Promise.all([
                        ...
                        return this._dialogService.confirm({
                            type: 'info',
                            message: localize(10736, null),
                            detail: localize(10737, null, this._productService.nameLong),
                            primaryButton: localize(10738, null)
                        }).then(res => {
