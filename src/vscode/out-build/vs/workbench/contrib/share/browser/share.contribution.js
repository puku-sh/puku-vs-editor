...
let ShareWorkbenchContribution = class ShareWorkbenchContribution extends Disposable {
    ...
    registerActions() {
        ...
        this._disposables.add(registerAction2(class ShareAction extends Action2 {
            ...
            static { this.LABEL = localize2(11988, 'Share...'); }
            constructor() {
                super({
                    id: ShareAction.ID,
            ...
            async run(accessor, ...args) {
                ...
                if (result) {
                    ...
                    dialogService.prompt({
                        type: Severity.Info,
                        message: isResultText ? localize(11983, null) : localize(11984, null),
                        custom: {
                            icon: Codicon.check,
                            markdownDetails: [{
                        ...
                        cancelButton: localize(11985, null),
                        buttons: isResultText ? [] : [{ label: localize(11986, null), run: () => { urlService.open(result, { openExternal: true }); } }]
                    });
                }
            }
        }));
...
Registry.as(ConfigurationExtensions.Configuration).registerConfiguration({
    ...
    properties: {
        'workbench.experimental.share.enabled': {
            ...
            default: false,
            tags: ['experimental'],
            markdownDescription: localize(11987, null, '`#window.commandCenter#`', '`true`'),
            restricted: false,
        }
    }
});
