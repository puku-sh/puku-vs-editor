    ...
    async _doUpdate() {
        ...
        if (disableLightbulb || !editorUri) {
            ...
            if (lang && lang !== existing && skip[existing] !== lang) {
                ...
                let tooltip = localize(9278, null, detectedName);
                ...
                const props = {
                    name: localize(9279, null),
                    ariaLabel: localize(9280, null, lang),
                    tooltip,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(9282, "Detect Language from Content"),
            f1: true,
    ...
    async run(accessor) {
        ...
        if (editorUri) {
            ...
            if (lang) {
                ...
                notificationService.warn(localize(9281, null));
            }
        }
    }
});
