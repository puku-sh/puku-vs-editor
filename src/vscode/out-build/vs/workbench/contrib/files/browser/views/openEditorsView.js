...
let OpenEditorsView = class OpenEditorsView extends ViewPane {
    ...
    static { this.NAME = nls.localize2(8980, "Open Editors"); }
    ...
    updateDirtyIndicator(workingCopy) {
        ...
        if (dirty === 0) {
            ...
            this.dirtyCountElement.textContent = nls.localize(8977, null, dirty);
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(8981, "Toggle Vertical/Horizontal Editor Layout"),
            f1: true,
            keybinding: {
...
MenuRegistry.appendMenuItem(MenuId.MenubarLayoutMenu, {
    ...
    command: {
        ...
        title: {
            ...nls.localize2(8982, "Flip Layout"),
            mnemonicTitle: nls.localize(8979, null)
        }
    },
    order: 1
});
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(8983, "New Untitled Text File"),
            f1: false,
