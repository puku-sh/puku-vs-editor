...
const explorerViewIcon = registerIcon('explorer-view-icon', Codicon.files, localize(8641, null));
const openEditorsViewIcon = registerIcon('open-editors-view-icon', Codicon.book, localize(8642, null));
...
export const VIEW_CONTAINER = viewContainerRegistry.registerViewContainer({
    ...
    openCommandActionDescriptor: {
        id: VIEWLET_ID,
        title: localize2(8654, "Explorer"),
        mnemonicTitle: localize(8643, null),
        keybindings: { primary: 2048 /* KeyMod.CtrlCmd */ | 1024 /* KeyMod.Shift */ | 35 /* KeyCode.KeyE */ },
        order: 0
    },
}, 0 /* ViewContainerLocation.Sidebar */, { isDefault: true });
const openFolder = localize(8644, null);
const addAFolder = localize(8645, null);
const openRecent = localize(8646, null);
...
viewsRegistry.registerViewWelcomeContent(EmptyView.ID, {
    content: localize(8647, null, addRootFolderButton),
...
viewsRegistry.registerViewWelcomeContent(EmptyView.ID, {
    content: localize(8648, null, openFolderViaWorkspaceButton, openRecentButton),
    when: ContextKeyExpr.and(
    // inside a .code-workspace
    WorkbenchStateContext.isEqualTo('workspace'), 
...
viewsRegistry.registerViewWelcomeContent(EmptyView.ID, {
    content: localize(8649, null, openFolderButton),
    when: ContextKeyExpr.and(
...
viewsRegistry.registerViewWelcomeContent(EmptyView.ID, {
    content: localize(8650, null, openFolderButton, addAFolderButton),
    when: ContextKeyExpr.and(
    // editors are opened
...
viewsRegistry.registerViewWelcomeContent(EmptyView.ID, {
    content: localize(8651, null, openFolderButton),
    when: ContextKeyExpr.and(
    // no editor is open
