...
let WorkspaceWatcher = class WorkspaceWatcher extends Disposable {
    ...
    onDidWatchError(error) {
        ...
        if (msg.indexOf('ENOSPC') >= 0) {
            reason = 'ENOSPC';
            this.notificationService.prompt(Severity.Warning, localize(8984, null), [{
                    label: localize(8985, null),
        ...
        // Detect when the watcher throws an error unexpectedly
            ...
            reason = 'EUNKNOWN';
            this.notificationService.prompt(Severity.Warning, localize(8986, null), [{
                    label: localize(8987, null),
