...
let ExplorerView = class ExplorerView extends ViewPane {
    ...
    renderHeader(container) {
        ...
        const setHeader = () => {
            ...
            this.ariaHeaderLabel = nls.localize(8953, null, this.name);
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(8956, "Refresh Explorer"),
            f1: true,
            ...
            metadata: {
                description: nls.localize2(8957, "Forces a refresh of the Explorer.")
            },
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(8958, "Collapse Folders in Explorer"),
            f1: true,
            ...
            metadata: {
                description: nls.localize2(8959, "Folds all folders in the Explorer.")
            }
        });
    }
    run(accessor) {
