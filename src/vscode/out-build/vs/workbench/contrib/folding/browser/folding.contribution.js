...
let DefaultFoldingRangeProvider = class DefaultFoldingRangeProvider extends Disposable {
    ...
    async _updateConfigValues() {
        ...
        DefaultFoldingRangeProvider_1.extensionItemLabels.push(nls.localize(9011, null));
        DefaultFoldingRangeProvider_1.extensionDescriptions.push(nls.localize(9012, null));
...
Registry.as(ConfigurationExtensions.Configuration).registerConfiguration({
    ...
    properties: {
        [DefaultFoldingRangeProvider.configName]: {
            description: nls.localize(9013, null),
            type: ['string', 'null'],
            default: null,
