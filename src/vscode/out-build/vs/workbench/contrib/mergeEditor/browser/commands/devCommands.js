...
const MERGE_EDITOR_CATEGORY = localize2(9948, 'Merge Editor (Dev)');
export class MergeEditorCopyContentsToJSON extends Action2 {
    constructor() {
        super({
            id: 'merge.dev.copyContentsJson',
            category: MERGE_EDITOR_CATEGORY,
            title: localize2(9949, "Copy Merge Editor State as JSON"),
    ...
    run(accessor) {
        ...
        if (!(activeEditorPane instanceof MergeEditor)) {
            notificationService.info({
                name: localize(9938, null),
                message: localize(9939, null)
            });
            return;
        }
        ...
        notificationService.info({
            name: localize(9940, null),
            message: localize(9941, null),
        });
    }
}
export class MergeEditorSaveContentsToFolder extends Action2 {
    constructor() {
        super({
            ...
            category: MERGE_EDITOR_CATEGORY,
            title: localize2(9950, "Save Merge Editor State to Folder"),
            icon: Codicon.layoutCentered,
            f1: true,
            precondition: ctxIsMergeEditor,
        });
    ...
    async run(accessor) {
        ...
        if (!(activeEditorPane instanceof MergeEditor)) {
            notificationService.info({
                name: localize(9942, null),
                message: localize(9943, null)
            });
            return;
        }
        const model = activeEditorPane.model;
        ...
        notificationService.info({
            name: localize(9945, null),
            message: localize(9946, null),
        });
    }
}
export class MergeEditorLoadContentsFromFolder extends Action2 {
    constructor() {
        super({
            ...
            category: MERGE_EDITOR_CATEGORY,
            title: localize2(9951, "Load Merge Editor State from Folder"),
            icon: Codicon.layoutCentered,
            f1: true
        });
    }
