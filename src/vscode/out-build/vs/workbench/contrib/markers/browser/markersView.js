...
let MarkersView = class MarkersView extends FilterViewPane {
    ...
    updateBadge(total, filtered) {
        this.filterWidget.updateBadge(total === filtered || total === 0 ? undefined : localize(9467, null, filtered, total));
    }
    checkMoreFilters() {
    ...
    renderMessage() {
        ...
        if (filtered === 0) {
            ...
            if (filtered === total) {
                this.setAriaLabel(localize(9468, null, total));
            }
            else {
                this.setAriaLabel(localize(9469, null, filtered, total));
            }
    ...
    renderFilteredByFilterMessage(container) {
        ...
        link.textContent = localize(9470, null);
