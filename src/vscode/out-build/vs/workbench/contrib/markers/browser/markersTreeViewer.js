...
const expandedIcon = registerIcon('markers-view-multi-line-expanded', Codicon.chevronUp, localize(9463, null));
const collapsedIcon = registerIcon('markers-view-multi-line-collapsed', Codicon.chevronDown, localize(9464, null));
...
class MarkerWidget extends Disposable {
    ...
    renderMultilineActionbar(marker, parent) {
        ...
        action.tooltip = multiline ? localize(9465, null) : localize(9466, null);
