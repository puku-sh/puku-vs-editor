...
export class ShowWebViewEditorFindWidgetAction extends Action2 {
    ...
    static { this.LABEL = nls.localize(14297, null); }
    constructor() {
        super({
...
export class HideWebViewEditorFindCommand extends Action2 {
    ...
    static { this.LABEL = nls.localize(14298, null); }
    constructor() {
        super({
...
export class WebViewEditorFindNextCommand extends Action2 {
    ...
    static { this.LABEL = nls.localize(14299, null); }
    constructor() {
        super({
...
export class WebViewEditorFindPreviousCommand extends Action2 {
    ...
    static { this.LABEL = nls.localize(14300, null); }
    constructor() {
        super({
...
export class ReloadWebviewAction extends Action2 {
    ...
    static { this.LABEL = nls.localize2(14301, "Reload Webviews"); }
    constructor() {
        super({
