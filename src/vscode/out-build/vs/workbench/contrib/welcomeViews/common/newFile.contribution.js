...
const builtInSource = localize(14584, null);
const category = localize2(14592, 'Create');
registerAction2(class extends Action2 {
    constructor() {
        super({
            id: 'welcome.showNewFileEntries',
            title: localize2(14593, 'New File...'),
            category,
            f1: true,
            keybinding: {
...
let NewFileTemplatesManager = class NewFileTemplatesManager extends Disposable {
    ...
    async selectNewEntry(entries) {
        ...
        qp.title = localize(14585, null);
        qp.placeholder = localize(14586, null);
        ...
        const displayCategory = {
            'file': localize(14587, null),
            'notebook': localize(14588, null),
        };
