...
export class CloseWindowAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...localize2(14785, "Close Window"),
                mnemonicTitle: localize(14771, null),
            },
            f1: true,
            keybinding: {
...
export class ZoomInAction extends BaseZoomAction {
    constructor() {
        super({
            ...
            title: {
                ...localize2(14786, "Zoom In"),
                mnemonicTitle: localize(14772, null),
            },
...
export class ZoomOutAction extends BaseZoomAction {
    constructor() {
        super({
            ...
            title: {
                ...localize2(14787, "Zoom Out"),
                mnemonicTitle: localize(14773, null),
            },
            category: Categories.View,
            f1: true,
            keybinding: {
...
export class ZoomResetAction extends BaseZoomAction {
    constructor() {
        super({
            ...
            title: {
                ...localize2(14788, "Reset Zoom"),
                mnemonicTitle: localize(14774, null),
            },
            category: Categories.View,
            f1: true,
            keybinding: {
    ...
    async run(accessor) {
        ...
        for (const window of mainWindows) {
            ...
            if (mapMainWindowToAuxiliaryWindows.size > 0) {
                picks.push({ type: 'separator', label: auxiliaryWindows ? localize(14778, null) : undefined });
            }
            ...
            const pick = {
                windowId: window.id,
                label: window.title,
                ariaLabel: window.dirty ? localize(14779, null, window.title) : window.title,
                iconClasses: getIconClasses(modelService, languageService, resource, fileKind),
                description: (currentWindowId === window.id) ? localize(14780, null) : undefined,
            ...
            if (auxiliaryWindows) {
                for (const auxiliaryWindow of auxiliaryWindows) {
                    const pick = {
                        ...
                        description: (currentWindowId === auxiliaryWindow.id) ? localize(14781, null) : undefined,
        ...
        const pick = await quickInputService.pick(picks, {
            ...
            placeHolder: localize(14782, null),
...
export class SwitchWindowAction extends BaseSwitchWindow {
    constructor() {
        super({
            ...
            title: localize2(14789, 'Switch Window...'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: 0,
...
export class QuickSwitchWindowAction extends BaseSwitchWindow {
    constructor() {
        super({
            ...
            title: localize2(14790, 'Quick Switch Window...'),
...
export class ToggleWindowAlwaysOnTopAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(14791, "Toggle Window Always on Top"),
            f1: true,
