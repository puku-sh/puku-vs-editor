...
// Register Icons
const menubarIcon = registerIcon('menuBar', Codicon.layoutMenubar, localize(3102, null));
const activityBarLeftIcon = registerIcon('activity-bar-left', Codicon.layoutActivitybarLeft, localize(3103, null));
const activityBarRightIcon = registerIcon('activity-bar-right', Codicon.layoutActivitybarRight, localize(3104, null));
const panelLeftIcon = registerIcon('panel-left', Codicon.layoutSidebarLeft, localize(3105, null));
const panelLeftOffIcon = registerIcon('panel-left-off', Codicon.layoutSidebarLeftOff, localize(3106, null));
const panelRightIcon = registerIcon('panel-right', Codicon.layoutSidebarRight, localize(3107, null));
const panelRightOffIcon = registerIcon('panel-right-off', Codicon.layoutSidebarRightOff, localize(3108, null));
const panelIcon = registerIcon('panel-bottom', Codicon.layoutPanel, localize(3109, null));
const statusBarIcon = registerIcon('statusBar', Codicon.layoutStatusbar, localize(3110, null));
const panelAlignmentLeftIcon = registerIcon('panel-align-left', Codicon.layoutPanelLeft, localize(3111, null));
const panelAlignmentRightIcon = registerIcon('panel-align-right', Codicon.layoutPanelRight, localize(3112, null));
const panelAlignmentCenterIcon = registerIcon('panel-align-center', Codicon.layoutPanelCenter, localize(3113, null));
const panelAlignmentJustifyIcon = registerIcon('panel-align-justify', Codicon.layoutPanelJustify, localize(3114, null));
const quickInputAlignmentTopIcon = registerIcon('quickInputAlignmentTop', Codicon.arrowUp, localize(3115, null));
const quickInputAlignmentCenterIcon = registerIcon('quickInputAlignmentCenter', Codicon.circle, localize(3116, null));
const fullscreenIcon = registerIcon('fullscreen', Codicon.screenFull, localize(3117, null));
const centerLayoutIcon = registerIcon('centerLayoutIcon', Codicon.layoutCentered, localize(3118, null));
const zenModeIcon = registerIcon('zenMode', Codicon.target, localize(3119, null));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3193, "Toggle Centered Layout"),
                mnemonicTitle: localize(3120, null),
            },
...
class MoveSidebarRightAction extends MoveSidebarPositionAction {
    ...
    constructor() {
        super(MoveSidebarRightAction.ID, localize2(3194, "Move Primary Side Bar Right"), 1 /* Position.RIGHT */);
    }
}
class MoveSidebarLeftAction extends MoveSidebarPositionAction {
    static { this.ID = 'workbench.action.moveSideBarLeft'; }
    constructor() {
        super(MoveSidebarLeftAction.ID, localize2(3195, "Move Primary Side Bar Left"), 0 /* Position.LEFT */);
    }
}
...
export class ToggleSidebarPositionAction extends Action2 {
    ...
    static { this.LABEL = localize(3121, null); }
    static getLabel(layoutService) {
        return layoutService.getSideBarPosition() === 0 /* Position.LEFT */ ? localize(3122, null) : localize(3123, null);
    }
    constructor() {
        super({
            id: ToggleSidebarPositionAction.ID,
            title: localize2(3196, "Toggle Primary Side Bar Position"),
            category: Categories.View,
            f1: true
        });
    }
...
const configureLayoutIcon = registerIcon('configure-layout-icon', Codicon.layout, localize(3124, null));
MenuRegistry.appendMenuItem(MenuId.LayoutControlMenu, {
    submenu: MenuId.LayoutControlMenuSubmenu,
    title: localize(3125, null),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3197, "Toggle Editor Area Visibility"),
                mnemonicTitle: localize(3132, null),
            },
            category: Categories.View,
            f1: true,
...
export class ToggleSidebarVisibilityAction extends Action2 {
    ...
    static { this.LABEL = localize(3134, null); }
    constructor() {
        super({
            id: ToggleSidebarVisibilityAction.ID,
            title: localize2(3198, 'Toggle Primary Side Bar Visibility'),
            toggled: {
                condition: SideBarVisibleContext,
                title: localize(3135, null),
                mnemonicTitle: localize(3136, null),
            },
            metadata: {
                description: localize(3137, null),
            },
            category: Categories.View,
            f1: true,
            keybinding: {
...
export class ToggleStatusbarVisibilityAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...localize2(3199, "Toggle Status Bar Visibility"),
                mnemonicTitle: localize(3143, null),
            },
            category: Categories.View,
            f1: true,
...
export class HideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = localize2(3200, 'Hide Editor Tabs');
        super("workbench.editor.showTabs" /* LayoutSettings.EDITOR_TABS_MODE */, "none" /* EditorTabsMode.NONE */, title, HideEditorTabsAction.ID, precondition, localize2(3201, "Hide Tab Bar"));
    }
}
export class ZenHideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = localize2(3202, 'Hide Editor Tabs in Zen Mode');
        super("zenMode.showTabs" /* ZenModeSettings.SHOW_TABS */, "none" /* EditorTabsMode.NONE */, title, ZenHideEditorTabsAction.ID, precondition, localize2(3203, "Hide Tab Bar in Zen Mode"));
    }
}
...
export class ShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = localize2(3204, 'Show Multiple Editor Tabs');
        super("workbench.editor.showTabs" /* LayoutSettings.EDITOR_TABS_MODE */, "multiple" /* EditorTabsMode.MULTIPLE */, title, ShowMultipleEditorTabsAction.ID, precondition, localize2(3205, "Show Tab Bar with multiple tabs"));
    }
}
export class ZenShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = localize2(3206, 'Show Multiple Editor Tabs in Zen Mode');
        super("zenMode.showTabs" /* ZenModeSettings.SHOW_TABS */, "multiple" /* EditorTabsMode.MULTIPLE */, title, ZenShowMultipleEditorTabsAction.ID, precondition, localize2(3207, "Show Tab Bar in Zen Mode"));
    }
}
...
export class ShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = localize2(3208, 'Show Single Editor Tab');
        super("workbench.editor.showTabs" /* LayoutSettings.EDITOR_TABS_MODE */, "single" /* EditorTabsMode.SINGLE */, title, ShowSingleEditorTabAction.ID, precondition, localize2(3209, "Show Tab Bar with one Tab"));
    }
}
export class ZenShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = localize2(3210, 'Show Single Editor Tab in Zen Mode');
        super("zenMode.showTabs" /* ZenModeSettings.SHOW_TABS */, "single" /* EditorTabsMode.SINGLE */, title, ZenShowSingleEditorTabAction.ID, precondition, localize2(3211, "Show Tab Bar in Zen Mode with one Tab"));
    }
}
...
export class EditorActionsTitleBarAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3212, "Move Editor Actions to Title Bar"),
            category: Categories.View,
            ...
            metadata: { description: localize2(3213, "Move Editor Actions from the tab bar to the title bar") },
            f1: true
        });
    }
    run(accessor) {
...
export class EditorActionsDefaultAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3214, "Move Editor Actions to Tab Bar"),
            category: Categories.View,
            ...
            metadata: { description: localize2(3215, "Move Editor Actions from the title bar to the tab bar") },
            f1: true
        });
    }
    run(accessor) {
...
export class HideEditorActionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3216, "Hide Editor Actions"),
            category: Categories.View,
            ...
            metadata: { description: localize2(3217, "Hide Editor Actions in the tab and title bar") },
            f1: true
        });
    }
    run(accessor) {
...
export class ShowEditorActionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3218, "Show Editor Actions"),
            category: Categories.View,
            ...
            metadata: { description: localize2(3219, "Make Editor Actions visible.") },
            f1: true
        });
    }
    run(accessor) {
...
export class ConfigureEditorTabsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3220, "Configure Tabs"),
            category: Categories.View,
        });
    }
    run(accessor) {
...
export class ConfigureEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3221, "Configure Editors"),
            category: Categories.View,
        });
    }
    run(accessor) {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3222, "Separate Pinned Editor Tabs"),
            category: Categories.View,
            ...
            metadata: { description: localize2(3223, "Toggle whether pinned editor tabs are shown on a separate row above unpinned tabs.") },
            f1: true
        });
    }
    run(accessor) {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3224, "Toggle Zen Mode"),
                mnemonicTitle: localize(3147, null),
            },
            precondition: IsAuxiliaryWindowFocusedContext.toNegated(),
            category: Categories.View,
            f1: true,
    ...
    registerAction2(class ToggleMenubarAction extends Action2 {
        constructor() {
            super({
                ...
                title: {
                    ...localize2(3225, "Toggle Menu Bar"),
                    mnemonicTitle: localize(3148, null),
                },
                category: Categories.View,
                f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3226, "Reset View Locations"),
            category: Categories.View,
            f1: true
        });
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3227, "Move View"),
            category: Categories.View,
            f1: true
        });
    }
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: localize(3150, null, containerModel.title)
                        });
                        hasAddedView = true;
                    }
                    results.push({
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: localize(3151, null, containerModel.title)
                        });
                        hasAddedView = true;
                    }
                    results.push({
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: localize(3152, null, containerModel.title)
                        });
                        hasAddedView = true;
                    }
                    results.push({
    ...
    async getView(quickInputService, viewDescriptorService, paneCompositePartService, viewId) {
        ...
        quickPick.placeholder = localize(3153, null);
...
class MoveFocusedViewAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3228, "Move Focused View"),
            category: Categories.View,
    ...
    run(accessor, viewId) {
        ...
        if (focusedViewId === undefined || focusedViewId.trim() === '') {
            dialogService.error(localize(3154, null));
            return;
        }
        const viewDescriptor = viewDescriptorService.getViewDescriptorById(focusedViewId);
        if (!viewDescriptor?.canMoveView) {
            dialogService.error(localize(3155, null));
            return;
        }
        const disposables = new DisposableStore();
        const quickPick = disposables.add(quickInputService.createQuickPick({ useSeparators: true }));
        quickPick.placeholder = localize(3156, null);
        quickPick.title = localize(3157, null, viewDescriptor.name.value);
        const items = [];
        ...
        if (!(isViewSolo && currentLocation === 2 /* ViewContainerLocation.AuxiliaryBar */)) {
            items.push({
                ...
                label: localize(3160, null)
            });
        }
        items.push({
            type: 'separator',
            label: localize(3161, null)
        });
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3229, "Reset Focused View Location"),
            category: Categories.View,
            f1: true,
            precondition: FocusedViewContext.notEqualsTo('')
        });
    ...
    run(accessor) {
        ...
        if (!viewDescriptor) {
            dialogService.error(localize(3164, null));
            return;
        }
...
class IncreaseViewSizeAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3230, 'Increase Current View Size'),
            f1: true,
            precondition: IsAuxiliaryWindowFocusedContext.toNegated()
        });
    }
...
class IncreaseViewWidthAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3231, 'Increase Editor Width'),
            f1: true,
            precondition: IsAuxiliaryWindowFocusedContext.toNegated()
        });
    }
...
class IncreaseViewHeightAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3232, 'Increase Editor Height'),
            f1: true,
            precondition: IsAuxiliaryWindowFocusedContext.toNegated()
        });
    }
...
class DecreaseViewSizeAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3233, 'Decrease Current View Size'),
            f1: true,
            precondition: IsAuxiliaryWindowFocusedContext.toNegated()
        });
    }
...
class DecreaseViewWidthAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3234, 'Decrease Editor Width'),
            f1: true,
            precondition: IsAuxiliaryWindowFocusedContext.toNegated()
        });
    }
...
class DecreaseViewHeightAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3235, 'Decrease Editor Height'),
            f1: true,
            precondition: IsAuxiliaryWindowFocusedContext.toNegated()
        });
    }
...
registerAction2(class AlignQuickInputTopAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3236, 'Align Quick Input Top'),
            f1: false
        });
    }
    run(accessor) {
...
registerAction2(class AlignQuickInputCenterAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3237, 'Align Quick Input Center'),
            f1: false
        });
    }
    run(accessor) {
...
const CreateToggleLayoutItem = (id, active, label, visualIcon) => {
    return {
        ...
        activeAriaLabel: localize(3165, null),
        inactiveAriaLabel: localize(3166, null),
        useButtons: true,
    };
};
const CreateOptionLayoutItem = (id, active, label, visualIcon) => {
    return {
        ...
        activeAriaLabel: localize(3167, null),
        useButtons: false
    };
};
...
if (!isMacintosh || !isNative) {
    ToggleVisibilityActions.push(CreateToggleLayoutItem('workbench.action.toggleMenuBar', MenuBarToggledContext, localize(3168, null), menubarIcon));
}
ToggleVisibilityActions.push(...[
    CreateToggleLayoutItem(ToggleActivityBarVisibilityActionId, ContextKeyExpr.notEquals('config.workbench.activityBar.location', 'hidden'), localize(3169, null), { whenA: ContextKeyExpr.equals('config.workbench.sideBar.location', 'left'), iconA: activityBarLeftIcon, iconB: activityBarRightIcon }),
    CreateToggleLayoutItem(ToggleSidebarVisibilityAction.ID, SideBarVisibleContext, localize(3170, null), { whenA: ContextKeyExpr.equals('config.workbench.sideBar.location', 'left'), iconA: panelLeftIcon, iconB: panelRightIcon }),
    CreateToggleLayoutItem(ToggleAuxiliaryBarAction.ID, AuxiliaryBarVisibleContext, localize(3171, null), { whenA: ContextKeyExpr.equals('config.workbench.sideBar.location', 'left'), iconA: panelRightIcon, iconB: panelLeftIcon }),
    CreateToggleLayoutItem(TogglePanelAction.ID, PanelVisibleContext, localize(3172, null), panelIcon),
    CreateToggleLayoutItem(ToggleStatusbarVisibilityAction.ID, ContextKeyExpr.equals('config.workbench.statusBar.visible', true), localize(3173, null), statusBarIcon),
]);
const MoveSideBarActions = [
    CreateOptionLayoutItem(MoveSidebarLeftAction.ID, ContextKeyExpr.equals('config.workbench.sideBar.location', 'left'), localize(3174, null), panelLeftIcon),
    CreateOptionLayoutItem(MoveSidebarRightAction.ID, ContextKeyExpr.equals('config.workbench.sideBar.location', 'right'), localize(3175, null), panelRightIcon),
];
const AlignPanelActions = [
    CreateOptionLayoutItem('workbench.action.alignPanelLeft', PanelAlignmentContext.isEqualTo('left'), localize(3176, null), panelAlignmentLeftIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelRight', PanelAlignmentContext.isEqualTo('right'), localize(3177, null), panelAlignmentRightIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelCenter', PanelAlignmentContext.isEqualTo('center'), localize(3178, null), panelAlignmentCenterIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelJustify', PanelAlignmentContext.isEqualTo('justify'), localize(3179, null), panelAlignmentJustifyIcon),
];
const QuickInputActions = [
    CreateOptionLayoutItem('workbench.action.alignQuickInputTop', QuickInputAlignmentContextKey.isEqualTo('top'), localize(3180, null), quickInputAlignmentTopIcon),
    CreateOptionLayoutItem('workbench.action.alignQuickInputCenter', QuickInputAlignmentContextKey.isEqualTo('center'), localize(3181, null), quickInputAlignmentCenterIcon),
];
const MiscLayoutOptions = [
    CreateOptionLayoutItem('workbench.action.toggleFullScreen', IsMainWindowFullscreenContext, localize(3182, null), fullscreenIcon),
    CreateOptionLayoutItem('workbench.action.toggleZenMode', InEditorZenModeContext, localize(3183, null), zenModeIcon),
    CreateOptionLayoutItem('workbench.action.toggleCenteredLayout', IsMainEditorCenteredLayoutContext, localize(3184, null), centerLayoutIcon),
];
...
registerAction2(class CustomizeLayoutAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3238, "Customize Layout..."),
            f1: true,
            icon: configureLayoutIcon,
            menu: [
                {
    ...
    run(accessor) {
        ...
        quickPick.title = localize(3190, null);
        const closeButton = {
            alwaysVisible: true,
            iconClass: ThemeIcon.asClassName(Codicon.close),
            tooltip: localize(3191, null)
        };
        const resetButton = {
            alwaysVisible: true,
            iconClass: ThemeIcon.asClassName(Codicon.discard),
            tooltip: localize(3192, null)
        };
        quickPick.buttons = [
            resetButton,
            closeButton
