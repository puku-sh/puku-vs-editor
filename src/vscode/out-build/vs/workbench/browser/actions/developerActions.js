...
class InspectContextKeysAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3073, 'Inspect Context Keys'),
...
class ToggleScreencastModeAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3074, 'Toggle Screencast Mode'),
            category: Categories.Developer,
            f1: true
        });
    }
...
class LogStorageAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3075, "Log Storage Database Contents"),
            category: Categories.Developer,
            f1: true
        });
    }
    run(accessor) {
        ...
        storageService.log();
        dialogService.info(localize(3047, null), localize(3048, null));
    }
}
class LogWorkingCopiesAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3076, "Log Working Copies"),
            category: Categories.Developer,
            f1: true
        });
    }
...
class RemoveLargeStorageEntriesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3077, 'Remove Large Storage Database Entries...'),
            category: Categories.Developer,
            f1: true
        });
    }
    async run(accessor) {
                ...
                for (const key of storageService.keys(scope, target)) {
                    ...
                    if (value && (!environmentService.isBuilt /* show all keys in dev */ || value.length > RemoveLargeStorageEntriesAction.SIZE_THRESHOLD)) {
                        items.push({
                            ...
                            detail: localize(3049, null, scope === -1 /* StorageScope.APPLICATION */ ? localize(3050, null) : scope === 0 /* StorageScope.PROFILE */ ? localize(3051, null) : localize(3052, null), target === 1 /* StorageTarget.MACHINE */ ? localize(3053, null) : localize(3054, null)),
                        });
                    }
                }
            }
        ...
        const selectedItems = await new Promise(resolve => {
            ...
            picker.customLabel = localize(3055, null);
            picker.placeholder = localize(3056, null);
            if (items.length === 0) {
                picker.description = localize(3057, null);
            }
            picker.show();
        ...
        const { confirmed } = await dialogService.confirm({
            type: 'warning',
            message: localize(3058, null),
            detail: localize(3059, null, selectedItems.map(item => item.label).join('\n')),
            primaryButton: localize(3060, null)
        });
        if (!confirmed) {
            return;
        }
...
class StartTrackDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3078, 'Start Tracking Disposables'),
            category: Categories.Developer,
            f1: true,
...
class SnapshotTrackedDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3079, 'Snapshot Tracked Disposables'),
            category: Categories.Developer,
            f1: true,
...
class StopTrackDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3080, 'Stop Tracking Disposables'),
            category: Categories.Developer,
            f1: true,
...
class PolicyDiagnosticsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3081, 'Policy Diagnostics'),
            category: Categories.Developer,
            f1: true
        });
    }
...
configurationRegistry.registerConfiguration({
    ...
    properties: {
        'screencastMode.verticalOffset': {
            ...
            minimum: 0,
            maximum: 90,
            description: localize(3062, null)
        },
        'screencastMode.fontSize': {
            ...
            minimum: 20,
            maximum: 100,
            description: localize(3063, null)
        },
        'screencastMode.keyboardOptions': {
            type: 'object',
            description: localize(3064, null),
            properties: {
                'showKeys': {
                    type: 'boolean',
                    default: true,
                    description: localize(3065, null)
                },
                'showKeybindings': {
                    type: 'boolean',
                    default: true,
                    description: localize(3066, null)
                },
                'showCommands': {
                    type: 'boolean',
                    default: true,
                    description: localize(3067, null)
                },
                'showCommandGroups': {
                    type: 'boolean',
                    default: false,
                    description: localize(3068, null)
                },
                'showSingleEditorCursorMoves': {
                    type: 'boolean',
                    default: true,
                    description: localize(3069, null)
                }
            },
            default: {
                'showKeys': true,
        ...
        'screencastMode.keyboardOverlayTimeout': {
            ...
            minimum: 500,
            maximum: 5000,
            description: localize(3070, null)
        },
        'screencastMode.mouseIndicatorColor': {
            type: 'string',
            format: 'color-hex',
            default: '#FF0000',
            description: localize(3071, null)
        },
        'screencastMode.mouseIndicatorSize': {
            ...
            minimum: 20,
            maximum: 100,
            description: localize(3072, null)
        },
    }
});
