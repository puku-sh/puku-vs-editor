...
class BaseOpenRecentAction extends Action2 {
    ...
    async run(accessor) {
        ...
        let keyMods;
        const workspaceSeparator = { type: 'separator', label: hasWorkspaces ? localize(3267, null) : localize(3268, null) };
        const fileSeparator = { type: 'separator', label: localize(3269, null) };
        const picks = [workspaceSeparator, ...workspacePicks, fileSeparator, ...filePicks];
        const pick = await quickInputService.pick(picks, {
            contextKey: inRecentFilesPickerContextKey,
            activeItem: [...workspacePicks, ...filePicks][autoFocusSecondEntry ? 1 : 0],
            placeHolder: isMacintosh ? localize(3270, null) : localize(3271, null),
            ...
            onDidTriggerItemButton: async (context) => {
                ...
                // Dirty Folder/Workspace
                    ...
                    const { confirmed } = await dialogService.confirm({
                        title: isDirtyWorkspace ? localize(3272, null) : localize(3273, null),
                        message: isDirtyWorkspace ? localize(3274, null) : localize(3275, null),
                        detail: isDirtyWorkspace ? localize(3276, null) : localize(3277, null)
                    });
                    if (confirmed) {
    ...
    toQuickPick(modelService, languageService, labelService, recent, kind) {
        ...
        return {
            iconClasses,
            label: name,
            ariaLabel: kind.isDirty ? isWorkspace ? localize(3278, null, name) : localize(3279, null, name) : name,
...
export class OpenRecentAction extends BaseOpenRecentAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...localize2(3286, "Open Recent..."),
                mnemonicTitle: localize(3280, null),
            },
...
class QuickPickRecentAction extends BaseOpenRecentAction {
    constructor() {
        super({
            ...
            title: localize2(3287, 'Quick Open Recent...'),
            category: Categories.File,
...
class ToggleFullScreenAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3288, "Toggle Full Screen"),
                mnemonicTitle: localize(3281, null),
            },
...
export class ReloadWindowAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3289, 'Reload Window'),
...
class ShowAboutDialogAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3290, "About"),
                mnemonicTitle: localize(3282, null),
            },
...
class NewWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3291, "New Window"),
                mnemonicTitle: localize(3283, null),
            },
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
class BlurAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3292, 'Remove keyboard focus from focused element')
        });
    }
    run() {
