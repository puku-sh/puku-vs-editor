...
registerAction2(class extends BaseNavigationAction {
    constructor() {
        super({
            ...
            title: localize2(3242, 'Navigate to the View on the Left'),
...
registerAction2(class extends BaseNavigationAction {
    constructor() {
        super({
            ...
            title: localize2(3243, 'Navigate to the View on the Right'),
            category: Categories.View,
            f1: true
        }, 3 /* Direction.Right */);
    }
...
registerAction2(class extends BaseNavigationAction {
    constructor() {
        super({
            ...
            title: localize2(3244, 'Navigate to the View Above'),
            category: Categories.View,
            f1: true
        }, 0 /* Direction.Up */);
    }
...
registerAction2(class extends BaseNavigationAction {
    constructor() {
        super({
            ...
            title: localize2(3245, 'Navigate to the View Below'),
            category: Categories.View,
            f1: true
        }, 1 /* Direction.Down */);
    }
...
registerAction2(class extends BaseFocusAction {
    constructor() {
        super({
            ...
            title: localize2(3246, 'Focus Next Part'),
            category: Categories.View,
            f1: true,
            keybinding: {
...
registerAction2(class extends BaseFocusAction {
    constructor() {
        super({
            ...
            title: localize2(3247, 'Focus Previous Part'),
            category: Categories.View,
            f1: true,
            keybinding: {
