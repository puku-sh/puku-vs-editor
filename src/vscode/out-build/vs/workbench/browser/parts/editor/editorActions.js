...
export class SplitEditorAction extends AbstractSplitEditorAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(3648, 'Split Editor'),
            f1: true,
            keybinding: {
...
export class SplitEditorOrthogonalAction extends AbstractSplitEditorAction {
    constructor() {
        super({
            ...
            title: localize2(3649, 'Split Editor Orthogonal'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class SplitEditorLeftAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3650, 'Split Editor Left'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: KeyChord(2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */, 2048 /* KeyMod.CtrlCmd */ | 93 /* KeyCode.Backslash */)
...
export class SplitEditorRightAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3651, 'Split Editor Right'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: KeyChord(2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */, 2048 /* KeyMod.CtrlCmd */ | 93 /* KeyCode.Backslash */)
...
export class SplitEditorUpAction extends ExecuteCommandAction {
    static { this.LABEL = localize(3624, null); }
    constructor() {
        super({
            id: SPLIT_EDITOR_UP,
            title: localize2(3652, "Split Editor Up"),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: KeyChord(2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */, 2048 /* KeyMod.CtrlCmd */ | 93 /* KeyCode.Backslash */)
...
export class SplitEditorDownAction extends ExecuteCommandAction {
    static { this.LABEL = localize(3625, null); }
    constructor() {
        super({
            id: SPLIT_EDITOR_DOWN,
            title: localize2(3653, "Split Editor Down"),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: KeyChord(2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */, 2048 /* KeyMod.CtrlCmd */ | 93 /* KeyCode.Backslash */)
...
export class JoinTwoGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3654, 'Join Editor Group with Next Group'),
            f1: true,
            category: Categories.View
        });
    }
...
export class JoinAllGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3655, 'Join All Editor Groups'),
            f1: true,
            category: Categories.View
        });
    }
...
export class NavigateBetweenGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3656, 'Navigate Between Editor Groups'),
            f1: true,
            category: Categories.View
        });
    }
...
export class FocusActiveGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3657, 'Focus Active Editor Group'),
            f1: true,
            category: Categories.View
        });
    }
...
export class FocusFirstGroupAction extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3658, 'Focus First Editor Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class FocusLastGroupAction extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3659, 'Focus Last Editor Group'),
            f1: true,
            category: Categories.View
...
export class FocusNextGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3660, 'Focus Next Editor Group'),
            f1: true,
            category: Categories.View
...
export class FocusPreviousGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3661, 'Focus Previous Editor Group'),
            f1: true,
            category: Categories.View
...
export class FocusLeftGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3662, 'Focus Left Editor Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class FocusRightGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3663, 'Focus Right Editor Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class FocusAboveGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3664, 'Focus Editor Group Above'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class FocusBelowGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3665, 'Focus Editor Group Below'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
let CloseEditorAction = class CloseEditorAction extends Action {
    ...
    static { this.LABEL = localize(3626, null); }
...
let UnpinEditorAction = class UnpinEditorAction extends Action {
    ...
    static { this.LABEL = localize(3627, null); }
    constructor(id, label, commandService) {
...
let CloseEditorTabAction = class CloseEditorTabAction extends Action {
    static { this.ID = 'workbench.action.closeActiveEditor'; }
    static { this.LABEL = localize(3628, null); }
...
export class RevertAndCloseEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3666, 'Revert and Close Editor'),
            f1: true,
            category: Categories.View
        });
    }
...
export class CloseLeftEditorsInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3667, 'Close Editors to the Left in Group'),
            f1: true,
            category: Categories.View
        });
    }
...
export class CloseAllEditorsAction extends AbstractCloseAllAction {
    ...
    static { this.LABEL = localize2(3668, 'Close All Editors'); }
    constructor() {
        super({
...
export class CloseAllEditorGroupsAction extends AbstractCloseAllAction {
    constructor() {
        super({
            ...
            title: localize2(3669, 'Close All Editor Groups'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class CloseEditorsInOtherGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3670, 'Close Editors in Other Groups'),
            f1: true,
            category: Categories.View
        });
    }
...
export class CloseEditorInAllGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3671, 'Close Editor in All Groups'),
            f1: true,
            category: Categories.View
        });
    }
...
export class MoveGroupLeftAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3672, 'Move Editor Group Left'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class MoveGroupRightAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3673, 'Move Editor Group Right'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class MoveGroupUpAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3674, 'Move Editor Group Up'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class MoveGroupDownAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3675, 'Move Editor Group Down'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class DuplicateGroupLeftAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3676, 'Duplicate Editor Group Left'),
            f1: true,
            category: Categories.View
        }, 2 /* GroupDirection.LEFT */);
    }
...
export class DuplicateGroupRightAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3677, 'Duplicate Editor Group Right'),
            f1: true,
            category: Categories.View
        }, 3 /* GroupDirection.RIGHT */);
    }
...
export class DuplicateGroupUpAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3678, 'Duplicate Editor Group Up'),
            f1: true,
            category: Categories.View
        }, 0 /* GroupDirection.UP */);
    }
...
export class DuplicateGroupDownAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3679, 'Duplicate Editor Group Down'),
            f1: true,
            category: Categories.View
        }, 1 /* GroupDirection.DOWN */);
    }
...
export class MinimizeOtherGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3680, 'Expand Editor Group'),
            f1: true,
            category: Categories.View,
...
export class MinimizeOtherGroupsHideSidebarAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3681, 'Expand Editor Group and Hide Side Bars'),
            f1: true,
            category: Categories.View,
...
export class ResetGroupSizesAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3682, 'Reset Editor Group Sizes'),
            f1: true,
            category: Categories.View
        });
    }
...
export class ToggleGroupSizesAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3683, 'Toggle Editor Group Sizes'),
            f1: true,
            category: Categories.View
        });
    }
...
export class MaximizeGroupHideSidebarAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3684, 'Maximize Editor Group and Hide Side Bars'),
            f1: true,
            category: Categories.View,
...
export class ToggleMaximizeEditorGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3685, 'Toggle Maximize Editor Group'),
            f1: true,
            category: Categories.View,
...
export class OpenNextEditor extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: localize2(3686, 'Open Next Editor'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class OpenPreviousEditor extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: localize2(3687, 'Open Previous Editor'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class OpenNextEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: localize2(3688, 'Open Next Editor in Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class OpenPreviousEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: localize2(3689, 'Open Previous Editor in Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class OpenFirstEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: localize2(3690, 'Open First Editor in Group'),
            f1: true,
            category: Categories.View
        });
    }
...
export class OpenLastEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: localize2(3691, 'Open Last Editor in Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class NavigateForwardAction extends Action2 {
    ...
    static { this.LABEL = localize(3631, null); }
    constructor() {
        super({
            id: NavigateForwardAction.ID,
            title: {
                ...localize2(3692, "Go Forward"),
                mnemonicTitle: localize(3632, null)
            },
            f1: true,
...
export class NavigateBackwardsAction extends Action2 {
    ...
    static { this.LABEL = localize(3633, null); }
    constructor() {
        super({
            id: NavigateBackwardsAction.ID,
            title: {
                ...localize2(3693, "Go Back"),
...
export class NavigatePreviousAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3694, 'Go Previous'),
            f1: true
        });
    }
    async run(accessor) {
...
export class NavigateForwardInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3695, 'Go Forward in Edit Locations'),
            f1: true
        });
    }
    async run(accessor) {
...
export class NavigateBackwardsInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3696, 'Go Back in Edit Locations'),
            f1: true
        });
    }
    async run(accessor) {
...
export class NavigatePreviousInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3697, 'Go Previous in Edit Locations'),
            f1: true
        });
    }
    async run(accessor) {
...
export class NavigateToLastEditLocationAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3698, 'Go to Last Edit Location'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class NavigateForwardInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3699, 'Go Forward in Navigation Locations'),
            f1: true
        });
    }
    async run(accessor) {
...
export class NavigateBackwardsInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3700, 'Go Back in Navigation Locations'),
            f1: true
        });
    }
    async run(accessor) {
...
export class NavigatePreviousInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3701, 'Go Previous in Navigation Locations'),
            f1: true
        });
    }
    async run(accessor) {
...
export class NavigateToLastNavigationLocationAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3702, 'Go to Last Navigation Location'),
            f1: true
        });
    }
    async run(accessor) {
...
export class ReopenClosedEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3703, 'Reopen Closed Editor'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class ClearRecentFilesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3704, 'Clear Recently Opened...'),
            f1: true,
    ...
    async run(accessor) {
        ...
        const { confirmed } = await dialogService.confirm({
            type: 'warning',
            message: localize(3635, null),
            detail: localize(3636, null),
            primaryButton: localize(3637, null)
        });
        if (!confirmed) {
            return;
        }
...
export class ShowEditorsInActiveGroupByMostRecentlyUsedAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3705, 'Show Editors in Active Group By Most Recently Used'),
            f1: true,
            category: Categories.View
        });
    }
...
export class ShowAllEditorsByAppearanceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3706, 'Show All Editors By Appearance'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class ShowAllEditorsByMostRecentlyUsedAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3707, 'Show All Editors By Most Recently Used'),
            f1: true,
            category: Categories.View
        });
    }
...
export class QuickAccessPreviousRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: localize2(3708, 'Quick Open Previous Recently Used Editor'),
            f1: true,
            category: Categories.View
...
export class QuickAccessLeastRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: localize2(3709, 'Quick Open Least Recently Used Editor'),
            f1: true,
            category: Categories.View
        }, AllEditorsByMostRecentlyUsedQuickAccess.PREFIX, undefined);
    }
...
export class QuickAccessPreviousRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: localize2(3710, 'Quick Open Previous Recently Used Editor in Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class QuickAccessLeastRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: localize2(3711, 'Quick Open Least Recently Used Editor in Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class QuickAccessPreviousEditorFromHistoryAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3712, 'Quick Open Previous Editor from History'),
            f1: true
        });
    }
    async run(accessor) {
...
export class OpenNextRecentlyUsedEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3713, 'Open Next Recently Used Editor'),
            f1: true,
            category: Categories.View
        });
    }
...
export class OpenPreviousRecentlyUsedEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3714, 'Open Previous Recently Used Editor'),
            f1: true,
            category: Categories.View
        });
    }
...
export class OpenNextRecentlyUsedEditorInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3715, 'Open Next Recently Used Editor In Group'),
            f1: true,
            category: Categories.View
        });
    }
...
export class OpenPreviousRecentlyUsedEditorInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3716, 'Open Previous Recently Used Editor In Group'),
            f1: true,
            category: Categories.View
        });
    }
...
export class ClearEditorHistoryWithoutConfirmAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3717, 'Clear Editor History without Confirmation'),
            f1: true,
...
export class ClearEditorHistoryAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3718, 'Clear Editor History'),
            f1: true
        });
    }
    async run(accessor) {
        ...
        const { confirmed } = await dialogService.confirm({
            type: 'warning',
            message: localize(3638, null),
            detail: localize(3639, null),
            primaryButton: localize(3640, null)
        });
        if (!confirmed) {
            return;
        }
...
export class MoveEditorLeftInGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3719, 'Move Editor Left'),
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class MoveEditorRightInGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3720, 'Move Editor Right'),
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class MoveEditorToPreviousGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3721, 'Move Editor into Previous Group'),
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: 2048 /* KeyMod.CtrlCmd */ | 512 /* KeyMod.Alt */ | 15 /* KeyCode.LeftArrow */,
                mac: {
...
export class MoveEditorToNextGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3722, 'Move Editor into Next Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: 2048 /* KeyMod.CtrlCmd */ | 512 /* KeyMod.Alt */ | 17 /* KeyCode.RightArrow */,
...
export class MoveEditorToAboveGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3723, 'Move Editor into Group Above'),
            f1: true,
            category: Categories.View
...
export class MoveEditorToBelowGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3724, 'Move Editor into Group Below'),
            f1: true,
            category: Categories.View
...
export class MoveEditorToLeftGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3725, 'Move Editor into Left Group'),
            f1: true,
            category: Categories.View
...
export class MoveEditorToRightGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3726, 'Move Editor into Right Group'),
            f1: true,
            category: Categories.View
...
export class MoveEditorToFirstGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3727, 'Move Editor into First Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class MoveEditorToLastGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3728, 'Move Editor into Last Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class SplitEditorToPreviousGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3729, 'Split Editor into Previous Group'),
            f1: true,
            category: Categories.View
...
export class SplitEditorToNextGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3730, 'Split Editor into Next Group'),
            f1: true,
            category: Categories.View
...
export class SplitEditorToAboveGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3731, 'Split Editor into Group Above'),
            f1: true,
            category: Categories.View
...
export class SplitEditorToBelowGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3732, 'Split Editor into Group Below'),
            f1: true,
            category: Categories.View
...
export class SplitEditorToLeftGroupAction extends ExecuteCommandAction {
    ...
    static { this.LABEL = localize(3641, null); }
    constructor() {
        super({
            id: 'workbench.action.splitEditorToLeftGroup',
            title: localize2(3733, "Split Editor into Left Group"),
            f1: true,
            category: Categories.View
...
export class SplitEditorToRightGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3734, 'Split Editor into Right Group'),
            f1: true,
            category: Categories.View
...
export class SplitEditorToFirstGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3735, 'Split Editor into First Group'),
            f1: true,
            category: Categories.View
...
export class SplitEditorToLastGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(3736, 'Split Editor into Last Group'),
            f1: true,
            category: Categories.View
...
export class EditorLayoutSingleAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(3737, 'Single Column Editor Layout'),
            f1: true,
            category: Categories.View
...
export class EditorLayoutTwoColumnsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(3738, 'Two Columns Editor Layout'),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}], orientation: 0 /* GroupOrientation.HORIZONTAL */ });
    }
...
export class EditorLayoutThreeColumnsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(3739, 'Three Columns Editor Layout'),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}, {}], orientation: 0 /* GroupOrientation.HORIZONTAL */ });
    }
...
export class EditorLayoutTwoRowsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(3740, 'Two Rows Editor Layout'),
            f1: true,
            category: Categories.View
...
export class EditorLayoutThreeRowsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(3741, 'Three Rows Editor Layout'),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}, {}], orientation: 1 /* GroupOrientation.VERTICAL */ });
    }
...
export class EditorLayoutTwoByTwoGridAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(3742, 'Grid Editor Layout (2x2)'),
            f1: true,
            category: Categories.View
...
export class EditorLayoutTwoColumnsBottomAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(3743, 'Two Columns Bottom Editor Layout'),
            f1: true,
            category: Categories.View
...
export class EditorLayoutTwoRowsRightAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(3744, 'Two Rows Right Editor Layout'),
            f1: true,
            category: Categories.View
...
export class NewEditorGroupLeftAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3745, 'New Editor Group to the Left'),
            f1: true,
            category: Categories.View
        }, 2 /* GroupDirection.LEFT */);
    }
...
export class NewEditorGroupRightAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3746, 'New Editor Group to the Right'),
            f1: true,
            category: Categories.View
        }, 3 /* GroupDirection.RIGHT */);
    }
...
export class NewEditorGroupAboveAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3747, 'New Editor Group Above'),
            f1: true,
            category: Categories.View
        }, 0 /* GroupDirection.UP */);
    }
...
export class NewEditorGroupBelowAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: localize2(3748, 'New Editor Group Below'),
            f1: true,
            category: Categories.View
        }, 1 /* GroupDirection.DOWN */);
    }
...
export class ToggleEditorTypeAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3749, 'Toggle Editor Type'),
            f1: true,
            category: Categories.View,
...
export class ReOpenInTextEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3750, 'Reopen Editor with Text Editor'),
            f1: true,
            category: Categories.View,
            precondition: ActiveEditorAvailableEditorIdsContext
        });
...
export class MoveEditorToNewWindowAction extends BaseMoveCopyEditorToNewWindowAction {
    constructor() {
        super(MOVE_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, {
            ...localize2(3751, "Move Editor into New Window"),
            mnemonicTitle: localize(3642, null),
        }, undefined, true);
    }
}
export class CopyEditorToNewindowAction extends BaseMoveCopyEditorToNewWindowAction {
    constructor() {
        super(COPY_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, {
            ...localize2(3752, "Copy Editor into New Window"),
            mnemonicTitle: localize(3643, null),
...
export class MoveEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
    constructor() {
        super(MOVE_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, {
            ...localize2(3753, "Move Editor Group into New Window"),
            mnemonicTitle: localize(3644, null),
        }, true);
    }
}
export class CopyEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
    constructor() {
        super(COPY_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, {
            ...localize2(3754, "Copy Editor Group into New Window"),
            mnemonicTitle: localize(3645, null),
        }, false);
    }
}
export class RestoreEditorsToMainWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3755, "Restore Editors into Main Window"),
                mnemonicTitle: localize(3646, null),
            },
            f1: true,
...
export class NewEmptyEditorWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3756, "New Empty Editor Window"),
                mnemonicTitle: localize(3647, null),
            },
            f1: true,
            category: Categories.View
        });
