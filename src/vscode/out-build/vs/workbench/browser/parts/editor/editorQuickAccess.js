            ...
            return {
                ...
                ariaLabel: (() => {
                    if (mapGroupIdToGroupAriaLabel.size > 1) {
                        return isDirty ?
                            localize(3818, null, nameAndDescription, mapGroupIdToGroupAriaLabel.get(groupId)) :
                            localize(3819, null, nameAndDescription, mapGroupIdToGroupAriaLabel.get(groupId));
                    }
                    return isDirty ? localize(3820, null, nameAndDescription) : nameAndDescription;
                })(),
                description,
