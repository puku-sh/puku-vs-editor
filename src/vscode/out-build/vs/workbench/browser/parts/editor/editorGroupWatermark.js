...
const showCommands = { text: localize(3791, null), id: 'workbench.action.showCommands' };
const gotoFile = { text: localize(3792, null), id: 'workbench.action.quickOpen' };
const openFile = { text: localize(3793, null), id: 'workbench.action.files.openFile' };
const openFolder = { text: localize(3794, null), id: 'workbench.action.files.openFolder' };
const openFileOrFolder = { text: localize(3795, null), id: 'workbench.action.files.openFileFolder' };
const openRecent = { text: localize(3796, null), id: 'workbench.action.openRecent' };
const newUntitledFile = { text: localize(3797, null), id: 'workbench.action.files.newUntitledFile' };
const findInFiles = { text: localize(3798, null), id: 'workbench.action.findInFiles' };
const toggleTerminal = { text: localize(3799, null), id: 'workbench.action.terminal.toggleTerminal', when: { web: ContextKeyExpr.equals('terminalProcessSupported', true) } };
const startDebugging = { text: localize(3800, null), id: 'workbench.action.debug.start', when: { web: ContextKeyExpr.equals('terminalProcessSupported', true) } };
const openSettings = { text: localize(3801, null), id: 'workbench.action.openSettings' };
...
const openChat = { text: localize(3802, null), id: 'workbench.action.chat.open', when: { native: showChat, web: showChat } };
...
registerColor('editorWatermark.foreground', { dark: transparent(editorForeground, 0.6), light: transparent(editorForeground, 0.68), hcDark: editorForeground, hcLight: editorForeground }, localize(3803, null));
