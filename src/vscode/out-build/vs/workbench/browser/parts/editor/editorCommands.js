...
function registerActiveEditorMoveCopyCommand() {
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        metadata: {
            description: localize(3757, null),
            args: [
                {
                    name: localize(3758, null),
                    description: localize(3759, null),
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        metadata: {
            description: localize(3760, null),
            args: [
                {
                    name: localize(3761, null),
                    description: localize(3762, null),
                    constraint: isSelectedEditorsMoveCopyArg,
                    schema: moveCopyJSONSchema
                }
            ]
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(3765, 'Split Editor in Group'),
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(3766, 'Join Editor in Group'),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(3767, 'Toggle Split Editor in Group'),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(3768, 'Toggle Layout of Split Editor in Group'),
                category: Categories.View,
                precondition: SideBySideEditorActiveContext,
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(3769, 'Focus First Side in Active Editor'),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(3770, 'Focus Second Side in Active Editor'),
                category: Categories.View,
                precondition: ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext),
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(3771, 'Focus Other Side in Active Editor'),
                category: Categories.View,
                precondition: ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext),
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(3772, 'Toggle Editor Group Lock'),
                category: Categories.View,
                f1: true
            });
        }
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(3773, 'Lock Editor Group'),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(3774, 'Unlock Editor Group'),
