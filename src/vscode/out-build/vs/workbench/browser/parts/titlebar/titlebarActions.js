...
registerAction2(class ToggleCommandCenter extends ToggleTitleBarConfigAction {
    constructor() {
        super("window.commandCenter" /* LayoutSettings.COMMAND_CENTER */, localize(4069, null), localize(4070, null), 1, IsCompactTitleBarContext.toNegated());
    }
});
registerAction2(class ToggleNavigationControl extends ToggleTitleBarConfigAction {
    constructor() {
        super('workbench.navigationControl.enabled', localize(4071, null), localize(4072, null), 2, ContextKeyExpr.and(IsCompactTitleBarContext.toNegated(), ContextKeyExpr.has('config.window.commandCenter')));
    }
});
registerAction2(class ToggleLayoutControl extends ToggleTitleBarConfigAction {
    constructor() {
        super("workbench.layoutControl.enabled" /* LayoutSettings.LAYOUT_ACTIONS */, localize(4073, null), localize(4074, null), 4);
    }
});
...
registerAction2(class ShowCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4083, "Show Custom Title Bar"),
...
registerAction2(class HideCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4084, "Hide Custom Title Bar"),
...
registerAction2(class HideCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4085, "Hide Custom Title Bar In Full Screen"),
...
export const ACCOUNTS_ACTIVITY_TILE_ACTION = {
    ...
    label: localize(4079, null),
    tooltip: localize(4080, null),
    class: undefined,
    enabled: true,
    run: function () { }
};
export const GLOBAL_ACTIVITY_TITLE_ACTION = {
    ...
    label: localize(4081, null),
    tooltip: localize(4082, null),
    class: undefined,
    enabled: true,
    run: function () { }
};
