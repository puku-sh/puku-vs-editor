...
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'File',
        original: 'File',
        mnemonicTitle: localize(4051, null),
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Edit',
        original: 'Edit',
        mnemonicTitle: localize(4052, null)
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Selection',
        original: 'Selection',
        mnemonicTitle: localize(4053, null)
    },
    order: 3
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'View',
        original: 'View',
        mnemonicTitle: localize(4054, null)
    },
    order: 4
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Go',
        original: 'Go',
        mnemonicTitle: localize(4055, null)
    },
    order: 5
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Terminal',
        original: 'Terminal',
        mnemonicTitle: localize(4056, null)
    },
    order: 7
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Help',
        original: 'Help',
        mnemonicTitle: localize(4057, null)
    },
    order: 8
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        ...
        mnemonicTitle: localize(4058, null)
    },
...
export class MenubarControl extends Disposable {
    ...
    notifyUserOfCustomMenubarAccessibility() {
        ...
        const message = localize(4059, null);
        this.notificationService.prompt(Severity.Info, message, [
            {
                label: localize(4060, null),
                run: () => {
        ...
        registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(4068, 'Focus Application Menu'),
                    keybinding: {
    ...
    getUpdateAction() {
        ...
        switch (state.type) {
            case "idle" /* StateType.Idle */:
                return toAction({
                    id: 'update.check', label: localize(4061, null), enabled: true, run: () => this.updateService.checkForUpdates(true)
                });
            case "checking for updates" /* StateType.CheckingForUpdates */:
                return toAction({ id: 'update.checking', label: localize(4062, null), enabled: false, run: () => { } });
            case "available for download" /* StateType.AvailableForDownload */:
                return toAction({
                    id: 'update.downloadNow', label: localize(4063, null), enabled: true, run: () => this.updateService.downloadUpdate()
                });
            case "downloading" /* StateType.Downloading */:
                return toAction({ id: 'update.downloading', label: localize(4064, null), enabled: false, run: () => { } });
            case "downloaded" /* StateType.Downloaded */:
                return isMacintosh ? null : toAction({
                    id: 'update.install', label: localize(4065, null), enabled: true, run: () => this.updateService.applyUpdate()
                });
            case "updating" /* StateType.Updating */:
                return toAction({ id: 'update.updating', label: localize(4066, null), enabled: false, run: () => { } });
            case "ready" /* StateType.Ready */:
                return toAction({
                    id: 'update.restart', label: localize(4067, null), enabled: true, run: () => this.updateService.quitAndInstall()
                });
            default:
                return null;
        }
