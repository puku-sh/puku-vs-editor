...
let ActivityBarCompositeBar = class ActivityBarCompositeBar extends PaneCompositeBar {
    ...
    fillContextMenuActions(actions, e) {
        ...
        if (menuBarVisibility === 'compact' || menuBarVisibility === 'hidden' || menuBarVisibility === 'toggle') {
            actions.unshift(...[toAction({ id: 'toggleMenuVisibility', label: localize(3324, null), checked: menuBarVisibility === 'compact', run: () => this.configurationService.updateValue("window.menuBarVisibility" /* MenuSettings.MenuBarVisibility */, menuBarVisibility === 'compact' ? 'toggle' : 'compact') }), new Separator()]);
        }
        if (menuBarVisibility === 'compact' && this.menuBarContainer && e?.target) {
            if (isAncestor(e.target, this.menuBarContainer)) {
                actions.unshift(...[toAction({ id: 'hideCompactMenu', label: localize(3325, null), run: () => this.configurationService.updateValue("window.menuBarVisibility" /* MenuSettings.MenuBarVisibility */, 'toggle') }), new Separator()]);
            }
        }
    ...
    getActivityBarContextMenuActions() {
        ...
        const actions = [
            new SubmenuAction('workbench.action.panel.position', localize(3326, null), positionActions),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3337, 'Move Activity Bar to Side'),
                mnemonicTitle: localize(3327, null),
            },
            shortTitle: localize(3328, null),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3338, 'Move Activity Bar to Top'),
                mnemonicTitle: localize(3329, null),
            },
            shortTitle: localize(3330, null),
            category: Categories.View,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3339, 'Move Activity Bar to Bottom'),
                mnemonicTitle: localize(3331, null),
            },
            shortTitle: localize(3332, null),
            category: Categories.View,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3340, 'Hide Activity Bar'),
                mnemonicTitle: localize(3333, null),
            },
            shortTitle: localize(3334, null),
            category: Categories.View,
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3341, 'Previous Primary Side Bar View'),
            category: Categories.View,
            f1: true
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3342, 'Next Primary Side Bar View'),
            category: Categories.View,
            f1: true
        }, 0 /* ViewContainerLocation.Sidebar */, 1);
    }
...
registerAction2(class FocusActivityBarAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3343, 'Focus Activity Bar'),
            category: Categories.View,
            f1: true
        });
    }
