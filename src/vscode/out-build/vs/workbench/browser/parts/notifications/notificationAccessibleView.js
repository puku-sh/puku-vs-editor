    ...
    getProvider(accessor) {
        ...
        function getProvider() {
            ...
            function getContentForNotification() {
                ...
                return withSeverityPrefix(notification.source ? localize(3917, null, message, notification.source) : message, notification.severity);
            }
...
function getActionsFromNotification(notification, accessibilitySignalService) {
    ...
    if (actions) {
        actions.push({
            id: 'clearNotification', label: localize(3918, null), tooltip: localize(3919, null), run: () => {
                notification.close();
