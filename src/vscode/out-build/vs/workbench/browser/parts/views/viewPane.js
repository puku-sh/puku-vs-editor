...
const viewPaneContainerExpandedIcon = registerIcon('view-pane-container-expanded', Codicon.chevronDown, nls.localize(4101, null));
const viewPaneContainerCollapsedIcon = registerIcon('view-pane-container-collapsed', Codicon.chevronRight, nls.localize(4102, null));
...
let ViewPane = class ViewPane extends Pane {
    ...
    renderHeader(container) {
        ...
        this.toolbar = this.instantiationService.createInstance(WorkbenchToolBar, actions, {
            ...
            ariaLabel: nls.localize(4103, null, this.title),
    ...
    _getAriaLabel(title, description) {
        ...
        return nls.localize(4104, null, title);
    }
    updateTitle(title) {
        const calculatedTitle = this.calculateTitle(title);
