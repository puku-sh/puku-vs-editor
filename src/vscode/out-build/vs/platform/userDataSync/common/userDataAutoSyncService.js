...
class AutoSync extends Disposable {
    ...
    async createAndRunSyncTask(disableCache, token) {
        ...
        if (this.manifest === null && await this.userDataSyncService.hasPreviouslySynced()) {
            if (this.hasSyncServiceChanged()) {
                if (await this.hasDefaultServiceChanged()) {
                    throw new UserDataAutoSyncError(localize(2711, null), "DefaultServiceChanged" /* UserDataSyncErrorCode.DefaultServiceChanged */);
                }
                else {
                    throw new UserDataAutoSyncError(localize(2712, null), "ServiceChanged" /* UserDataSyncErrorCode.ServiceChanged */);
                }
            }
            else {
                // Sync was turned off in the cloud
                throw new UserDataAutoSyncError(localize(2713, null), "TurnedOff" /* UserDataSyncErrorCode.TurnedOff */);
            }
        }
        ...
        if (sessionId && this.manifest && sessionId !== this.manifest.session) {
            if (this.hasSyncServiceChanged()) {
                if (await this.hasDefaultServiceChanged()) {
                    throw new UserDataAutoSyncError(localize(2714, null), "DefaultServiceChanged" /* UserDataSyncErrorCode.DefaultServiceChanged */);
                }
                else {
                    throw new UserDataAutoSyncError(localize(2715, null), "ServiceChanged" /* UserDataSyncErrorCode.ServiceChanged */);
                }
            }
            else {
                throw new UserDataAutoSyncError(localize(2716, null), "SessionExpired" /* UserDataSyncErrorCode.SessionExpired */);
            }
        }
        ...
        if (currentMachine?.disabled) {
            ...
            throw new UserDataAutoSyncError(localize(2717, null), "TurnedOff" /* UserDataSyncErrorCode.TurnedOff */);
        }
