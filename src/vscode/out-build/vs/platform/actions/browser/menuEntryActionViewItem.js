...
let MenuEntryActionViewItem = class MenuEntryActionViewItem extends ActionViewItem {
    ...
    getTooltip() {
        ...
        let title = keybindingLabel
            ? localize(1811, null, tooltip, keybindingLabel)
            : tooltip;
        if (!this._wantsAltCommand && this._menuItemAction.alt?.enabled) {
            ...
            const altTitleSection = altKeybindingLabel
                ? localize(1812, null, altTooltip, altKeybindingLabel)
                : altTooltip;
            title = localize(1813, null, title, UILabelProvider.modifierLabels[OS].altKey, altTitleSection);
        }
        return title;
    }
    updateClass() {
    ...
    updateLabel() {
        ...
        if (this.label) {
            ...
            if (this._options?.conversational) {
                this.label.textContent = localize(1814, null, this._action.label, kb2);
            }
            else {
                this.label.textContent = localize(1815, null, this._action.label, kb2);
            }
        }
    }
