    ...
    _expectAnotherChord(firstChord, keypressLabel) {
        ...
        switch (this._currentChords.length) {
            ...
            case 1:
                ...
                this._currentChordStatusMessage = this._notificationService.status(nls.localize(2124, null, keypressLabel));
                break;
            default: {
                const fullKeypressLabel = this._currentChords.map(({ label }) => label).join(', ');
                this._currentChordStatusMessage = this._notificationService.status(nls.localize(2125, null, fullKeypressLabel));
            }
        }
        ...
        switch (resolveResult.kind) {
            case 0 /* ResultKind.NoMatchingKb */: {
                ...
                if (this.inChordMode) {
                    ...
                    this._notificationService.status(nls.localize(2126, null, currentChordsLabel, keypressLabel), { hideAfter: 10 * 1000 /* 10s */ });
                    this._leaveChordMode();
            ...
            case 2 /* ResultKind.KbFound */: {
                ...
                if (resolveResult.commandId === null || resolveResult.commandId === '') {
                    if (this.inChordMode) {
                        ...
                        this._notificationService.status(nls.localize(2127, null, currentChordsLabel, keypressLabel), { hideAfter: 10 * 1000 /* 10s */ });
                        this._leaveChordMode();
                        shouldPreventDefault = true;
                    }
                }
