...
const errorEmptyString = localize(1843, null);
const hintEmptyString = localize(1844, null);
const errorNoInAfterNot = localize(1845, null);
const errorClosingParenthesis = localize(1846, null);
const errorUnexpectedToken = localize(1847, null);
const hintUnexpectedToken = localize(1848, null);
const errorUnexpectedEOF = localize(1849, null);
const hintUnexpectedEOF = localize(1850, null);
/**
        ...
        if (parser.lexingErrors.length > 0) {
            return parser.lexingErrors.map((se) => ({
                errorMessage: se.additionalInfo ?
                    localize(1852, null, se.additionalInfo) :
                    localize(1853, null),
                offset: se.offset,
