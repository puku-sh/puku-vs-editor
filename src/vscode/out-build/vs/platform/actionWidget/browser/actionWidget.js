...
registerColor('actionBar.toggledBackground', inputActiveOptionBackground, localize(1825, null));
const ActionWidgetContextKeys = {
    Visible: new RawContextKey('codeActionMenuVisible', false, localize(1826, null))
};
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1827, "Hide action widget"),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1828, "Select previous action"),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1829, "Select next action"),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1830, "Accept selected action"),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1831, "Preview selected action"),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
