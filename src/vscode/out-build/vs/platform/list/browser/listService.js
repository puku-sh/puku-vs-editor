...
configurationRegistry.registerConfiguration({
    ...
    properties: {
        [multiSelectModifierSettingKey]: {
            ...
            default: 'ctrlCmd',
            description: localize(2138, null)
        ...
        [openModeSettingKey]: {
            ...
            default: 'singleClick',
            description: localize(2139, null)
        ...
        [horizontalScrollingKey]: {
            type: 'boolean',
            default: false,
            description: localize(2140, null)
        },
        [scrollByPageKey]: {
            type: 'boolean',
            default: false,
            description: localize(2141, null)
        },
        [treeIndentKey]: {
            type: 'number',
            default: 8,
        ...
        [treeRenderIndentGuidesKey]: {
            ...
            default: 'onHover',
            description: localize(2143, null)
        },
        [listSmoothScrolling]: {
            type: 'boolean',
            default: false,
            description: localize(2144, null),
        },
        [mouseWheelScrollSensitivityKey]: {
            type: 'number',
            default: 1,
            markdownDescription: localize(2145, null)
        },
        ...
        [defaultFindModeSettingKey]: {
            ...
            default: 'highlight',
            description: localize(2149, null)
        },
        [keyboardNavigationSettingKey]: {
            ...
            deprecated: true,
            deprecationMessage: localize(2154, null)
        },
        [defaultFindMatchTypeSettingKey]: {
            ...
            default: 'fuzzy',
            description: localize(2157, null)
        },
        [treeExpandMode]: {
            type: 'string',
            enum: ['singleClick', 'doubleClick'],
            default: 'singleClick',
            description: localize(2158, null),
        },
        [treeStickyScroll]: {
            type: 'boolean',
            default: true,
            description: localize(2159, null),
        },
        [treeStickyScrollMaxElements]: {
            type: 'number',
            minimum: 1,
            default: 7,
            markdownDescription: localize(2160, null, '`#workbench.tree.enableStickyScroll#`'),
        },
        [typeNavigationModeSettingKey]: {
            type: 'string',
            enum: ['automatic', 'trigger'],
            default: 'automatic',
            markdownDescription: localize(2161, null),
        }
    }
});
