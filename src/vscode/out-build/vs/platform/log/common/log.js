...
export function LogLevelToLocalizedString(logLevel) {
    switch (logLevel) {
        case LogLevel.Trace: return { original: 'Trace', value: nls.localize(2162, null) };
        case LogLevel.Debug: return { original: 'Debug', value: nls.localize(2163, null) };
        case LogLevel.Info: return { original: 'Info', value: nls.localize(2164, null) };
        case LogLevel.Warning: return { original: 'Warning', value: nls.localize(2165, null) };
        case LogLevel.Error: return { original: 'Error', value: nls.localize(2166, null) };
        case LogLevel.Off: return { original: 'Off', value: nls.localize(2167, null) };
    }
}
