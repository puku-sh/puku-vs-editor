...
export class DiskFileSystemProviderChannel extends AbstractDiskFileSystemProviderChannel {
    ...
    async delete(uriTransformer, _resource, opts) {
        ...
        try {
            ...
            throw createFileSystemProviderError(isWindows ? localize(2112, null, basename(filePath), toErrorMessage(error)) : localize(2113, null, basename(filePath), toErrorMessage(error)), FileSystemProviderErrorCode.Unknown);
        }
    }
    //#endregion
