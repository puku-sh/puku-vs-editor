            ...
            this._contextMenuService.showContextMenu({
                ...
                getActions: () => {
                    ...
                    actions.push(new Action('diff.clipboard.copyDeletedContent', isDeletion
                        ...
                        : (_diff.original.length > 1
                            ? localize(228, null)
                            : localize(229, null)), undefined, true, async () => {
                    ...
                    if (_diff.original.length > 1) {
                        actions.push(new Action('diff.clipboard.copyDeletedLineContent', isDeletion
                            ? localize(230, null, _diff.original.startLineNumber + currentLineNumberOffset)
                            : localize(231, null, _diff.original.startLineNumber + currentLineNumberOffset), undefined, true, async () => {
                    ...
                    if (!readOnly) {
                        actions.push(new Action('diff.inline.revertChange', localize(232, null), undefined, true, async () => {
