...
const InlineCompletionsSnoozing = new RawContextKey('inlineCompletions.snoozed', false, localize(193, null));
...
export class SnoozeInlineCompletion extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(195, "Snooze Inline Suggestions"),
...
export class CancelSnoozeInlineCompletion extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(196, "Cancel Snooze Inline Suggestions"),
