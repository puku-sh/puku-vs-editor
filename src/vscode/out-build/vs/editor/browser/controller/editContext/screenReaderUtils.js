...
export function ariaLabelForScreenReaderContent(options, keybindingService) {
    ...
    if (accessibilitySupport === 1 /* AccessibilitySupport.Disabled */) {
        ...
        const editorNotAccessibleMessage = nls.localize(175, null);
        if (toggleKeybindingLabel) {
            return nls.localize(176, null, editorNotAccessibleMessage, toggleKeybindingLabel);
        }
        else if (runCommandKeybindingLabel) {
            return nls.localize(177, null, editorNotAccessibleMessage, runCommandKeybindingLabel);
        }
        else if (keybindingEditorKeybindingLabel) {
            return nls.localize(178, null, editorNotAccessibleMessage, keybindingEditorKeybindingLabel);
        }
        else {
            // SOS
