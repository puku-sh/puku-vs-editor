...
export class InlineSuggestionGutterMenuData {
    static fromInlineSuggestion(suggestion) {
        return new InlineSuggestionGutterMenuData(suggestion.action, suggestion.source.provider.displayName ?? localize(1381, null), suggestion.source.inlineSuggestions.commands ?? []);
    }
