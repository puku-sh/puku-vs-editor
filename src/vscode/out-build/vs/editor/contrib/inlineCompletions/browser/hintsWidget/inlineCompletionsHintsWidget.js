...
const inlineSuggestionHintsNextIcon = registerIcon('inline-suggestion-hints-next', Codicon.chevronRight, localize(1369, null));
const inlineSuggestionHintsPreviousIcon = registerIcon('inline-suggestion-hints-previous', Codicon.chevronLeft, localize(1370, null));
let InlineSuggestionHintsContentWidget = class InlineSuggestionHintsContentWidget extends Disposable {
    ...
    createCommandAction(commandId, label, iconClassName) {
        ...
        let tooltip = label;
        if (kb) {
            tooltip = localize(1371, null, label, kb.getLabel());
        }
    ...
    constructor(editor, withBorder, _position, _currentSuggestionIdx, _suggestionCount, _extraCommands, _warning, _relayout, _commandService, instantiationService, keybindingService, _contextKeyService, _menuService) {
        ...
        this.previousAction = this._register(this.createCommandAction(showPreviousInlineSuggestionActionId, localize(1372, null), ThemeIcon.asClassName(inlineSuggestionHintsPreviousIcon)));
        ...
        this.nextAction = this._register(this.createCommandAction(showNextInlineSuggestionActionId, localize(1373, null), ThemeIcon.asClassName(inlineSuggestionHintsNextIcon)));
