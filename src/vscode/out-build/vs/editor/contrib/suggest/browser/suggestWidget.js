 ...
 */
registerColor('editorSuggestWidget.background', editorWidgetBackground, nls.localize(1636, null));
registerColor('editorSuggestWidget.border', editorWidgetBorder, nls.localize(1637, null));
export const editorSuggestWidgetForeground = registerColor('editorSuggestWidget.foreground', editorForeground, nls.localize(1638, null));
registerColor('editorSuggestWidget.selectedForeground', quickInputListFocusForeground, nls.localize(1639, null));
registerColor('editorSuggestWidget.selectedIconForeground', quickInputListFocusIconForeground, nls.localize(1640, null));
export const editorSuggestWidgetSelectedBackground = registerColor('editorSuggestWidget.selectedBackground', quickInputListFocusBackground, nls.localize(1641, null));
registerColor('editorSuggestWidget.highlightForeground', listHighlightForeground, nls.localize(1642, null));
registerColor('editorSuggestWidget.focusHighlightForeground', listFocusHighlightForeground, nls.localize(1643, null));
registerColor('editorSuggestWidgetStatus.foreground', transparent(editorSuggestWidgetForeground, .5), nls.localize(1644, null));
var State;
(function (State) {
...
let SuggestWidget = class SuggestWidget {
    ...
    static { this.LOADING_MESSAGE = nls.localize(1645, null); }
    static { this.NO_SUGGESTIONS_MESSAGE = nls.localize(1646, null); }
    constructor(editor, _storageService, _contextKeyService, _themeService, instantiationService) {
        ...
        this._list = new List('SuggestWidget', this._listElement, {
            ...
            accessibilityProvider: {
                ...
                getWidgetAriaLabel: () => nls.localize(1647, null),
                ...
                getAriaLabel: (item) => {
                    ...
                    if (typeof item.completion.label !== 'string') {
                        ...
                        if (detail && description) {
                            label = nls.localize(1648, null, label, detail, description, kindLabel);
                        }
                        else if (detail) {
                            label = nls.localize(1649, null, label, detail, kindLabel);
                        }
                        else if (description) {
                            label = nls.localize(1650, null, label, description, kindLabel);
                        }
                    }
                    else {
                        label = nls.localize(1651, null, label, kindLabel);
                    }
                    ...
                    return nls.localize(1652, null, label, docs);
                },
            }
        });
