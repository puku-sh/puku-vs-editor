...
export const Context = {
    ...
    HasFocusedSuggestion: new RawContextKey('suggestWidgetHasFocusedSuggestion', false, localize(1618, null)),
    DetailsVisible: new RawContextKey('suggestWidgetDetailsVisible', false, localize(1619, null)),
    MultipleSuggestions: new RawContextKey('suggestWidgetMultipleSuggestions', false, localize(1620, null)),
    MakesTextEdit: new RawContextKey('suggestionMakesTextEdit', true, localize(1621, null)),
    AcceptSuggestionsOnEnter: new RawContextKey('acceptSuggestionOnEnter', true, localize(1622, null)),
    HasInsertAndReplaceRange: new RawContextKey('suggestionHasInsertAndReplaceRange', false, localize(1623, null)),
    InsertMode: new RawContextKey('suggestionInsertMode', undefined, { type: 'string', description: localize(1624, null) }),
    CanResolve: new RawContextKey('suggestionCanResolve', false, localize(1625, null)),
};
