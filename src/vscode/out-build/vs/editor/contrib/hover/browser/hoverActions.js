...
export class ShowOrFocusHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1269, "Show or Focus Hover"),
            ...
            metadata: {
                description: nls.localize2(1270, 'Show or focus the editor hover which shows documentation, references, and other content for a symbol at the current cursor position.'),
                args: [{
                        name: 'args',
                        schema: {
                            type: 'object',
                            properties: {
                                'focus': {
                                    ...
                                    enumDescriptions: [
                                        nls.localize(1266, null),
                                        nls.localize(1267, null),
                                        nls.localize(1268, null),
                                    ],
...
export class ShowDefinitionPreviewHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1271, "Show Definition Preview Hover"),
            ...
            precondition: undefined,
            metadata: {
                description: nls.localize2(1272, 'Show the definition preview hover in the editor.'),
            },
        });
    }
    run(accessor, editor) {
...
export class HideContentHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1273, "Hide Hover"),
...
export class ScrollUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1274, "Scroll Up Hover"),
            ...
            metadata: {
                description: nls.localize2(1275, 'Scroll up the editor hover.')
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1276, "Scroll Down Hover"),
            ...
            metadata: {
                description: nls.localize2(1277, 'Scroll down the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollLeftHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1278, "Scroll Left Hover"),
            ...
            metadata: {
                description: nls.localize2(1279, 'Scroll left the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollRightHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1280, "Scroll Right Hover"),
            ...
            metadata: {
                description: nls.localize2(1281, 'Scroll right the editor hover.')
            },
        });
    }
    run(accessor, editor) {
...
export class PageUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1282, "Page Up Hover"),
            ...
            metadata: {
                description: nls.localize2(1283, 'Page up the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class PageDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1284, "Page Down Hover"),
            ...
            metadata: {
                description: nls.localize2(1285, 'Page down the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class GoToTopHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1286, "Go To Top Hover"),
            ...
            metadata: {
                description: nls.localize2(1287, 'Go to the top of the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class GoToBottomHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1288, "Go To Bottom Hover"),
            ...
            metadata: {
                description: nls.localize2(1289, 'Go to the bottom of the editor hover.')
            },
        });
    }
    run(accessor, editor) {
