...
(function (HoverAccessibilityHelpNLS) {
    HoverAccessibilityHelpNLS.increaseVerbosity = localize(1262, null, `<keybinding:${INCREASE_HOVER_VERBOSITY_ACTION_ID}>`);
    HoverAccessibilityHelpNLS.decreaseVerbosity = localize(1263, null, `<keybinding:${DECREASE_HOVER_VERBOSITY_ACTION_ID}>`);
