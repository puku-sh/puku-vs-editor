...
export class NextMarkerAction extends MarkerNavigationAction {
    ...
    static { this.LABEL = nls.localize2(1177, "Go to Next Problem (Error, Warning, Info)"); }
    constructor() {
        super(true, false, {
            ...
            menuOpts: {
                ...
                icon: registerIcon('marker-navigation-next', Codicon.arrowDown, nls.localize(1173, null)),
                group: 'navigation',
                order: 1
            }
        });
...
class PrevMarkerAction extends MarkerNavigationAction {
    ...
    static { this.LABEL = nls.localize2(1178, "Go to Previous Problem (Error, Warning, Info)"); }
    constructor() {
        super(false, false, {
            ...
            menuOpts: {
                ...
                icon: registerIcon('marker-navigation-previous', Codicon.arrowUp, nls.localize(1174, null)),
                group: 'navigation',
                order: 2
            }
        });
...
class NextMarkerInFilesAction extends MarkerNavigationAction {
    constructor() {
        super(true, true, {
            ...
            label: nls.localize2(1179, "Go to Next Problem in Files (Error, Warning, Info)"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
class PrevMarkerInFilesAction extends MarkerNavigationAction {
    constructor() {
        super(false, true, {
            ...
            label: nls.localize2(1180, "Go to Previous Problem in Files (Error, Warning, Info)"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
