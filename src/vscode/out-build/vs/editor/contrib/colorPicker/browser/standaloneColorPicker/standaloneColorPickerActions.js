...
export class ShowOrFocusStandaloneColorPicker extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(1046, "Show or Focus Standalone Color Picker"),
                mnemonicTitle: localize(1045, null),
            },
            ...
            metadata: {
                description: localize2(1047, "Show or focus a standalone color picker which uses the default color provider. It displays hex/rgb/hsl colors."),
            }
        });
    }
...
export class HideStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1048, "Hide the Color Picker"),
            ...
            metadata: {
                description: localize2(1049, "Hide the standalone color picker."),
            }
        });
    }
...
export class InsertColorWithStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1050, "Insert Color with Standalone Color Picker"),
            ...
            metadata: {
                description: localize2(1051, "Insert hex/rgb/hsl colors with the focused standalone color picker."),
            }
        });
    }
    run(_accessor, editor) {
