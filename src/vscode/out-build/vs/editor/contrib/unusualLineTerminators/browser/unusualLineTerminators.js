    ...
    async _checkForUnusualLineTerminators() {
        ...
        try {
            ...
            result = await this._dialogService.confirm({
                title: nls.localize(1721, null),
                message: nls.localize(1722, null),
                detail: nls.localize(1723, null, basename(model.uri)),
                primaryButton: nls.localize(1724, null),
                cancelButton: nls.localize(1725, null)
            });
        }
        finally {
            this._isPresentingDialog = false;
