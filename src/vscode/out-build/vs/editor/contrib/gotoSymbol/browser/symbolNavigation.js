...
export const ctxHasSymbols = new RawContextKey('hasSymbols', false, localize(1252, null));
...
let SymbolNavigationService = class SymbolNavigationService {
    ...
    _showMessage() {
        ...
        const message = kb
            ? localize(1253, null, this._currentIdx + 1, this._currentModel.references.length, kb.getLabel())
            : localize(1254, null, this._currentIdx + 1, this._currentModel.references.length);
