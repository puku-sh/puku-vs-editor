...
export class ToggleTabFocusModeAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(1693, 'Toggle Tab Key Moves Focus'),
            ...
            metadata: {
                description: nls.localize2(1694, "Determines whether the tab key moves focus around the workbench or inserts the tab character in the current editor. This is also called tab trapping, tab navigation, or tab focus mode."),
            },
            f1: true
        });
    }
    run() {
        ...
        if (newValue) {
            alert(nls.localize(1691, null));
        }
        else {
            alert(nls.localize(1692, null));
        }
    }
}
