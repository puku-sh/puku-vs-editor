...
export class ToggleStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(1611, "Toggle Editor Sticky Scroll"),
                mnemonicTitle: localize(1607, null),
            },
            metadata: {
                description: localize2(1612, "Toggle/enable the editor sticky scroll which shows the nested scopes at the top of the viewport"),
            },
            category: Categories.View,
            toggled: {
                condition: ContextKeyExpr.equals('config.editor.stickyScroll.enabled', true),
                title: localize(1608, null),
                mnemonicTitle: localize(1609, null),
            },
            menu: [
...
export class FocusStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(1613, "Focus Editor Sticky Scroll"),
                mnemonicTitle: localize(1610, null),
            },
...
export class SelectNextStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1614, "Select the next editor sticky scroll line"),
...
export class SelectPreviousStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1615, "Select the previous sticky scroll line"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
...
export class GoToStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1616, "Go to the focused sticky scroll line"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
...
export class SelectEditor extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1617, "Select Editor"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
