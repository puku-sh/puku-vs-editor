...
const findCollapsedIcon = registerIcon('find-collapsed', Codicon.chevronRight, nls.localize(1113, null));
const findExpandedIcon = registerIcon('find-expanded', Codicon.chevronDown, nls.localize(1114, null));
export const findSelectionIcon = registerIcon('find-selection', Codicon.selection, nls.localize(1115, null));
export const findReplaceIcon = registerIcon('find-replace', Codicon.replace, nls.localize(1116, null));
export const findReplaceAllIcon = registerIcon('find-replace-all', Codicon.replaceAll, nls.localize(1117, null));
export const findPreviousMatchIcon = registerIcon('find-previous-match', Codicon.arrowUp, nls.localize(1118, null));
export const findNextMatchIcon = registerIcon('find-next-match', Codicon.arrowDown, nls.localize(1119, null));
const NLS_FIND_DIALOG_LABEL = nls.localize(1120, null);
const NLS_FIND_INPUT_LABEL = nls.localize(1121, null);
const NLS_FIND_INPUT_PLACEHOLDER = nls.localize(1122, null);
const NLS_PREVIOUS_MATCH_BTN_LABEL = nls.localize(1123, null);
const NLS_NEXT_MATCH_BTN_LABEL = nls.localize(1124, null);
const NLS_TOGGLE_SELECTION_FIND_TITLE = nls.localize(1125, null);
const NLS_CLOSE_BTN_LABEL = nls.localize(1126, null);
const NLS_REPLACE_INPUT_LABEL = nls.localize(1127, null);
const NLS_REPLACE_INPUT_PLACEHOLDER = nls.localize(1128, null);
const NLS_REPLACE_BTN_LABEL = nls.localize(1129, null);
const NLS_REPLACE_ALL_BTN_LABEL = nls.localize(1130, null);
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = nls.localize(1131, null);
const NLS_MATCHES_COUNT_LIMIT_TITLE = nls.localize(1132, null, MATCHES_LIMIT);
export const NLS_MATCHES_LOCATION = nls.localize(1133, null);
export const NLS_NO_RESULTS = nls.localize(1134, null);
...
export class FindWidget extends Widget {
    ...
    _getAriaLabel(label, currentMatch, searchString) {
        if (label === NLS_NO_RESULTS) {
            return searchString === ''
                ? nls.localize(1135, null, label)
                : nls.localize(1136, null, label, searchString);
        }
        if (currentMatch) {
            const ariaLabel = nls.localize(1137, null, label, searchString, currentMatch.startLineNumber + ':' + currentMatch.startColumn);
        ...
        return nls.localize(1138, null, label, searchString);
    }
    /**
