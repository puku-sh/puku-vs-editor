    ...
    replaceAll() {
        if (this._model) {
            if (this._editor.getModel()?.isTooLargeForHeapOperation()) {
                this._notificationService.warn(nls.localize(1097, null));
                return false;
            }
...
export class StartFindWithArgsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1105, "Find with Arguments"),
...
export class StartFindWithSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1106, "Find with Selection"),
            precondition: undefined,
            kbOpts: {
                kbExpr: null,
                primary: 0,
...
export const NextMatchFindAction = registerMultiEditorAction(new MultiEditorAction({
    ...
    label: nls.localize2(1107, "Find Next"),
    precondition: undefined,
    kbOpts: [{
...
export const PreviousMatchFindAction = registerMultiEditorAction(new MultiEditorAction({
    ...
    label: nls.localize2(1108, "Find Previous"),
    precondition: undefined,
    kbOpts: [{
            kbExpr: EditorContextKeys.focus,
...
export class MoveToMatchFindAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1109, "Go to Match..."),
    ...
    run(accessor, editor) {
        ...
        if (matchesCount < 1) {
            ...
            notificationService.notify({
                ...
                message: nls.localize(1099, null)
            });
            return;
        }
        ...
        inputBox.placeholder = nls.localize(1100, null, matchesCount);
        ...
        const updatePickerAndEditor = (value) => {
            ...
            if (typeof index === 'number') {
                ...
                inputBox.validationMessage = nls.localize(1101, null, controller.getState().matchesCount);
        ...
        disposables.add(inputBox.onDidAccept(() => {
            ...
            if (typeof index === 'number') {
                ...
                inputBox.validationMessage = nls.localize(1102, null, controller.getState().matchesCount);
            }
        }));
...
export class NextSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1110, "Find Next Selection"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
export class PreviousSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1111, "Find Previous Selection"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
export const StartFindReplaceAction = registerMultiEditorAction(new MultiEditorAction({
    ...
    label: nls.localize2(1112, "Replace"),
    precondition: ContextKeyExpr.or(EditorContextKeys.focus, ContextKeyExpr.has('editorIsOpen')),
    kbOpts: {
        kbExpr: null,
