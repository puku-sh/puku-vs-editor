...
let AbstractGotoSymbolQuickAccessProvider = class AbstractGotoSymbolQuickAccessProvider extends AbstractEditorNavigationQuickAccessProvider {
    ...
    provideWithoutTextEditor(picker) {
        this.provideLabelPick(picker, localize(1508, null));
    ...
    doProvideWithoutEditorSymbols(context, model, picker, token) {
        ...
        this.provideLabelPick(picker, localize(1509, null));
            ...
            try {
                ...
                if (items.length > 0) {
                    ...
                    if (query.original.length > 0) {
                        this.provideLabelPick(picker, localize(1510, null));
                    }
                    else {
                        this.provideLabelPick(picker, localize(1511, null));
                    }
                }
            }
            finally {
    ...
    async doGetSymbolPicks(symbolsPromise, query, options, token, model) {
        ...
        if (openSideBySideDirection) {
            buttons = [{
                    ...
                    tooltip: openSideBySideDirection === 'right' ? localize(1512, null) : localize(1513, null)
                }];
        }
        ...
        if (filterBySymbolKind) {
            ...
            symbolPicks = [
                { label: localize(1514, null, filteredSymbolPicks.length), type: 'separator' },
...
// #region NLS Helpers
const FALLBACK_NLS_SYMBOL_KIND = localize(1515, null);
const NLS_SYMBOL_KIND_CACHE = {
    [5 /* SymbolKind.Method */]: localize(1516, null),
    [11 /* SymbolKind.Function */]: localize(1517, null),
    [8 /* SymbolKind.Constructor */]: localize(1518, null),
    [12 /* SymbolKind.Variable */]: localize(1519, null),
    [4 /* SymbolKind.Class */]: localize(1520, null),
    [22 /* SymbolKind.Struct */]: localize(1521, null),
    [23 /* SymbolKind.Event */]: localize(1522, null),
    [24 /* SymbolKind.Operator */]: localize(1523, null),
    [10 /* SymbolKind.Interface */]: localize(1524, null),
    [2 /* SymbolKind.Namespace */]: localize(1525, null),
    [3 /* SymbolKind.Package */]: localize(1526, null),
    [25 /* SymbolKind.TypeParameter */]: localize(1527, null),
    [1 /* SymbolKind.Module */]: localize(1528, null),
    [6 /* SymbolKind.Property */]: localize(1529, null),
    [9 /* SymbolKind.Enum */]: localize(1530, null),
    [21 /* SymbolKind.EnumMember */]: localize(1531, null),
    [14 /* SymbolKind.String */]: localize(1532, null),
    [0 /* SymbolKind.File */]: localize(1533, null),
    [17 /* SymbolKind.Array */]: localize(1534, null),
    [15 /* SymbolKind.Number */]: localize(1535, null),
    [16 /* SymbolKind.Boolean */]: localize(1536, null),
    [18 /* SymbolKind.Object */]: localize(1537, null),
    [19 /* SymbolKind.Key */]: localize(1538, null),
    [7 /* SymbolKind.Field */]: localize(1539, null),
    [13 /* SymbolKind.Constant */]: localize(1540, null)
};
//#endregion
