...
export class AbstractGotoLineQuickAccessProvider extends AbstractEditorNavigationQuickAccessProvider {
    ...
    provideWithoutTextEditor(picker) {
        const label = localize(1497, null);
        picker.items = [{ label }];
    ...
    provideWithTextEditor(context, picker, token) {
        ...
        const updatePickerAndEditor = () => {
            ...
            picker.ariaLabel = localize(1498, null, cursor.lineNumber, cursor.column, label);
    ...
    parsePosition(editor, value) {
        ...
        if (value.startsWith(':')) {
            ...
            if (isNaN(offset)) {
                ...
                return {
                    ...
                    label: this.useZeroBasedOffset ?
                        localize(1501, null, maxOffset - 1) :
                        localize(1502, null, maxOffset)
                };
            }
            else {
                ...
                return {
                    ...pos,
                    inOffsetMode: true,
                    label: localize(1503, null, pos.lineNumber, pos.column)
                };
            }
        }
        else {
            ...
            if (parts.length < 1 || isNaN(lineNumber)) {
                return {
                    label: localize(1504, null, maxLine)
                };
            }
            ...
            if (parts.length < 2 || isNaN(column)) {
                return {
                    ...
                    label: parts.length < 2 ?
                        localize(1505, null, lineNumber) :
                        localize(1506, null, lineNumber, maxColumn)
                };
            }
            ...
            return {
                lineNumber,
                column,
                label: localize(1507, null, lineNumber, column)
            };
        }
    }
}
