...
export class IndentationToSpacesAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1310, "Convert Indentation to Spaces"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1311, "Convert the tab indentation to spaces."),
            }
        });
    }
    run(accessor, editor) {
...
export class IndentationToTabsAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1312, "Convert Indentation to Tabs"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1313, "Convert the spaces indentation to tabs."),
            }
        });
    }
    run(accessor, editor) {
        ...
        const picks = [1, 2, 3, 4, 5, 6, 7, 8].map(n => ({
            ...
            description: (n === creationOpts.tabSize && n === modelOpts.tabSize
                ...
                : n === creationOpts.tabSize
                    ...
                    : n === modelOpts.tabSize
                        ? nls.localize(1308, null)
                        : undefined)
        }));
        // auto focus the tabSize set for the current editor
        const autoFocusIndex = Math.min(model.getOptions().tabSize - 1, 7);
        setTimeout(() => {
            quickInputService.pick(picks, { placeHolder: nls.localize(1309, null), activeItem: picks[autoFocusIndex] }).then(pick => {
                if (pick) {
...
export class IndentUsingTabs extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(false, false, {
            ...
            label: nls.localize2(1314, "Indent Using Tabs"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1315, "Use indentation with tabs."),
            }
        });
    }
}
export class IndentUsingSpaces extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, false, {
            ...
            label: nls.localize2(1316, "Indent Using Spaces"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1317, "Use indentation with spaces."),
            }
        });
    }
}
export class ChangeTabDisplaySize extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, true, {
            ...
            label: nls.localize2(1318, "Change Tab Display Size"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1319, "Change the space size equivalent of the tab."),
            }
        });
    }
}
export class DetectIndentation extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1320, "Detect Indentation from Content"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1321, "Detect the indentation from content."),
            }
        });
    }
    run(accessor, editor) {
...
export class ReindentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1322, "Reindent Lines"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1323, "Reindent the lines of the editor."),
            },
...
export class ReindentSelectedLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1324, "Reindent Selected Lines"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1325, "Reindent the selected lines of the editor."),
            },
            canTriggerInlineEdits: true,
        });
    }
