...
let ContextMenuController = class ContextMenuController {
    ...
    _showScrollbarContextMenu(anchor) {
        ...
        actions.push(createEnumAction(nls.localize(1060, null), minimapOptions.enabled, 'editor.minimap.size', minimapOptions.size, [{
                label: nls.localize(1061, null),
                value: 'proportional'
            }, {
                label: nls.localize(1062, null),
                value: 'fill'
            }, {
                label: nls.localize(1063, null),
                value: 'fit'
            }]));
        actions.push(createEnumAction(nls.localize(1064, null), minimapOptions.enabled, 'editor.minimap.showSlider', minimapOptions.showSlider, [{
                label: nls.localize(1065, null),
                value: 'mouseover'
            }, {
                label: nls.localize(1066, null),
                value: 'always'
            }]));
        const useShadowDOM = this._editor.getOption(144 /* EditorOption.useShadowDOM */) && !isIOS; // Do not use shadow dom on IOS #122035
        this._contextMenuIsBeingShownCount++;
...
class ShowContextMenu extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1067, "Show Editor Context Menu"),
