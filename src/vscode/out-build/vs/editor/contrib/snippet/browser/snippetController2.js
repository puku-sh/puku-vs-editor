...
let SnippetController2 = class SnippetController2 {
    ...
    static { this.InSnippetMode = new RawContextKey('inSnippetMode', false, localize(1565, null)); }
    static { this.HasNextTabstop = new RawContextKey('hasNextTabstop', false, localize(1566, null)); }
    static { this.HasPrevTabstop = new RawContextKey('hasPrevTabstop', false, localize(1567, null)); }
                ...
                provideCompletionItems: (model, position) => {
                    ...
                    for (let i = 0; i < activeChoice.choice.options.length; i++) {
                        ...
                        suggestions.push({
                            ...
                            command: { id: 'jumpToNextSnippetPlaceholder', title: localize(1568, null) }
                        });
                    }
                    return { suggestions };
                }
