...
export enum ToolName {
	...
	GetNotebookSummary = 'puku_getNotebookSummary',
...
export enum ContributedToolName {
	ApplyPatch = 'puku_applyPatch',
	Codebase = 'puku_searchCodebase',
	SearchWorkspaceSymbols = 'puku_searchWorkspaceSymbols',
	Usages = 'puku_listCodeUsages',
	UpdateUserPreferences = 'puku_updateUserPreferences',
	VSCodeAPI = 'puku_getVSCodeAPI',
	TestFailure = 'puku_testFailure',
	/** @deprecated moving to core soon */
	RunTests = 'puku_runTests1',
	FindFiles = 'puku_findFiles',
	FindTextInFiles = 'puku_findTextInFiles',
	ReadFile = 'puku_readFile',
	ListDirectory = 'puku_listDirectory',
	GetErrors = 'puku_getErrors',
	DocInfo = 'puku_getDocInfo',
	GetScmChanges = 'puku_getChangedFiles',
	ReadProjectStructure = 'puku_readProjectStructure',
	CreateNewWorkspace = 'puku_createNewWorkspace',
	CreateNewJupyterNotebook = 'puku_createNewJupyterNotebook',
	EditFile = 'puku_insertEdit',
	CreateFile = 'puku_createFile',
	ReplaceString = 'puku_replaceString',
	MultiReplaceString = 'puku_multiReplaceString',
	EditNotebook = 'puku_editNotebook',
	RunNotebookCell = 'puku_runNotebookCell',
	GetNotebookSummary = 'puku_getNotebookSummary',
	ReadCellOutput = 'puku_readNotebookCellOutput',
	InstallExtension = 'puku_installExtension',
	FetchWebPage = 'puku_fetchWebPage',
	Memory = 'puku_memory',
	FindTestFiles = 'puku_findTestFiles',
	GetProjectSetupInfo = 'puku_getProjectSetupInfo',
	SearchViewResults = 'puku_getSearchResults',
	GithubRepo = 'puku_githubRepo',
	CreateAndRunTask = 'puku_createAndRunTask',
	SimpleBrowser = 'puku_openSimpleBrowser',
	CreateDirectory = 'puku_createDirectory',
	RunVscodeCmd = 'puku_runVscodeCommand',
	ToolReplay = 'puku_toolReplay',
	EditFilesPlaceholder = 'puku_editFiles',
}
